...
├── config.yaml
├── metadata.json
├── pulumi-equinix_darwin_amd64_v1
│   └── pulumi-resource-equinix
├── pulumi-equinix_darwin_arm64
│   └── pulumi-resource-equinix
├── pulumi-equinix_linux_amd64_v1
│   └── pulumi-resource-equinix
├── pulumi-equinix_linux_arm64
│   └── pulumi-resource-equinix
├── pulumi-equinix_windows_amd64_v1
│   └── pulumi-resource-equinix.exe
└── pulumi-equinix_windows_arm64
    └── pulumi-resource-equinix.exe
```
