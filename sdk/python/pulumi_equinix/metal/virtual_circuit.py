...
class _VirtualCircuitState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Name of the Virtual Circuit resource
        :param pulumi.Input[_builtins.int] nni_vlan: Equinix Metal network-to-network VLAN ID (optional when the connection has mode=tunnel)
        :param pulumi.Input[_builtins.int] nni_vnid: Nni VLAN ID parameter, see https://docs.equinix.com/metal/interconnections/introduction/
        :param pulumi.Input[_builtins.int] peer_asn: The BGP ASN of the peer. The same ASN may be the used across several VCs, but it cannot be the same as the local_asn of the VRF.
        :param pulumi.Input[_builtins.str] port_id: UUID of the Connection Port where the VC is scoped to
        :param pulumi.Input[_builtins.str] project_id: UUID of the Project where the VC is scoped to
        :param pulumi.Input[_builtins.str] speed: Description of the Virtual Circuit speed. This is for information purposes and is computed when the connection type is shared.
        ...
        :param pulumi.Input[_builtins.str] virtual_circuit_id: UUID of an existing VC to configure. Used in the case of shared interconnections where the VC has already been created.
        :param pulumi.Input[_builtins.str] vlan_id: UUID of the VLAN to associate
        :param pulumi.Input[_builtins.int] vnid: VNID VLAN parameter, see https://docs.equinix.com/metal/interconnections/introduction/
        :param pulumi.Input[_builtins.str] vrf_id: UUID of the VRF to associate
        """
        if connection_id is not None:
            pulumi.set(__self__, "connection_id", connection_id)
