...
class _ConnectionState:
    def __init__(__self__, *,
                 ...
                 service_token_type: Optional[pulumi.Input[str]] = None,
                 service_tokens: Optional[pulumi.Input[Sequence[pulumi.Input['ConnectionServiceTokenArgs']]]] = None,
        ...
        :param pulumi.Input[str] name: Name of the connection resource
        :param pulumi.Input[str] organization_id: ID of the organization where the connection is scoped to.
        :param pulumi.Input[Sequence[pulumi.Input['ConnectionPortArgs']]] ports: List of connection ports - primary (`ports[0]`) and secondary (`ports[1]`). Schema of
               port is described in documentation of the
               metal.Connection datasource.
        :param pulumi.Input[str] project_id: ID of the project where the connection is scoped to, must be set for.
        :param pulumi.Input[str] redundancy: Connection redundancy - redundant or primary.
        :param pulumi.Input[str] service_token_type: Only used with shared connection. Type of service token to use for the connection, a_side or z_side
        :param pulumi.Input[Sequence[pulumi.Input['ConnectionServiceTokenArgs']]] service_tokens: List of connection service tokens with attributes required to configure the connection in Equinix Fabric with the equinix_ecx_l2_connection resource or from the [Equinix Fabric Portal](https://ecxfabric.equinix.com/dashboard). Scehma of service_token is described in documentation of the metal.Connection datasource.
        :param pulumi.Input[str] speed: Connection speed - one of 50Mbps, 200Mbps, 500Mbps, 1Gbps, 2Gbps, 5Gbps, 10Gbps.
    ...
    def service_tokens(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ConnectionServiceTokenArgs']]]]:
        """
        List of connection service tokens with attributes required to configure the connection in Equinix Fabric with the equinix_ecx_l2_connection resource or from the [Equinix Fabric Portal](https://ecxfabric.equinix.com/dashboard). Scehma of service_token is described in documentation of the metal.Connection datasource.
        """
        return pulumi.get(self, "service_tokens")

    @service_tokens.setter
    def service_tokens(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ConnectionServiceTokenArgs']]]]):
...
class Connection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            redundancy: Optional[pulumi.Input[str]] = None,
            service_token_type: Optional[pulumi.Input[str]] = None,
            service_tokens: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ConnectionServiceTokenArgs']]]]] = None,
            speed: Optional[pulumi.Input[str]] = None,
            status: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            token: Optional[pulumi.Input[str]] = None,
            type: Optional[pulumi.Input[str]] = None,
            vlans: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None) -> 'Connection':
        """
        ...
        :param pulumi.Input[str] name: Name of the connection resource
        :param pulumi.Input[str] organization_id: ID of the organization where the connection is scoped to.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ConnectionPortArgs']]]] ports: List of connection ports - primary (`ports[0]`) and secondary (`ports[1]`). Schema of
               port is described in documentation of the
               metal.Connection datasource.
        :param pulumi.Input[str] project_id: ID of the project where the connection is scoped to, must be set for.
        :param pulumi.Input[str] redundancy: Connection redundancy - redundant or primary.
        :param pulumi.Input[str] service_token_type: Only used with shared connection. Type of service token to use for the connection, a_side or z_side
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ConnectionServiceTokenArgs']]]] service_tokens: List of connection service tokens with attributes required to configure the connection in Equinix Fabric with the equinix_ecx_l2_connection resource or from the [Equinix Fabric Portal](https://ecxfabric.equinix.com/dashboard). Scehma of service_token is described in documentation of the metal.Connection datasource.
        :param pulumi.Input[str] speed: Connection speed - one of 50Mbps, 200Mbps, 500Mbps, 1Gbps, 2Gbps, 5Gbps, 10Gbps.
        :param pulumi.Input[str] status: Status of the connection resource.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] tags: String list of tags.
        :param pulumi.Input[str] token: (Deprecated) Fabric Token required to configure the connection in Equinix Fabric with the equinix_ecx_l2_connection resource or from the [Equinix Fabric Portal](https://ecxfabric.equinix.com/dashboard). If your organization already has connection service tokens enabled, use `service_tokens` instead.
    ...
    @property
    @pulumi.getter(name="serviceTokens")
    def service_tokens(self) -> pulumi.Output[Sequence['outputs.ConnectionServiceToken']]:
        """
        List of connection service tokens with attributes required to configure the connection in Equinix Fabric with the equinix_ecx_l2_connection resource or from the [Equinix Fabric Portal](https://ecxfabric.equinix.com/dashboard). Scehma of service_token is described in documentation of the metal.Connection datasource.
        """
        return pulumi.get(self, "service_tokens")
