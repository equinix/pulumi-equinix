...
class GetIpBlockRangesResult:
    ...
    def global_ipv4s(self) -> Sequence[_builtins.str]:
        """
    ...
    def private_ipv4s(self) -> Sequence[_builtins.str]:
        """
    ...
    def public_ipv4s(self) -> Sequence[_builtins.str]:
        """
...
def get_ip_block_ranges(facility: Optional[_builtins.str] = None,
    ...
    :param _builtins.str facility: Facility code filtering the IP blocks. Global IPv4 blocks will be listed anyway. If you omit this and metro, all the block from the project will be listed. Use metro instead; read the facility to metro migration guide
    :param _builtins.str metro: Metro code filtering the IP blocks. Global IPv4 blocks will be listed anyway. If you omit this and facility, all the block from the project will be listed.
    :param _builtins.str project_id: ID of the project from which to list the blocks.
    """
    __args__ = dict()
...
def get_ip_block_ranges_output(facility: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
