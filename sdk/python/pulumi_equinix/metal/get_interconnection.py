...
class GetInterconnectionResult:
    ...
    def service_token_type(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def vlans(self) -> Sequence[_builtins.int]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def vrfs(self) -> Sequence[_builtins.str]:
...
def get_interconnection(connection_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str connection_id: ID of the connection resource.
    """
    __args__ = dict()
...
def get_interconnection_output(connection_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetInterconnectionResult(
        ...
        service_token_type=pulumi.get(__response__, 'service_token_type'),
        service_tokens=pulumi.get(__response__, 'service_tokens'),
