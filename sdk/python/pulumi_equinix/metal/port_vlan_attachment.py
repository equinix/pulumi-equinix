...
class PortVlanAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 vlan_vnid: pulumi.Input[_builtins.int],
                 force_bond: Optional[pulumi.Input[_builtins.bool]] = None,
                 native: Optional[pulumi.Input[_builtins.bool]] = None):
        """
        The set of arguments for constructing a PortVlanAttachment resource.
        :param pulumi.Input[_builtins.str] device_id: ID of device to be assigned to the VLAN.
        :param pulumi.Input[_builtins.str] port_name: Name of network port to be assigned to the VLAN.
        :param pulumi.Input[_builtins.int] vlan_vnid: VXLAN Network Identifier.
        :param pulumi.Input[_builtins.bool] force_bond: Add port back to the bond when this resource is removed. Default is `false`.
        :param pulumi.Input[_builtins.bool] native: Mark this VLAN a native VLAN on the port. This can be used only if this assignment assigns second or further VLAN to the port. To ensure that this attachment is not first on a port, you can use `depends_on` pointing to another `metal.PortVlanAttachment`, just like in the layer2-individual example above.
        """
    ...
    def vlan_vnid(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    @vlan_vnid.setter
    def vlan_vnid(self, value: pulumi.Input[_builtins.int]):
        pulumi.set(self, "vlan_vnid", value)

    @_builtins.property
    @pulumi.getter(name="forceBond")
    def force_bond(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    @force_bond.setter
    def force_bond(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "force_bond", value)

    @_builtins.property
    @pulumi.getter
    def native(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    @native.setter
    def native(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class _PortVlanAttachmentState:
    def __init__(__self__, *,
                 ...
                 vlan_vnid: Optional[pulumi.Input[_builtins.int]] = None):
        """
        Input properties used for looking up and filtering PortVlanAttachment resources.
        :param pulumi.Input[_builtins.str] device_id: ID of device to be assigned to the VLAN.
        :param pulumi.Input[_builtins.bool] force_bond: Add port back to the bond when this resource is removed. Default is `false`.
        :param pulumi.Input[_builtins.bool] native: Mark this VLAN a native VLAN on the port. This can be used only if this assignment assigns second or further VLAN to the port. To ensure that this attachment is not first on a port, you can use `depends_on` pointing to another `metal.PortVlanAttachment`, just like in the layer2-individual example above.
        :param pulumi.Input[_builtins.str] port_id: UUID of device port
        :param pulumi.Input[_builtins.str] port_name: Name of network port to be assigned to the VLAN.
        :param pulumi.Input[_builtins.str] vlan_id: UUID of VLAN API resource
        :param pulumi.Input[_builtins.int] vlan_vnid: VXLAN Network Identifier.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="vlanVnid")
    def vlan_vnid(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        VXLAN Network Identifier.
        """
        return pulumi.get(self, "vlan_vnid")
    ...
    @vlan_vnid.setter
    def vlan_vnid(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "vlan_vnid", value)


@pulumi.type_token("equinix:metal/portVlanAttachment:PortVlanAttachment")
class PortVlanAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            port_name: Optional[pulumi.Input[_builtins.str]] = None,
            vlan_id: Optional[pulumi.Input[_builtins.str]] = None,
            vlan_vnid: Optional[pulumi.Input[_builtins.int]] = None) -> 'PortVlanAttachment':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="forceBond")
    def force_bond(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Add port back to the bond when this resource is removed. Default is `false`.
        """
        return pulumi.get(self, "force_bond")
    ...
    @_builtins.property
    @pulumi.getter
    def native(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Mark this VLAN a native VLAN on the port. This can be used only if this assignment assigns second or further VLAN to the port. To ensure that this attachment is not first on a port, you can use `depends_on` pointing to another `metal.PortVlanAttachment`, just like in the layer2-individual example above.
        """
        return pulumi.get(self, "native")
    ...
    @_builtins.property
    @pulumi.getter(name="vlanVnid")
    def vlan_vnid(self) -> pulumi.Output[_builtins.int]:
        """
        VXLAN Network Identifier.
        """
        return pulumi.get(self, "vlan_vnid")
