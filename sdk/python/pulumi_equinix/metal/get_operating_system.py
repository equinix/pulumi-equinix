...
class GetOperatingSystemResult:
    ...
    def provisionable_on(self) -> Optional[_builtins.str]:
...
def get_operating_system(distro: Optional[_builtins.str] = None,
                         name: Optional[_builtins.str] = None,
                         provisionable_on: Optional[_builtins.str] = None,
    ...
    :param _builtins.str distro: Name of the OS distribution.
    :param _builtins.str name: Name or part of the name of the distribution. Case insensitive.
    :param _builtins.str provisionable_on: Plan name.
    :param _builtins.str version: Version of the distribution.
    """
    __args__ = dict()
...
def get_operating_system_output(distro: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                provisionable_on: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
