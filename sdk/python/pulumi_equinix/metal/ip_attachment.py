...
class IpAttachmentArgs:
    def __init__(__self__, *,
                 cidr_notation: pulumi.Input[_builtins.str],
                 device_id: pulumi.Input[_builtins.str]):
        """
        The set of arguments for constructing a IpAttachment resource.
        :param pulumi.Input[_builtins.str] cidr_notation: CIDR notation of subnet from block reserved in the same project and metro as the device.
        :param pulumi.Input[_builtins.str] device_id: ID of device to which to assign the subnet.
        """
    ...
    def cidr_notation(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def cidr_notation(self, value: pulumi.Input[_builtins.str]):
...
class _IpAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] cidr: Length of CIDR prefix of the subnet as integer.
        :param pulumi.Input[_builtins.str] cidr_notation: CIDR notation of subnet from block reserved in the same project and metro as the device.
        :param pulumi.Input[_builtins.str] device_id: ID of device to which to assign the subnet.
        :param pulumi.Input[_builtins.str] gateway: IP address of gateway for the subnet.
        :param pulumi.Input[_builtins.bool] global_: Flag indicating whether IP block is global, i.e. assignable in any location
        :param pulumi.Input[_builtins.str] netmask: Subnet mask in decimal notation, e.g., `255.255.255.0`.
        :param pulumi.Input[_builtins.str] network: Subnet network address.
        :param pulumi.Input[_builtins.bool] public: Boolean flag whether subnet is reachable from the Internet.
        """
...
@pulumi.type_token("equinix:metal/ipAttachment:IpAttachment")
class IpAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network: Optional[pulumi.Input[_builtins.str]] = None,
            public: Optional[pulumi.Input[_builtins.bool]] = None,
            vrf_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'IpAttachment':
        """
