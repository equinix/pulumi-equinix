...
class GatewayArgs:
    def __init__(__self__, *,
                 ...
                 ip_reservation_id: Optional[pulumi.Input[_builtins.str]] = None,
                 private_ipv4_subnet_size: Optional[pulumi.Input[_builtins.int]] = None,
                 timeouts: Optional[pulumi.Input['GatewayTimeoutsArgs']] = None):
        """
        The set of arguments for constructing a Gateway resource.
        :param pulumi.Input[_builtins.str] project_id: UUID of the project where the gateway is scoped to.
        :param pulumi.Input[_builtins.str] vlan_id: UUID of the VLAN where the gateway is scoped to.
        :param pulumi.Input[_builtins.str] ip_reservation_id: UUID of Public or VRF IP Reservation to associate with the gateway, the reservation must be in the same metro as the VLAN, conflicts with `private_ipv4_subnet_size`.
        :param pulumi.Input[_builtins.int] private_ipv4_subnet_size: Size of the private IPv4 subnet to create for this metal gateway, must be one of `8`, `16`, `32`, `64`, `128`. Conflicts with `ip_reservation_id`.
        """
    ...
    def ip_reservation_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def ip_reservation_id(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "ip_reservation_id", value)

    @_builtins.property
    @pulumi.getter(name="privateIpv4SubnetSize")
    def private_ipv4_subnet_size(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    def private_ipv4_subnet_size(self, value: Optional[pulumi.Input[_builtins.int]]):
...
class _GatewayState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] private_ipv4_subnet_size: Size of the private IPv4 subnet to create for this metal gateway, must be one of `8`, `16`, `32`, `64`, `128`. Conflicts with `ip_reservation_id`.
        :param pulumi.Input[_builtins.str] project_id: UUID of the project where the gateway is scoped to.
        :param pulumi.Input[_builtins.str] state: Status of the gateway resource.
        :param pulumi.Input[_builtins.str] vlan_id: UUID of the VLAN where the gateway is scoped to.
        :param pulumi.Input[_builtins.str] vrf_id: UUID of the VRF associated with the IP Reservation
        """
        if ip_reservation_id is not None:
            pulumi.set(__self__, "ip_reservation_id", ip_reservation_id)
        if private_ipv4_subnet_size is not None:
...
@pulumi.type_token("equinix:metal/gateway:Gateway")
class Gateway(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            timeouts: Optional[pulumi.Input[Union['GatewayTimeoutsArgs', 'GatewayTimeoutsArgsDict']]] = None,
            vlan_id: Optional[pulumi.Input[_builtins.str]] = None,
            vrf_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'Gateway':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="ipReservationId")
    def ip_reservation_id(self) -> pulumi.Output[_builtins.str]:
        """
        UUID of Public or VRF IP Reservation to associate with the gateway, the reservation must be in the same metro as the VLAN, conflicts with `private_ipv4_subnet_size`.
        """
        return pulumi.get(self, "ip_reservation_id")
    ...
    @_builtins.property
    @pulumi.getter(name="privateIpv4SubnetSize")
    def private_ipv4_subnet_size(self) -> pulumi.Output[_builtins.int]:
        """
        Size of the private IPv4 subnet to create for this metal gateway, must be one of `8`, `16`, `32`, `64`, `128`. Conflicts with `ip_reservation_id`.
        """
        return pulumi.get(self, "private_ipv4_subnet_size")
