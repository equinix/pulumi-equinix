...
class DeviceNetworkTypeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] device_id: The ID of the device on which the network type should be set.
        :param pulumi.Input[_builtins.str] type: Network type to set. Must be one of `layer3`, `hybrid`, `hybrid-bonded`, `layer2-individual` and `layer2-bonded`.
        """
...
@pulumi.type_token("equinix:metal/deviceNetworkType:DeviceNetworkType")
class DeviceNetworkType(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            device_id: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None) -> 'DeviceNetworkType':
        """
