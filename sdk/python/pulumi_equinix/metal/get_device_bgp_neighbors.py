...
def get_device_bgp_neighbors(device_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str device_id: UUID of BGP-enabled device whose neighbors to list.
    """
    __args__ = dict()
...
def get_device_bgp_neighbors_output(device_id: Optional[pulumi.Input[_builtins.str]] = None,
