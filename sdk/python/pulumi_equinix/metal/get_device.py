...
def get_device(device_id: Optional[_builtins.str] = None,
    ...
    test = equinix.metal.get_device(project_id=project_id,
        hostname="mydevice")
    ...
    :param _builtins.str project_id: The id of the project in which the devices exists
    """
    __args__ = dict()
...
def get_device_output(device_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
