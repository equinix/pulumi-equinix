...
class ProjectArgs:
    def __init__(__self__, *,
                 backend_transfer: Optional[pulumi.Input[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.bool] backend_transfer: Enable or disable [Backend Transfer](https://metal.equinix.com/developers/docs/networking/backend-transfer/), default is `false`.
        ...
        :param pulumi.Input[_builtins.str] name: The name of the project. The maximum length is 80 characters
        :param pulumi.Input[_builtins.str] organization_id: The UUID of organization under which you want to create the project. If you leave it out, the project will be created under your the default organization of your account.
        :param pulumi.Input[_builtins.str] payment_method_id: The UUID of payment method for this project. The payment method and the project need to belong to the same organization (passed with `organization_id`, or default).
        """
    ...
    def backend_transfer(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def backend_transfer(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class _ProjectState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ProjectBgpConfigArgs'] bgp_config: Optional BGP settings. Refer to [Equinix Metal guide for BGP](https://metal.equinix.com/developers/docs/networking/local-global-bgp/).
               ...
               > **NOTE:** Once you set the BGP config in a project, it can't be removed (due to a limitation in the Equinix Metal API). It can be updated.
        :param pulumi.Input[_builtins.str] created: The timestamp for when the project was created.
        :param pulumi.Input[_builtins.str] name: The name of the project. The maximum length is 80 characters
        :param pulumi.Input[_builtins.str] organization_id: The UUID of organization under which you want to create the project. If you leave it out, the project will be created under your the default organization of your account.
        :param pulumi.Input[_builtins.str] payment_method_id: The UUID of payment method for this project. The payment method and the project need to belong to the same organization (passed with `organization_id`, or default).
        :param pulumi.Input[_builtins.str] updated: The timestamp for the last time the project was updated.
        """
        if backend_transfer is not None:
            pulumi.set(__self__, "backend_transfer", backend_transfer)
        if bgp_config is not None:
...
@pulumi.type_token("equinix:metal/project:Project")
class Project(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            organization_id: Optional[pulumi.Input[_builtins.str]] = None,
            payment_method_id: Optional[pulumi.Input[_builtins.str]] = None,
            updated: Optional[pulumi.Input[_builtins.str]] = None) -> 'Project':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="backendTransfer")
    def backend_transfer(self) -> pulumi.Output[_builtins.bool]:
        """
        Enable or disable [Backend Transfer](https://metal.equinix.com/developers/docs/networking/backend-transfer/), default is `false`.
        """
        return pulumi.get(self, "backend_transfer")
