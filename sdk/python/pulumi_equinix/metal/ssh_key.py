...
class _SshKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name of the SSH key for identification
        :param pulumi.Input[_builtins.str] owner_id: The UUID of the Equinix Metal API User who owns this key.
        :param pulumi.Input[_builtins.str] public_key: The public key. If this is a file, it can be read using the file interpolation function
...
@pulumi.type_token("equinix:metal/sshKey:SshKey")
class SshKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            owner_id: Optional[pulumi.Input[_builtins.str]] = None,
            public_key: Optional[pulumi.Input[_builtins.str]] = None,
            updated: Optional[pulumi.Input[_builtins.str]] = None) -> 'SshKey':
        """
