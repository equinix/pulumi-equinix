...
class GetHardwareReservationResult:
    ...
    def switch_uuid(self) -> _builtins.str:
        """
...
def get_hardware_reservation(device_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str device_id: UUID of device occupying the reservation.
    :param _builtins.str id: ID of the hardware reservation.
    """
    __args__ = dict()
...
def get_hardware_reservation_output(device_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
