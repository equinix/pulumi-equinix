...
class UserApiKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: Description string for the User API Key resource.
...
class _UserApiKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] user_id: UUID of the owner of the API key.
        """
...
@pulumi.type_token("equinix:metal/userApiKey:UserApiKey")
