...
class GetProjectResult:
    ...
    def backend_transfer(self) -> _builtins.bool:
        """
...
def get_project(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The name which is used to look up the project.
    :param _builtins.str project_id: The UUID by which to look up the project.
    """
    __args__ = dict()
    __args__['name'] = name
