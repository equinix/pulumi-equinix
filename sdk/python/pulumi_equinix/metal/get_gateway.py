...
class GetGatewayResult:
    ...
    def ip_reservation_id(self) -> _builtins.str:
        """
    ...
    def private_ipv4_subnet_size(self) -> _builtins.int:
        """
...
def get_gateway(gateway_id: Optional[_builtins.str] = None,
    ...
    test_vlan = equinix.metal.Vlan("test",
        description="test VLAN in SV",
        metro="sv",
        project_id=project_id)
    test = equinix.metal.get_gateway(gateway_id=gateway_id)
    ```


    :param _builtins.str gateway_id: UUID of the metal gateway resource to retrieve.
    """
    __args__ = dict()
