...
class ProjectApiKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: Description string for the Project API Key resource.
               * `read-only` - (Optional) Flag indicating whether the API key shoud be read-only.
        :param pulumi.Input[_builtins.str] project_id: UUID of the project where the API key is scoped to.
        :param pulumi.Input[_builtins.bool] read_only: Flag indicating whether the API key shoud be read-only
        """
...
class _ProjectApiKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] project_id: UUID of the project where the API key is scoped to.
        :param pulumi.Input[_builtins.bool] read_only: Flag indicating whether the API key shoud be read-only
        :param pulumi.Input[_builtins.str] token: API token which can be used in Equinix Metal API clients
        """
...
@pulumi.type_token("equinix:metal/projectApiKey:ProjectApiKey")
class ProjectApiKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[_builtins.str]] = None,
            read_only: Optional[pulumi.Input[_builtins.bool]] = None,
            token: Optional[pulumi.Input[_builtins.str]] = None) -> 'ProjectApiKey':
        """
