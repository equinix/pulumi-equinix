...
class VrfArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] metro: Metro ID or Code where the VRF will be deployed
        :param pulumi.Input[_builtins.str] project_id: Project ID where the VRF will be deployed
        :param pulumi.Input[_builtins.str] description: Description of the VRF
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ip_ranges: All IPv4 and IPv6 Ranges that will be available to BGP Peers. IPv4 addresses must be /8 or smaller with a minimum size of /29. IPv6 must be /56 or smaller with a minimum size of /64. Ranges must not overlap other ranges within the VRF.
        :param pulumi.Input[_builtins.int] local_asn: The 4-byte ASN set on the VRF.
        :param pulumi.Input[_builtins.str] name: User-supplied name of the VRF, unique to the project
        """
...
@pulumi.type_token("equinix:metal/vrf:Vrf")
class Vrf(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            metro: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            project_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'Vrf':
        """
