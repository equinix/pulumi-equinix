...
class GetDevicesDeviceResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str sos_hostname: The hostname to use for [Serial over SSH](https://docs.equinix.com/metal/resilience-recovery/serial-over-ssh/) access to the device
