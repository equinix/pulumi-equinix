...
class GetDeviceSoftwareResult:
    ...
    def release_notes_link(self) -> _builtins.str:
        """
    ...
    def version_regex(self) -> Optional[_builtins.str]:
...
def get_device_software(device_type: Optional[_builtins.str] = None,
                        most_recent: Optional[_builtins.bool] = None,
                        packages: Optional[Sequence[_builtins.str]] = None,
                        stable: Optional[_builtins.bool] = None,
                        version_regex: Optional[_builtins.str] = None,
    ...
    :param _builtins.str device_type: Code of a device type.
    :param _builtins.bool most_recent: Boolean value to indicate that most recent version should be used *(in case when more than one result is returned)*.
    :param Sequence[_builtins.str] packages: Limits returned versions to those that are supported by given software package codes.
    :param _builtins.bool stable: Boolean value to limit query results to stable versions only.
    :param _builtins.str version_regex: A regex string to apply on returned versions and filter search results.
    """
    __args__ = dict()
...
def get_device_software_output(device_type: Optional[pulumi.Input[_builtins.str]] = None,
                               ...
                               stable: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                               version_regex: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
