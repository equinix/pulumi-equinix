...
class DeviceLinkArgs:
    def __init__(__self__, *,
                 ...
                 metro_links: pulumi.Input[Optional[Sequence[pulumi.Input['DeviceLinkMetroLinkArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] name: device link name.
        :param pulumi.Input[_builtins.str] project_id: Unique Identifier for the project resource where the device link is scoped to.If you leave it out, the device link will be created under the default project id of your organization.
        :param pulumi.Input[_builtins.str] redundancy_type: Whether the connection should be created through Fabric's primary or secondary port. Supported values: `PRIMARY` (Default), `SECONDARY`, `HYBRID`
        :param pulumi.Input[_builtins.str] subnet: device link subnet in CIDR format. Not required for link between self configured devices.
        """
    ...
    def metro_links(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DeviceLinkMetroLinkArgs']]]]:
        """
    ...
    @metro_links.setter
    def metro_links(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DeviceLinkMetroLinkArgs']]]]):
...
class _DeviceLinkState:
    def __init__(__self__, *,
                 devices: pulumi.Input[Optional[Sequence[pulumi.Input['DeviceLinkDeviceArgs']]]] = None,
                 metro_links: pulumi.Input[Optional[Sequence[pulumi.Input['DeviceLinkMetroLinkArgs']]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 project_id: pulumi.Input[Optional[_builtins.str]] = None,
                 redundancy_type: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] subnet: device link subnet in CIDR format. Not required for link between self configured devices.
        :param pulumi.Input[_builtins.str] uuid: Device link unique identifier.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def devices(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DeviceLinkDeviceArgs']]]]:
        """
        definition of one or more devices belonging to the device link. See Device section below for more details.
        """
        return pulumi.get(self, "devices")
    ...
    @devices.setter
    def devices(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DeviceLinkDeviceArgs']]]]):
        pulumi.set(self, "devices", value)
...
@pulumi.type_token("equinix:networkedge/deviceLink:DeviceLink")
class DeviceLink(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 devices: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DeviceLinkDeviceArgs', 'DeviceLinkDeviceArgsDict', 'outputs.DeviceLinkDevice']]]]] = None,
                 metro_links: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DeviceLinkMetroLinkArgs', 'DeviceLinkMetroLinkArgsDict', 'outputs.DeviceLinkMetroLink']]]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 project_id: pulumi.Input[Optional[_builtins.str]] = None,
                 redundancy_type: pulumi.Input[Optional[_builtins.str]] = None,
                 subnet: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['DeviceLinkDeviceArgs', 'DeviceLinkDeviceArgsDict', 'outputs.DeviceLinkDevice']]]] devices: definition of one or more devices belonging to the device link. See Device section below for more details.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DeviceLinkMetroLinkArgs', 'DeviceLinkMetroLinkArgsDict', 'outputs.DeviceLinkMetroLink']]]] metro_links: definition of one or more, inter metro, connections belonging to the device link. See Metro Link section below for more details.
        :param pulumi.Input[_builtins.str] name: device link name.
        :param pulumi.Input[_builtins.str] project_id: Unique Identifier for the project resource where the device link is scoped to.If you leave it out, the device link will be created under the default project id of your organization.
        :param pulumi.Input[_builtins.str] redundancy_type: Whether the connection should be created through Fabric's primary or secondary port. Supported values: `PRIMARY` (Default), `SECONDARY`, `HYBRID`
        :param pulumi.Input[_builtins.str] subnet: device link subnet in CIDR format. Not required for link between self configured devices.
    ...
    def get(resource_name: str,
            ...
            status: pulumi.Input[Optional[_builtins.str]] = None,
            subnet: pulumi.Input[Optional[_builtins.str]] = None,
            uuid: pulumi.Input[Optional[_builtins.str]] = None) -> 'DeviceLink':
        """
