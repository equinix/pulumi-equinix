...
def get_account(metro_code: Optional[_builtins.str] = None,
    ...
    :param _builtins.str metro_code: Account location metro code.
    :param _builtins.str name: Account name for filtering.
    :param _builtins.str project_id: Unique Identifier for the project resource where the account is scoped to.If you leave it out, all the billing accounts under all projects in your organization will be returned and it may return more than one account.
    :param _builtins.str status: Account status for filtering. Possible values are: `Active`, `Processing`, `Submitted`, `Staged`.
    """
    __args__ = dict()
...
def get_account_output(metro_code: Optional[pulumi.Input[_builtins.str]] = None,
