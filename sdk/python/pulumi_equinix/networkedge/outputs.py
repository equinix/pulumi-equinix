...
class DeviceClusterDetailsNode0VendorConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 management_interface_id: Optional[_builtins.str] = None,
        ...
        :param _builtins.str ip_address_type: Ip Address Type. This field is relevant only for FG VM Firewall clusters with connectivity PRIVATE option
        ...
        :param _builtins.str management_interface_id: Management Interface ID. This field is relevant only for FG VM Firewall clusters with connectivity PRIVATE option
    ...
    def management_interface_id(self) -> Optional[_builtins.str]:
        """
...
class DeviceSecondaryDevice(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str purchase_order_number: Purchase order number associated with a device order. For billing accounts that require a purchase order, this field is required.
...
class GetDeviceSecondaryDeviceResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str status: Device provisioning status
               ...
               * RESOURCE_UPGRADE_FAILED
        :param _builtins.str uuid: UUID of an existing Equinix Network Edge device
        :param Mapping[str, _builtins.str] vendor_configuration: Map of vendor specific configuration parameters for a device (controller1, activationKey, managementType, siteId, systemIpAddress, managementInterfaceId, ipAddressType)
        :param _builtins.str wan_interface_id: device interface id picked for WAN
        :param _builtins.str zone_code: Device location zone code
        """
        pulumi.set(__self__, "account_number", account_number)
