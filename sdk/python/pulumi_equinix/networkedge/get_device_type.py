...
def get_device_type_output(category: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                           metro_codes: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
