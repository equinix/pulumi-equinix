...
class GetDeviceTypeResult:
    ...
    def metro_codes(self) -> Sequence[_builtins.str]:
...
def get_device_type(category: Optional[_builtins.str] = None,
                    metro_codes: Optional[Sequence[_builtins.str]] = None,
    ...
    :param _builtins.str category: Device type category. One of: `Router`, `Firewall`, `SDWAN`.
    :param Sequence[_builtins.str] metro_codes: List of metro codes where device type has to be available
    :param _builtins.str name: Device type name.
    :param _builtins.str vendor: Device type vendor i.e. `Cisco`, `Juniper Networks`, `VERSA Networks`.
    """
    __args__ = dict()
...
def get_device_type_output(category: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           metro_codes: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
