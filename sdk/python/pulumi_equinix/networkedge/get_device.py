...
class GetDeviceResult:
    ...
    def diverse_device_id(self) -> _builtins.str:
        """
        diverse device uuid
        """
    ...
    def diverse_device_name(self) -> _builtins.str:
        """
    ...
    def interface_count(self) -> _builtins.int:
    ...
    def order_reference(self) -> _builtins.str:
        return pulumi.get(self, "order_reference")

    @_builtins.property
    @pulumi.getter(name="packageCode")
    def package_code(self) -> _builtins.str:
    ...
    def purchase_order_number(self) -> _builtins.str:
    ...
    def term_length(self) -> _builtins.int:
    ...
    def valid_status_list(self) -> Optional[_builtins.str]:
        """
...
def get_device(name: Optional[_builtins.str] = None,
               ...
               valid_status_list: Optional[_builtins.str] = None,
    ...
    :param _builtins.str valid_status_list: Device states to be considered valid when searching for a device by name
...
def get_device_output(name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                      ...
                      valid_status_list: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
