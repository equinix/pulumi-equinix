...
def get_device_platform_output(core_count: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                               device_type: pulumi.Input[Optional[_builtins.str]] = None,
                               flavor: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                               license_options: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                               management_types: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
