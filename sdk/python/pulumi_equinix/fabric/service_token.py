...
class ServiceTokenArgs:
    def __init__(__self__, *,
                 ...
                 project: pulumi.Input[Optional['ServiceTokenProjectArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def project(self) -> pulumi.Input[Optional['ServiceTokenProjectArgs']]:
        """
        Project information
        """
    ...
    @project.setter
    def project(self, value: pulumi.Input[Optional['ServiceTokenProjectArgs']]):
...
class _ServiceTokenState:
    def __init__(__self__, *,
                 accounts: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTokenAccountArgs']]]] = None,
                 change_logs: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTokenChangeLogArgs']]]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 expiration_date_time: pulumi.Input[Optional[_builtins.str]] = None,
                 href: pulumi.Input[Optional[_builtins.str]] = None,
                 issuer_side: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 notifications: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTokenNotificationArgs']]]] = None,
                 project: pulumi.Input[Optional['ServiceTokenProjectArgs']] = None,
                 service_token_connections: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTokenServiceTokenConnectionArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def accounts(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTokenAccountArgs']]]]:
        """
    ...
    @accounts.setter
    def accounts(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTokenAccountArgs']]]]):
        pulumi.set(self, "accounts", value)

    @_builtins.property
    @pulumi.getter(name="changeLogs")
    def change_logs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTokenChangeLogArgs']]]]:
        """
    ...
    @change_logs.setter
    def change_logs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTokenChangeLogArgs']]]]):
    ...
    def issuer_side(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @issuer_side.setter
    def issuer_side(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    @_builtins.property
    @pulumi.getter
    def notifications(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTokenNotificationArgs']]]]:
        """
        Preferences for notifications on Service Token configuration or status changes
        """
        return pulumi.get(self, "notifications")
    ...
    @notifications.setter
    def notifications(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTokenNotificationArgs']]]]):
        pulumi.set(self, "notifications", value)
    ...
    @_builtins.property
    @pulumi.getter(name="serviceTokenConnections")
    def service_token_connections(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTokenServiceTokenConnectionArgs']]]]:
        """
        Service Token Connection Type Information
        """
        return pulumi.get(self, "service_token_connections")
    ...
    @service_token_connections.setter
    def service_token_connections(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTokenServiceTokenConnectionArgs']]]]):
        pulumi.set(self, "service_token_connections", value)
...
class ServiceToken(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 expiration_date_time: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 notifications: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ServiceTokenNotificationArgs', 'ServiceTokenNotificationArgsDict', 'outputs.ServiceTokenNotification']]]]] = None,
                 project: pulumi.Input[Optional[Union['ServiceTokenProjectArgs', 'ServiceTokenProjectArgsDict', 'outputs.ServiceTokenProject']]] = None,
                 service_token_connections: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ServiceTokenServiceTokenConnectionArgs', 'ServiceTokenServiceTokenConnectionArgsDict', 'outputs.ServiceTokenServiceTokenConnection']]]]] = None,
                 type: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        * API: https://docs.equinix.com/fabric/fabric-api/connect-using-service-token
        ...
        :param pulumi.Input[_builtins.str] expiration_date_time: Expiration date and time of the service token; 2020-11-06T07:00:00Z
        :param pulumi.Input[_builtins.str] name: Name of the Service Token
        :param pulumi.Input[Sequence[pulumi.Input[Union['ServiceTokenNotificationArgs', 'ServiceTokenNotificationArgsDict', 'outputs.ServiceTokenNotification']]]] notifications: Preferences for notifications on Service Token configuration or status changes
        :param pulumi.Input[Union['ServiceTokenProjectArgs', 'ServiceTokenProjectArgsDict', 'outputs.ServiceTokenProject']] project: Project information
        :param pulumi.Input[Sequence[pulumi.Input[Union['ServiceTokenServiceTokenConnectionArgs', 'ServiceTokenServiceTokenConnectionArgsDict', 'outputs.ServiceTokenServiceTokenConnection']]]] service_token_connections: Service Token Connection Type Information
        :param pulumi.Input[_builtins.str] type: Service Token Type; VC*TOKEN,EPL*TOKEN
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            accounts: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ServiceTokenAccountArgs', 'ServiceTokenAccountArgsDict', 'outputs.ServiceTokenAccount']]]]] = None,
            change_logs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ServiceTokenChangeLogArgs', 'ServiceTokenChangeLogArgsDict', 'outputs.ServiceTokenChangeLog']]]]] = None,
            description: pulumi.Input[Optional[_builtins.str]] = None,
            expiration_date_time: pulumi.Input[Optional[_builtins.str]] = None,
            href: pulumi.Input[Optional[_builtins.str]] = None,
            issuer_side: pulumi.Input[Optional[_builtins.str]] = None,
            ...
            state: pulumi.Input[Optional[_builtins.str]] = None,
            type: pulumi.Input[Optional[_builtins.str]] = None,
            uuid: pulumi.Input[Optional[_builtins.str]] = None) -> 'ServiceToken':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ServiceTokenAccountArgs', 'ServiceTokenAccountArgsDict', 'outputs.ServiceTokenAccount']]]] accounts: Customer account information that is associated with this service token
        :param pulumi.Input[Sequence[pulumi.Input[Union['ServiceTokenChangeLogArgs', 'ServiceTokenChangeLogArgsDict', 'outputs.ServiceTokenChangeLog']]]] change_logs: Captures connection lifecycle change information
        :param pulumi.Input[_builtins.str] description: Optional Description to the Service Token you will be creating
        :param pulumi.Input[_builtins.str] expiration_date_time: Expiration date and time of the service token; 2020-11-06T07:00:00Z
        :param pulumi.Input[_builtins.str] href: An absolute URL that is the subject of the link's context.
        :param pulumi.Input[_builtins.str] issuer_side: Information about token side; ASIDE, ZSIDE
