...
def get_stream_subscriptions(pagination: Optional[Union['GetStreamSubscriptionsPaginationArgs', 'GetStreamSubscriptionsPaginationArgsDict', 'outputs.GetStreamSubscriptionsPaginationResult']] = None,
    ...
    * API: https://docs.equinix.com/api-catalog/fabricv4/#tag/Stream-Subscriptions
    ...
    all = equinix.fabric.get_stream_subscriptions(stream_id="<stream_id>",
        pagination={
            "limit": 10,
            "offset": 0,
        })
    ...
    :param Union['GetStreamSubscriptionsPaginationArgs', 'GetStreamSubscriptionsPaginationArgsDict', 'outputs.GetStreamSubscriptionsPaginationResult'] pagination: Pagination details for the returned streams list
    :param _builtins.str stream_id: The uuid of the stream that is the target of the stream subscription
    """
    __args__ = dict()
...
def get_stream_subscriptions_output(pagination: pulumi.Input[Optional[Union['GetStreamSubscriptionsPaginationArgs', 'GetStreamSubscriptionsPaginationArgsDict', 'outputs.GetStreamSubscriptionsPaginationResult']]] = None,
