...
def get_route_aggregations(filter: Optional[Union['GetRouteAggregationsFilterArgs', 'GetRouteAggregationsFilterArgsDict', 'outputs.GetRouteAggregationsFilterResult']] = None,
                           pagination: Optional[Union['GetRouteAggregationsPaginationArgs', 'GetRouteAggregationsPaginationArgsDict', 'outputs.GetRouteAggregationsPaginationResult']] = None,
                           sort: Optional[Union['GetRouteAggregationsSortArgs', 'GetRouteAggregationsSortArgsDict', 'outputs.GetRouteAggregationsSortResult']] = None,
    ...
    * API: https://docs.equinix.com/api-catalog/fabricv4/#tag/Route-Aggregations
    ...
    :param Union['GetRouteAggregationsFilterArgs', 'GetRouteAggregationsFilterArgsDict', 'outputs.GetRouteAggregationsFilterResult'] filter: Filters for the Data Source Search Request
    :param Union['GetRouteAggregationsPaginationArgs', 'GetRouteAggregationsPaginationArgsDict', 'outputs.GetRouteAggregationsPaginationResult'] pagination: Pagination details for the returned route aggregations list
    :param Union['GetRouteAggregationsSortArgs', 'GetRouteAggregationsSortArgsDict', 'outputs.GetRouteAggregationsSortResult'] sort: Filters for the Data Source Search Request
    """
    __args__ = dict()
...
def get_route_aggregations_output(filter: pulumi.Input[Optional[Union['GetRouteAggregationsFilterArgs', 'GetRouteAggregationsFilterArgsDict', 'outputs.GetRouteAggregationsFilterResult']]] = None,
                                  pagination: pulumi.Input[Optional[Optional[Union['GetRouteAggregationsPaginationArgs', 'GetRouteAggregationsPaginationArgsDict', 'outputs.GetRouteAggregationsPaginationResult']]]] = None,
                                  sort: pulumi.Input[Optional[Optional[Union['GetRouteAggregationsSortArgs', 'GetRouteAggregationsSortArgsDict', 'outputs.GetRouteAggregationsSortResult']]]] = None,
