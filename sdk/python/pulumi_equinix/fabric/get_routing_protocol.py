...
class GetRoutingProtocolResult:
    ...
    def as_override_enabled(self) -> _builtins.bool:
        """
    ...
    def connection_uuid(self) -> _builtins.str:
        """
...
def get_routing_protocol(connection_uuid: Optional[_builtins.str] = None,
    ...
    * API: https://developer.equinix.com/dev-docs/fabric/api-reference/fabric-v4-apis#routing-protocols
    ...
    :param _builtins.str connection_uuid: Connection URI associated with Routing Protocol
    :param _builtins.str uuid: Equinix-assigned routing protocol identifier
    """
    __args__ = dict()
...
def get_routing_protocol_output(connection_uuid: Optional[pulumi.Input[_builtins.str]] = None,
