...
def get_route_filter_rules(filters: Optional[Sequence[Union['GetRouteFilterRulesFilterArgs', 'GetRouteFilterRulesFilterArgsDict', 'outputs.GetRouteFilterRulesFilterResult']]] = None,
                           limit: Optional[_builtins.int] = None,
                           offset: Optional[_builtins.int] = None,
                           outer_operator: Optional[_builtins.str] = None,
                           route_filter_id: Optional[_builtins.str] = None,
                           sorts: Optional[Sequence[Union['GetRouteFilterRulesSortArgs', 'GetRouteFilterRulesSortArgsDict', 'outputs.GetRouteFilterRulesSortResult']]] = None,
    ...
    * API: https://docs.equinix.com/api-catalog/fabricv4/#tag/Route-Filter-Rules
    ...
    :param Sequence[Union['GetRouteFilterRulesFilterArgs', 'GetRouteFilterRulesFilterArgsDict', 'outputs.GetRouteFilterRulesFilterResult']] filters: Filters for the Data Source Search Request
    ...
    :param Sequence[Union['GetRouteFilterRulesSortArgs', 'GetRouteFilterRulesSortArgsDict', 'outputs.GetRouteFilterRulesSortResult']] sorts: Sort criteria for the Data Source Search Request
    """
    __args__ = dict()
...
def get_route_filter_rules_output(filters: pulumi.Input[Optional[Optional[Sequence[Union['GetRouteFilterRulesFilterArgs', 'GetRouteFilterRulesFilterArgsDict', 'outputs.GetRouteFilterRulesFilterResult']]]]] = None,
                                  ...
                                  sorts: pulumi.Input[Optional[Optional[Sequence[Union['GetRouteFilterRulesSortArgs', 'GetRouteFilterRulesSortArgsDict', 'outputs.GetRouteFilterRulesSortResult']]]]] = None,
