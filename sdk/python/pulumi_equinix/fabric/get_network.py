...
def get_network(uuid: Optional[_builtins.str] = None,
    ...
    * API: https://developer.equinix.com/dev-docs/fabric/api-reference/fabric-v4-apis#fabric-networks
    ...
    :param _builtins.str uuid: Equinix-assigned network identifier
    """
    __args__ = dict()
    __args__['uuid'] = uuid
...
def get_network_output(uuid: Optional[pulumi.Input[_builtins.str]] = None,
