...
def get_stream_subscription(stream_id: Optional[_builtins.str] = None,
    ...
    * API: https://developer.equinix.com/catalog/fabricv4#tag/Stream-Subscriptions
    ...
    :param _builtins.str subscription_id: The uuid of the stream subscription
    """
    __args__ = dict()
...
def get_stream_subscription_output(stream_id: Optional[pulumi.Input[_builtins.str]] = None,
