...
def get_route_filters(filters: Optional[Sequence[Union['GetRouteFiltersFilterArgs', 'GetRouteFiltersFilterArgsDict', 'outputs.GetRouteFiltersFilterResult']]] = None,
                      pagination: Optional[Union['GetRouteFiltersPaginationArgs', 'GetRouteFiltersPaginationArgsDict', 'outputs.GetRouteFiltersPaginationResult']] = None,
                      sorts: Optional[Sequence[Union['GetRouteFiltersSortArgs', 'GetRouteFiltersSortArgsDict', 'outputs.GetRouteFiltersSortResult']]] = None,
    ...
    * API: https://docs.equinix.com/api-catalog/fabricv4/#tag/Route-Filters
    ...
    :param Sequence[Union['GetRouteFiltersFilterArgs', 'GetRouteFiltersFilterArgsDict', 'outputs.GetRouteFiltersFilterResult']] filters: Filters for the Data Source Search Request. Maximum of 8 total filters.
    :param Union['GetRouteFiltersPaginationArgs', 'GetRouteFiltersPaginationArgsDict', 'outputs.GetRouteFiltersPaginationResult'] pagination: Pagination details for the Data Source Search Request
    :param Sequence[Union['GetRouteFiltersSortArgs', 'GetRouteFiltersSortArgsDict', 'outputs.GetRouteFiltersSortResult']] sorts: Filters for the Data Source Search Request
    """
    __args__ = dict()
...
def get_route_filters_output(filters: pulumi.Input[Optional[Sequence[Union['GetRouteFiltersFilterArgs', 'GetRouteFiltersFilterArgsDict', 'outputs.GetRouteFiltersFilterResult']]]] = None,
                             pagination: pulumi.Input[Optional[Optional[Union['GetRouteFiltersPaginationArgs', 'GetRouteFiltersPaginationArgsDict', 'outputs.GetRouteFiltersPaginationResult']]]] = None,
                             sorts: pulumi.Input[Optional[Optional[Sequence[Union['GetRouteFiltersSortArgs', 'GetRouteFiltersSortArgsDict', 'outputs.GetRouteFiltersSortResult']]]]] = None,
