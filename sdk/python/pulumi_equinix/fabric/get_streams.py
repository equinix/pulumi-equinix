...
def get_streams(pagination: Optional[Union['GetStreamsPaginationArgs', 'GetStreamsPaginationArgsDict', 'outputs.GetStreamsPaginationResult']] = None,
    ...
    * API: https://docs.equinix.com/api-catalog/fabricv4/#tag/Streams
    ...
    :param Union['GetStreamsPaginationArgs', 'GetStreamsPaginationArgsDict', 'outputs.GetStreamsPaginationResult'] pagination: Pagination details for the returned streams list
    """
    __args__ = dict()
...
def get_streams_output(pagination: pulumi.Input[Optional[Union['GetStreamsPaginationArgs', 'GetStreamsPaginationArgsDict', 'outputs.GetStreamsPaginationResult']]] = None,
