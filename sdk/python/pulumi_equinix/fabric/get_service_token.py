...
class GetServiceTokenResult:
    ...
    def issuer_side(self) -> _builtins.str:
        """
...
def get_service_token(uuid: Optional[_builtins.str] = None,
    ...
    * API: https://docs.equinix.com/en-us/Content/KnowledgeCenter/Fabric/GettingStarted/Integrating-with-Fabric-V4-APIs/ConnectUsingServiceToken.htm
    ...
    :param _builtins.str uuid: Equinix-assigned service token identifier
    """
    __args__ = dict()
    __args__['uuid'] = uuid
...
def get_service_token_output(uuid: Optional[pulumi.Input[_builtins.str]] = None,
