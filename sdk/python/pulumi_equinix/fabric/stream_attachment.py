...
class StreamAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 timeouts: pulumi.Input[Optional['StreamAttachmentTimeoutsArgs']] = None):
        """
        The set of arguments for constructing a StreamAttachment resource.

        :param pulumi.Input[_builtins.str] asset: Equinix defined asset category. Matches the product name the asset is a part of
        :param pulumi.Input[_builtins.str] asset_id: Equinix defined UUID of the asset being attached to the stream
        :param pulumi.Input[_builtins.str] stream_id: UUID of the stream that is the target of this asset attachment
        :param pulumi.Input[_builtins.bool] metrics_enabled: Boolean value indicating enablement of metrics for this asset stream attachment
        """
    ...
    @_builtins.property
    @pulumi.getter
    def timeouts(self) -> pulumi.Input[Optional['StreamAttachmentTimeoutsArgs']]:
        return pulumi.get(self, "timeouts")

    @timeouts.setter
    def timeouts(self, value: pulumi.Input[Optional['StreamAttachmentTimeoutsArgs']]):
...
class _StreamAttachmentState:
    def __init__(__self__, *,
                 ...
                 attachment_status: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] asset: Equinix defined asset category. Matches the product name the asset is a part of
        :param pulumi.Input[_builtins.str] asset_id: Equinix defined UUID of the asset being attached to the stream
        :param pulumi.Input[_builtins.str] attachment_status: Value representing status for the stream attachment
        :param pulumi.Input[_builtins.str] href: Equinix auto generated URI to the stream attachment in Equinix Portal
        :param pulumi.Input[_builtins.bool] metrics_enabled: Boolean value indicating enablement of metrics for this asset stream attachment
        :param pulumi.Input[_builtins.str] stream_id: UUID of the stream that is the target of this asset attachment
        :param pulumi.Input[_builtins.str] type: Equinix defined type for the asset stream attachment
        :param pulumi.Input[_builtins.str] uuid: Equinix-assigned unique id for the stream attachment
        """
    ...
    def attachment_status(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def attachment_status(self, value: pulumi.Input[Optional[_builtins.str]]):
...
@pulumi.type_token("equinix:fabric/streamAttachment:StreamAttachment")
class StreamAttachment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 metrics_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 stream_id: pulumi.Input[Optional[_builtins.str]] = None,
                 timeouts: pulumi.Input[Optional[Union['StreamAttachmentTimeoutsArgs', 'StreamAttachmentTimeoutsArgsDict', 'outputs.StreamAttachmentTimeouts']]] = None,
                 __props__=None):
        """
    ...
    def get(resource_name: str,
            ...
            timeouts: pulumi.Input[Optional[Union['StreamAttachmentTimeoutsArgs', 'StreamAttachmentTimeoutsArgsDict', 'outputs.StreamAttachmentTimeouts']]] = None,
            type: pulumi.Input[Optional[_builtins.str]] = None,
            uuid: pulumi.Input[Optional[_builtins.str]] = None) -> 'StreamAttachment':
        """
