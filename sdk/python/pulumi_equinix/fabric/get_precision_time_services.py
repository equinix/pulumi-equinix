...
def get_precision_time_services(filters: Optional[Sequence[Union['GetPrecisionTimeServicesFilterArgs', 'GetPrecisionTimeServicesFilterArgsDict', 'outputs.GetPrecisionTimeServicesFilterResult']]] = None,
                                pagination: Optional[Union['GetPrecisionTimeServicesPaginationArgs', 'GetPrecisionTimeServicesPaginationArgsDict', 'outputs.GetPrecisionTimeServicesPaginationResult']] = None,
                                sorts: Optional[Sequence[Union['GetPrecisionTimeServicesSortArgs', 'GetPrecisionTimeServicesSortArgsDict', 'outputs.GetPrecisionTimeServicesSortResult']]] = None,
    ...
    * API: https://docs.equinix.com/api-catalog/fabricv4/#tag/Precision-Time
    ...
    all = equinix.fabric.get_precision_time_services(pagination={
            "limit": 2,
            "offset": 1,
        },
        filters=[{
    ...
    pulumi.export("eptServiceId", all.datas[0].id)
    pulumi.export("eptServiceName", all.datas[0].name)
    pulumi.export("eptServiceState", all.datas[0].state)
    pulumi.export("eptServiceType", all.datas[0].type)
    pulumi.export("eptServiceIpv4", all.datas[0].ipv4)
    ```


    :param Sequence[Union['GetPrecisionTimeServicesFilterArgs', 'GetPrecisionTimeServicesFilterArgsDict', 'outputs.GetPrecisionTimeServicesFilterResult']] filters: List of filters to apply to the stream attachment get request. Maximum of 8. All will be AND'd together with 1 of the 8 being a possible OR group of 3
    :param Union['GetPrecisionTimeServicesPaginationArgs', 'GetPrecisionTimeServicesPaginationArgsDict', 'outputs.GetPrecisionTimeServicesPaginationResult'] pagination: Pagination details for the returned route aggregations list
    :param Sequence[Union['GetPrecisionTimeServicesSortArgs', 'GetPrecisionTimeServicesSortArgsDict', 'outputs.GetPrecisionTimeServicesSortResult']] sorts: Filters for the Data Source Search Request
    """
    __args__ = dict()
...
def get_precision_time_services_output(filters: pulumi.Input[Optional[Optional[Sequence[Union['GetPrecisionTimeServicesFilterArgs', 'GetPrecisionTimeServicesFilterArgsDict', 'outputs.GetPrecisionTimeServicesFilterResult']]]]] = None,
                                       pagination: pulumi.Input[Optional[Optional[Union['GetPrecisionTimeServicesPaginationArgs', 'GetPrecisionTimeServicesPaginationArgsDict', 'outputs.GetPrecisionTimeServicesPaginationResult']]]] = None,
                                       sorts: pulumi.Input[Optional[Optional[Sequence[Union['GetPrecisionTimeServicesSortArgs', 'GetPrecisionTimeServicesSortArgsDict', 'outputs.GetPrecisionTimeServicesSortResult']]]]] = None,
