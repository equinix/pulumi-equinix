...
def get_stream_alert_rule(alert_rule_id: Optional[_builtins.str] = None,
                          detection_method: Optional[Union['GetStreamAlertRuleDetectionMethodArgs', 'GetStreamAlertRuleDetectionMethodArgsDict', 'outputs.GetStreamAlertRuleDetectionMethodResult']] = None,
                          metric_selector: Optional[Union['GetStreamAlertRuleMetricSelectorArgs', 'GetStreamAlertRuleMetricSelectorArgsDict', 'outputs.GetStreamAlertRuleMetricSelectorResult']] = None,
    ...
    * API: https://docs.equinix.com/api-catalog/fabricv4/#tag/Stream-Alert-Rules
    ...
    :param Union['GetStreamAlertRuleDetectionMethodArgs', 'GetStreamAlertRuleDetectionMethodArgsDict', 'outputs.GetStreamAlertRuleDetectionMethodResult'] detection_method: Detection method for stream alert rule
    :param Union['GetStreamAlertRuleMetricSelectorArgs', 'GetStreamAlertRuleMetricSelectorArgsDict', 'outputs.GetStreamAlertRuleMetricSelectorResult'] metric_selector: Metric selector for the stream alert rule
...
def get_stream_alert_rule_output(alert_rule_id: pulumi.Input[Optional[_builtins.str]] = None,
                                 detection_method: pulumi.Input[Optional[Optional[Union['GetStreamAlertRuleDetectionMethodArgs', 'GetStreamAlertRuleDetectionMethodArgsDict', 'outputs.GetStreamAlertRuleDetectionMethodResult']]]] = None,
                                 metric_selector: pulumi.Input[Optional[Optional[Union['GetStreamAlertRuleMetricSelectorArgs', 'GetStreamAlertRuleMetricSelectorArgsDict', 'outputs.GetStreamAlertRuleMetricSelectorResult']]]] = None,
