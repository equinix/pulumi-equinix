...
class _RouteFilterState:
    def __init__(__self__, *,
                 change_logs: pulumi.Input[Optional[Sequence[pulumi.Input['RouteFilterChangeLogArgs']]]] = None,
                 changes: pulumi.Input[Optional[Sequence[pulumi.Input['RouteFilterChangeArgs']]]] = None,
                 connections_count: pulumi.Input[Optional[_builtins.int]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 href: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 not_matched_rule_action: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional['RouteFilterProjectArgs']] = None,
        ...
        :param pulumi.Input[_builtins.int] connections_count: The number of Fabric Connections that this Route Filter is attached to
        :param pulumi.Input[_builtins.str] description: Optional description to add to the Route Filter you will be creating
        :param pulumi.Input[_builtins.str] href: Route filter URI
        :param pulumi.Input[_builtins.str] name: Name of the Route Filter
        :param pulumi.Input[_builtins.str] not_matched_rule_action: The action that will be taken on ip ranges that don't match the rules present within the Route Filter
        :param pulumi.Input['RouteFilterProjectArgs'] project: The Project object that contains project_id and href that is related to the Fabric Project containing connections the Route Filter can be attached to
        :param pulumi.Input[_builtins.int] rules_count: The number of Route Filter Rules attached to this Route Filter
        :param pulumi.Input[_builtins.str] state: State of the Route Filter in its lifecycle
        :param pulumi.Input[_builtins.str] type: Route Filter Type. One of [ "BGP*IPv4*PREFIX*FILTER", "BGP*IPv6*PREFIX*FILTER" ]
        :param pulumi.Input[_builtins.str] uuid: Equinix Assigned ID for Route Filter
        """
    ...
    def change_logs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['RouteFilterChangeLogArgs']]]]:
        return pulumi.get(self, "change_logs")

    @change_logs.setter
    def change_logs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['RouteFilterChangeLogArgs']]]]):
        pulumi.set(self, "change_logs", value)

    @_builtins.property
    @pulumi.getter
    def changes(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['RouteFilterChangeArgs']]]]:
        """
    ...
    @changes.setter
    def changes(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['RouteFilterChangeArgs']]]]):
    ...
    def not_matched_rule_action(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def not_matched_rule_action(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "not_matched_rule_action", value)

    @_builtins.property
    @pulumi.getter
    def project(self) -> pulumi.Input[Optional['RouteFilterProjectArgs']]:
        """
        The Project object that contains project_id and href that is related to the Fabric Project containing connections the Route Filter can be attached to
        """
        return pulumi.get(self, "project")
    ...
    @project.setter
    def project(self, value: pulumi.Input[Optional['RouteFilterProjectArgs']]):
        pulumi.set(self, "project", value)
...
@pulumi.type_token("equinix:fabric/routeFilter:RouteFilter")
class RouteFilter(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[Union['RouteFilterProjectArgs', 'RouteFilterProjectArgsDict', 'outputs.RouteFilterProject']]] = None,
                 type: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        * API: https://docs.equinix.com/api-catalog/fabricv4/#tag/Route-Filters
        ...
        :param pulumi.Input[_builtins.str] description: Optional description to add to the Route Filter you will be creating
        :param pulumi.Input[_builtins.str] name: Name of the Route Filter
        :param pulumi.Input[Union['RouteFilterProjectArgs', 'RouteFilterProjectArgsDict', 'outputs.RouteFilterProject']] project: The Project object that contains project_id and href that is related to the Fabric Project containing connections the Route Filter can be attached to
        :param pulumi.Input[_builtins.str] type: Route Filter Type. One of [ "BGP*IPv4*PREFIX*FILTER", "BGP*IPv6*PREFIX*FILTER" ]
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            change_logs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['RouteFilterChangeLogArgs', 'RouteFilterChangeLogArgsDict', 'outputs.RouteFilterChangeLog']]]]] = None,
            changes: pulumi.Input[Optional[Sequence[pulumi.Input[Union['RouteFilterChangeArgs', 'RouteFilterChangeArgsDict', 'outputs.RouteFilterChange']]]]] = None,
            connections_count: pulumi.Input[Optional[_builtins.int]] = None,
            description: pulumi.Input[Optional[_builtins.str]] = None,
            href: pulumi.Input[Optional[_builtins.str]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            ...
            state: pulumi.Input[Optional[_builtins.str]] = None,
            type: pulumi.Input[Optional[_builtins.str]] = None,
            uuid: pulumi.Input[Optional[_builtins.str]] = None) -> 'RouteFilter':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['RouteFilterChangeArgs', 'RouteFilterChangeArgsDict', 'outputs.RouteFilterChange']]]] changes: An object with the details of the previous change applied on the Route Filter
        :param pulumi.Input[_builtins.int] connections_count: The number of Fabric Connections that this Route Filter is attached to
        :param pulumi.Input[_builtins.str] description: Optional description to add to the Route Filter you will be creating
        :param pulumi.Input[_builtins.str] href: Route filter URI
        :param pulumi.Input[_builtins.str] name: Name of the Route Filter
    ...
    @_builtins.property
    @pulumi.getter(name="notMatchedRuleAction")
    def not_matched_rule_action(self) -> pulumi.Output[_builtins.str]:
        """
        The action that will be taken on ip ranges that don't match the rules present within the Route Filter
        """
        return pulumi.get(self, "not_matched_rule_action")
