...
def get_route_aggregation_rule_output(description: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                      route_aggregation_id: pulumi.Input[Optional[_builtins.str]] = None,
                                      route_aggregation_rule_id: pulumi.Input[Optional[_builtins.str]] = None,
