...
def get_route_aggregation(route_aggregation_id: Optional[_builtins.str] = None,
...
def get_route_aggregation_output(route_aggregation_id: Optional[pulumi.Input[_builtins.str]] = None,
