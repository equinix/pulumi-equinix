...
def get_networks(filters: Optional[Sequence[Union['GetNetworksFilterArgs', 'GetNetworksFilterArgsDict', 'outputs.GetNetworksFilterResult']]] = None,
                 outer_operator: Optional[_builtins.str] = None,
                 pagination: Optional[Union['GetNetworksPaginationArgs', 'GetNetworksPaginationArgsDict', 'outputs.GetNetworksPaginationResult']] = None,
                 sorts: Optional[Sequence[Union['GetNetworksSortArgs', 'GetNetworksSortArgsDict', 'outputs.GetNetworksSortResult']]] = None,
    ...
    * API: https://docs.equinix.com/api-catalog/fabricv4/#tag/Networks
    ...
    :param Sequence[Union['GetNetworksFilterArgs', 'GetNetworksFilterArgsDict', 'outputs.GetNetworksFilterResult']] filters: Filters for the Data Source Search Request
    :param _builtins.str outer_operator: Determines if the filter list will be grouped by AND or by OR. One of [AND, OR]
    :param Union['GetNetworksPaginationArgs', 'GetNetworksPaginationArgsDict', 'outputs.GetNetworksPaginationResult'] pagination: Pagination details for the Data Source Search Request
    :param Sequence[Union['GetNetworksSortArgs', 'GetNetworksSortArgsDict', 'outputs.GetNetworksSortResult']] sorts: Filters for the Data Source Search Request
    """
    __args__ = dict()
...
def get_networks_output(filters: pulumi.Input[Optional[Sequence[Union['GetNetworksFilterArgs', 'GetNetworksFilterArgsDict', 'outputs.GetNetworksFilterResult']]]] = None,
                        outer_operator: pulumi.Input[Optional[_builtins.str]] = None,
                        pagination: pulumi.Input[Optional[Optional[Union['GetNetworksPaginationArgs', 'GetNetworksPaginationArgsDict', 'outputs.GetNetworksPaginationResult']]]] = None,
                        sorts: pulumi.Input[Optional[Optional[Sequence[Union['GetNetworksSortArgs', 'GetNetworksSortArgsDict', 'outputs.GetNetworksSortResult']]]]] = None,
