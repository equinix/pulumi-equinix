...
def get_service_tokens(filters: Optional[Sequence[Union['GetServiceTokensFilterArgs', 'GetServiceTokensFilterArgsDict', 'outputs.GetServiceTokensFilterResult']]] = None,
                       pagination: Optional[Union['GetServiceTokensPaginationArgs', 'GetServiceTokensPaginationArgsDict', 'outputs.GetServiceTokensPaginationResult']] = None,
    ...
    * API: https://docs.equinix.com/fabric/fabric-api/connect-using-service-token
    ...
    :param Sequence[Union['GetServiceTokensFilterArgs', 'GetServiceTokensFilterArgsDict', 'outputs.GetServiceTokensFilterResult']] filters: Filters for the Data Source Search Request
    :param Union['GetServiceTokensPaginationArgs', 'GetServiceTokensPaginationArgsDict', 'outputs.GetServiceTokensPaginationResult'] pagination: Pagination details for the Data Source Search Request
    """
    __args__ = dict()
...
def get_service_tokens_output(filters: pulumi.Input[Optional[Sequence[Union['GetServiceTokensFilterArgs', 'GetServiceTokensFilterArgsDict', 'outputs.GetServiceTokensFilterResult']]]] = None,
                              pagination: pulumi.Input[Optional[Optional[Union['GetServiceTokensPaginationArgs', 'GetServiceTokensPaginationArgsDict', 'outputs.GetServiceTokensPaginationResult']]]] = None,
