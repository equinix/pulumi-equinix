...
class GetCloudRouterResult:
    ...
    def gateway_attachments_count(self) -> _builtins.int:
        """
...
def get_cloud_router(uuid: Optional[_builtins.str] = None,
    ...
    * API: https://developer.equinix.com/dev-docs/fabric/api-reference/fabric-v4-apis#fabric-cloud-routers
    ...
    :param _builtins.str uuid: Equinix-assigned Fabric Cloud Router identifier
    """
    __args__ = dict()
    __args__['uuid'] = uuid
...
def get_cloud_router_output(uuid: Optional[pulumi.Input[_builtins.str]] = None,
