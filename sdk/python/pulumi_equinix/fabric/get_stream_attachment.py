...
def get_stream_attachment(asset: Optional[_builtins.str] = None,
    ...
    * API: https://developer.equinix.com/catalog/fabricv4#tag/Streams
    ...
    by_ids = equinix.fabric.get_stream_attachment(asset_id="<id_of_the_asset_being_attached>",
        asset="<asset_group>",
        stream_id="<id_of_the_stream_asset_is_being_attached_to>")
    ```


    :param _builtins.str asset: Equinix defined asset category. Matches the product name the asset is a part of
    :param _builtins.str asset_id: Equinix defined UUID of the asset being attached to the stream
...
def get_stream_attachment_output(asset: Optional[pulumi.Input[_builtins.str]] = None,
