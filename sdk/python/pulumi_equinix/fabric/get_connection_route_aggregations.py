...
def get_connection_route_aggregations(connection_id: Optional[_builtins.str] = None,
                                      pagination: Optional[Union['GetConnectionRouteAggregationsPaginationArgs', 'GetConnectionRouteAggregationsPaginationArgsDict', 'outputs.GetConnectionRouteAggregationsPaginationResult']] = None,
    ...
    * API: https://docs.equinix.com/api-catalog/fabricv4/#tag/Route-Aggregations
    ...
    :param Union['GetConnectionRouteAggregationsPaginationArgs', 'GetConnectionRouteAggregationsPaginationArgsDict', 'outputs.GetConnectionRouteAggregationsPaginationResult'] pagination: Pagination details for the returned connection route aggregations list
    """
    __args__ = dict()
...
def get_connection_route_aggregations_output(connection_id: pulumi.Input[Optional[_builtins.str]] = None,
                                             pagination: pulumi.Input[Optional[Optional[Union['GetConnectionRouteAggregationsPaginationArgs', 'GetConnectionRouteAggregationsPaginationArgsDict', 'outputs.GetConnectionRouteAggregationsPaginationResult']]]] = None,
