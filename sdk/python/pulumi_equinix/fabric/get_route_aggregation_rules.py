...
class GetRouteAggregationRulesResult:
    ...
    def outer_operator(self) -> _builtins.str:
        """
...
def get_route_aggregation_rules(filters: Optional[Sequence[Union['GetRouteAggregationRulesFilterArgs', 'GetRouteAggregationRulesFilterArgsDict', 'outputs.GetRouteAggregationRulesFilterResult']]] = None,
                                outer_operator: Optional[_builtins.str] = None,
                                pagination: Optional[Union['GetRouteAggregationRulesPaginationArgs', 'GetRouteAggregationRulesPaginationArgsDict', 'outputs.GetRouteAggregationRulesPaginationResult']] = None,
                                route_aggregation_id: Optional[_builtins.str] = None,
                                sorts: Optional[Sequence[Union['GetRouteAggregationRulesSortArgs', 'GetRouteAggregationRulesSortArgsDict', 'outputs.GetRouteAggregationRulesSortResult']]] = None,
    ...
    * API: https://docs.equinix.com/api-catalog/fabricv4/#tag/Route-Aggregation-Rules/operation/searchRouteAggregationRules
    ...
    :param Sequence[Union['GetRouteAggregationRulesFilterArgs', 'GetRouteAggregationRulesFilterArgsDict', 'outputs.GetRouteAggregationRulesFilterResult']] filters: Filters for the Data Source Search Request
    :param _builtins.str outer_operator: Determines if the filter list will be grouped by AND or by OR. One of [AND, OR]
    :param Union['GetRouteAggregationRulesPaginationArgs', 'GetRouteAggregationRulesPaginationArgsDict', 'outputs.GetRouteAggregationRulesPaginationResult'] pagination: Pagination details for the returned Route Aggregation Rules list
    :param _builtins.str route_aggregation_id: The UUID of the Route Aggregation from which this data source retrieves its rules.
    :param Sequence[Union['GetRouteAggregationRulesSortArgs', 'GetRouteAggregationRulesSortArgsDict', 'outputs.GetRouteAggregationRulesSortResult']] sorts: Sort criteria for the Data Source Search Request
    """
    __args__ = dict()
...
def get_route_aggregation_rules_output(filters: pulumi.Input[Optional[Optional[Sequence[Union['GetRouteAggregationRulesFilterArgs', 'GetRouteAggregationRulesFilterArgsDict', 'outputs.GetRouteAggregationRulesFilterResult']]]]] = None,
                                       outer_operator: pulumi.Input[Optional[_builtins.str]] = None,
                                       pagination: pulumi.Input[Optional[Optional[Union['GetRouteAggregationRulesPaginationArgs', 'GetRouteAggregationRulesPaginationArgsDict', 'outputs.GetRouteAggregationRulesPaginationResult']]]] = None,
                                       route_aggregation_id: pulumi.Input[Optional[_builtins.str]] = None,
                                       sorts: pulumi.Input[Optional[Optional[Sequence[Union['GetRouteAggregationRulesSortArgs', 'GetRouteAggregationRulesSortArgsDict', 'outputs.GetRouteAggregationRulesSortResult']]]]] = None,
