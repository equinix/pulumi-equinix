...
class GetPortResult:
    ...
    def available_bandwidth(self) -> _builtins.int:
        """
    ...
    def lag_enabled(self) -> _builtins.bool:
        """
        Port Lag
        """
    ...
    def used_bandwidth(self) -> _builtins.int:
        """
...
def get_port(uuid: Optional[_builtins.str] = None,
    ...
    * API: https://docs.equinix.com/api-catalog/fabricv4/#tag/Ports
    ...
    pulumi.export("deviceRedundancyEnabled", port_data_name.device.redundancy["enabled"])
    pulumi.export("deviceRedundancyPriority", port_data_name.device.redundancy["priority"])
    ```


    :param _builtins.str uuid: Equinix-assigned port identifier
    """
    __args__ = dict()
    __args__['uuid'] = uuid
...
def get_port_output(uuid: pulumi.Input[Optional[_builtins.str]] = None,
