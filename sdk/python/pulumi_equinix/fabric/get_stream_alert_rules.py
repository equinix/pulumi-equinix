...
def get_stream_alert_rules(pagination: Optional[Union['GetStreamAlertRulesPaginationArgs', 'GetStreamAlertRulesPaginationArgsDict', 'outputs.GetStreamAlertRulesPaginationResult']] = None,
    ...
    * API: https://docs.equinix.com/api-catalog/fabricv4/#tag/Stream-Alert-Rules
    ...
    pulumi.export("streamAlertRulesType", alert_rules["data"][0]["type"])
    pulumi.export("streamAlertRulesId", alert_rules["data"][0]["uuid"])
    pulumi.export("streamAlertRulesState", alert_rules["data"][0]["state"])
    pulumi.export("streamAlertRulesStreamId", alert_rules["data"][0]["streamId"])
    ```


    :param Union['GetStreamAlertRulesPaginationArgs', 'GetStreamAlertRulesPaginationArgsDict', 'outputs.GetStreamAlertRulesPaginationResult'] pagination: Pagination details for the returned stream alert rules list
...
def get_stream_alert_rules_output(pagination: pulumi.Input[Optional[Union['GetStreamAlertRulesPaginationArgs', 'GetStreamAlertRulesPaginationArgsDict', 'outputs.GetStreamAlertRulesPaginationResult']]] = None,
