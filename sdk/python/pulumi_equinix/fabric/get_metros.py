...
def get_metros(pagination: Optional[Union['GetMetrosPaginationArgs', 'GetMetrosPaginationArgsDict', 'outputs.GetMetrosPaginationResult']] = None,
    ...
    :param Union['GetMetrosPaginationArgs', 'GetMetrosPaginationArgsDict', 'outputs.GetMetrosPaginationResult'] pagination: Pagination details for the returned metro list
...
def get_metros_output(pagination: pulumi.Input[Optional[Union['GetMetrosPaginationArgs', 'GetMetrosPaginationArgsDict', 'outputs.GetMetrosPaginationResult']]] = None,
                      presence: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
