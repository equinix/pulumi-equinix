...
def get_cloud_routers(filters: Optional[Sequence[Union['GetCloudRoutersFilterArgs', 'GetCloudRoutersFilterArgsDict', 'outputs.GetCloudRoutersFilterResult']]] = None,
                      pagination: Optional[Union['GetCloudRoutersPaginationArgs', 'GetCloudRoutersPaginationArgsDict', 'outputs.GetCloudRoutersPaginationResult']] = None,
                      sort: Optional[Union['GetCloudRoutersSortArgs', 'GetCloudRoutersSortArgsDict', 'outputs.GetCloudRoutersSortResult']] = None,
    ...
    * API: https://docs.equinix.com/api-catalog/fabricv4/#tag/Cloud-Routers
    ...
    :param Sequence[Union['GetCloudRoutersFilterArgs', 'GetCloudRoutersFilterArgsDict', 'outputs.GetCloudRoutersFilterResult']] filters: Filters for the Data Source Search Request. Maximum of 8 total filters.
    :param Union['GetCloudRoutersPaginationArgs', 'GetCloudRoutersPaginationArgsDict', 'outputs.GetCloudRoutersPaginationResult'] pagination: Pagination details for the Data Source Search Request
    :param Union['GetCloudRoutersSortArgs', 'GetCloudRoutersSortArgsDict', 'outputs.GetCloudRoutersSortResult'] sort: Filters for the Data Source Search Request
    """
    __args__ = dict()
...
def get_cloud_routers_output(filters: pulumi.Input[Optional[Sequence[Union['GetCloudRoutersFilterArgs', 'GetCloudRoutersFilterArgsDict', 'outputs.GetCloudRoutersFilterResult']]]] = None,
                             pagination: pulumi.Input[Optional[Optional[Union['GetCloudRoutersPaginationArgs', 'GetCloudRoutersPaginationArgsDict', 'outputs.GetCloudRoutersPaginationResult']]]] = None,
                             sort: pulumi.Input[Optional[Optional[Union['GetCloudRoutersSortArgs', 'GetCloudRoutersSortArgsDict', 'outputs.GetCloudRoutersSortResult']]]] = None,
