...
def get_precision_time_service(ept_service_id: Optional[_builtins.str] = None,
                               ntp_advanced_configurations: Optional[Sequence[Union['GetPrecisionTimeServiceNtpAdvancedConfigurationArgs', 'GetPrecisionTimeServiceNtpAdvancedConfigurationArgsDict', 'outputs.GetPrecisionTimeServiceNtpAdvancedConfigurationResult']]] = None,
                               project: Optional[Union['GetPrecisionTimeServiceProjectArgs', 'GetPrecisionTimeServiceProjectArgsDict', 'outputs.GetPrecisionTimeServiceProjectResult']] = None,
                               ptp_advanced_configuration: Optional[Union['GetPrecisionTimeServicePtpAdvancedConfigurationArgs', 'GetPrecisionTimeServicePtpAdvancedConfigurationArgsDict', 'outputs.GetPrecisionTimeServicePtpAdvancedConfigurationResult']] = None,
    ...
    * API: https://docs.equinix.com/api-catalog/fabricv4/#tag/Precision-Time
    ...
    :param Sequence[Union['GetPrecisionTimeServiceNtpAdvancedConfigurationArgs', 'GetPrecisionTimeServiceNtpAdvancedConfigurationArgsDict', 'outputs.GetPrecisionTimeServiceNtpAdvancedConfigurationResult']] ntp_advanced_configurations: NTP Advanced configuration
    :param Union['GetPrecisionTimeServiceProjectArgs', 'GetPrecisionTimeServiceProjectArgsDict', 'outputs.GetPrecisionTimeServiceProjectResult'] project: Equinix Project attribute object
    :param Union['GetPrecisionTimeServicePtpAdvancedConfigurationArgs', 'GetPrecisionTimeServicePtpAdvancedConfigurationArgsDict', 'outputs.GetPrecisionTimeServicePtpAdvancedConfigurationResult'] ptp_advanced_configuration: PTP Advanced Configuration
    """
    __args__ = dict()
...
def get_precision_time_service_output(ept_service_id: pulumi.Input[Optional[_builtins.str]] = None,
                                      ntp_advanced_configurations: pulumi.Input[Optional[Optional[Sequence[Union['GetPrecisionTimeServiceNtpAdvancedConfigurationArgs', 'GetPrecisionTimeServiceNtpAdvancedConfigurationArgsDict', 'outputs.GetPrecisionTimeServiceNtpAdvancedConfigurationResult']]]]] = None,
                                      project: pulumi.Input[Optional[Optional[Union['GetPrecisionTimeServiceProjectArgs', 'GetPrecisionTimeServiceProjectArgsDict', 'outputs.GetPrecisionTimeServiceProjectResult']]]] = None,
                                      ptp_advanced_configuration: pulumi.Input[Optional[Optional[Union['GetPrecisionTimeServicePtpAdvancedConfigurationArgs', 'GetPrecisionTimeServicePtpAdvancedConfigurationArgsDict', 'outputs.GetPrecisionTimeServicePtpAdvancedConfigurationResult']]]] = None,
