...
def get_connection_route_filter(connection_id: Optional[_builtins.str] = None,
    ...
    * API: https://developer.equinix.com/dev-docs/fabric/api-reference/fabric-v4-apis#route-filter-rules
    ...
    :param _builtins.str connection_id: Equinix Assigned UUID of the Equinix Connection to attach the Route Filter Policy to
    :param _builtins.str route_filter_id: Equinix Assigned UUID of the Route Filter Policy to attach to the Equinix Connection
    """
    __args__ = dict()
...
def get_connection_route_filter_output(connection_id: Optional[pulumi.Input[_builtins.str]] = None,
