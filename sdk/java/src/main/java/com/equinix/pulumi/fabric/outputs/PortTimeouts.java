...
@CustomType
public final class PortTimeouts {
    /**
    ...
    public static Builder builder(PortTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(PortTimeouts defaults) {
        ...
        public PortTimeouts build() {
            final var _resultValue = new PortTimeouts();
