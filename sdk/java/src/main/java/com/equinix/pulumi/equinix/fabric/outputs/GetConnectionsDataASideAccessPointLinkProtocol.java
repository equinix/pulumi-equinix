...
@CustomType
public final class GetConnectionsDataASideAccessPointLinkProtocol {
    /**
    ...
    private GetConnectionsDataASideAccessPointLinkProtocol() {}
    /**
     * @return Type of the link protocol - UNTAGGED, DOT1Q, QINQ, EVPN_VXLAN
     * 
     */
    ...
    public static Builder builder(GetConnectionsDataASideAccessPointLinkProtocol defaults) {
    ...
    public static final class Builder {
        ...
        private Integer vlanTag;
        public Builder() {}
        public Builder(GetConnectionsDataASideAccessPointLinkProtocol defaults) {
        ...
        public GetConnectionsDataASideAccessPointLinkProtocol build() {
            final var _resultValue = new GetConnectionsDataASideAccessPointLinkProtocol();
