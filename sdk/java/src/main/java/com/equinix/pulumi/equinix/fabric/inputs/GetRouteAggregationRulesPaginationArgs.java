...
public final class GetRouteAggregationRulesPaginationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetRouteAggregationRulesPaginationArgs Empty = new GetRouteAggregationRulesPaginationArgs();
    ...
    private GetRouteAggregationRulesPaginationArgs() {}

    private GetRouteAggregationRulesPaginationArgs(GetRouteAggregationRulesPaginationArgs $) {
        this.limit = $.limit;
        this.next = $.next;
        this.offset = $.offset;
    ...
    public static Builder builder(GetRouteAggregationRulesPaginationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRouteAggregationRulesPaginationArgs();
        }

        public Builder(GetRouteAggregationRulesPaginationArgs defaults) {
            $ = new GetRouteAggregationRulesPaginationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRouteAggregationRulesPaginationArgs build() {
            if ($.limit == null) {
                throw new MissingRequiredPropertyException("GetRouteAggregationRulesPaginationArgs", "limit");
            }
            if ($.next == null) {
                throw new MissingRequiredPropertyException("GetRouteAggregationRulesPaginationArgs", "next");
            }
            if ($.offset == null) {
                throw new MissingRequiredPropertyException("GetRouteAggregationRulesPaginationArgs", "offset");
            }
            if ($.previous == null) {
                throw new MissingRequiredPropertyException("GetRouteAggregationRulesPaginationArgs", "previous");
            }
            if ($.total == null) {
                throw new MissingRequiredPropertyException("GetRouteAggregationRulesPaginationArgs", "total");
            }
            return $;
        }
    }
