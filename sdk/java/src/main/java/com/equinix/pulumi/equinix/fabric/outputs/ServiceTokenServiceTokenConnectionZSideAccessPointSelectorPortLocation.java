...
@CustomType
public final class ServiceTokenServiceTokenConnectionZSideAccessPointSelectorPortLocation {
    /**
     * @return IBX Code
     * 
     */
    ...
    public static Builder builder(ServiceTokenServiceTokenConnectionZSideAccessPointSelectorPortLocation defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String region;
        public Builder() {}
        public Builder(ServiceTokenServiceTokenConnectionZSideAccessPointSelectorPortLocation defaults) {
        ...
        public ServiceTokenServiceTokenConnectionZSideAccessPointSelectorPortLocation build() {
            final var _resultValue = new ServiceTokenServiceTokenConnectionZSideAccessPointSelectorPortLocation();
