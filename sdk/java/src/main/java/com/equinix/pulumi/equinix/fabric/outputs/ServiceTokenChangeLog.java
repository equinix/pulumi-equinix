...
@CustomType
public final class ServiceTokenChangeLog {
    /**
    ...
    public static Builder builder(ServiceTokenChangeLog defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String updatedDateTime;
        public Builder() {}
        public Builder(ServiceTokenChangeLog defaults) {
        ...
        public ServiceTokenChangeLog build() {
            final var _resultValue = new ServiceTokenChangeLog();
