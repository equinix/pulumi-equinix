...
public final class ServiceProfileChangeLogArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceProfileChangeLogArgs Empty = new ServiceProfileChangeLogArgs();
    ...
    private ServiceProfileChangeLogArgs() {}

    private ServiceProfileChangeLogArgs(ServiceProfileChangeLogArgs $) {
    ...
    public static Builder builder(ServiceProfileChangeLogArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceProfileChangeLogArgs();
        }

        public Builder(ServiceProfileChangeLogArgs defaults) {
            $ = new ServiceProfileChangeLogArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceProfileChangeLogArgs build() {
            return $;
        }
    }
