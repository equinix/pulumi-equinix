...
public final class NetworkNotificationArgs extends com.pulumi.resources.ResourceArgs {

    public static final NetworkNotificationArgs Empty = new NetworkNotificationArgs();
    ...
    private NetworkNotificationArgs() {}

    private NetworkNotificationArgs(NetworkNotificationArgs $) {
        this.emails = $.emails;
    ...
    public static Builder builder(NetworkNotificationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetworkNotificationArgs();
        }

        public Builder(NetworkNotificationArgs defaults) {
            $ = new NetworkNotificationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NetworkNotificationArgs build() {
            if ($.emails == null) {
                throw new MissingRequiredPropertyException("NetworkNotificationArgs", "emails");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("NetworkNotificationArgs", "type");
            }
            return $;
        }
    }
