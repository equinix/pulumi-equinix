...
@CustomType
public final class ServiceTokenAccount {
    /**
    ...
    public static Builder builder(ServiceTokenAccount defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String ucmId;
        public Builder() {}
        public Builder(ServiceTokenAccount defaults) {
        ...
        public ServiceTokenAccount build() {
            final var _resultValue = new ServiceTokenAccount();
