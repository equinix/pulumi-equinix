...
import com.equinix.pulumi.equinix.fabric.outputs.GetServiceProfilesDatumPortLocation;
...
public final class GetServiceProfilesDatumPort {
    ...
    public static Builder builder(GetServiceProfilesDatumPort defaults) {
    ...
    public static final class Builder {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetServiceProfilesDatumPort", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder uuid(String uuid) {
            if (uuid == null) {
              throw new MissingRequiredPropertyException("GetServiceProfilesDatumPort", "uuid");
            }
            this.uuid = uuid;
            return this;
        }
