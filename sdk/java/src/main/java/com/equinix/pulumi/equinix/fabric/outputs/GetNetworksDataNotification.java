...
@CustomType
public final class GetNetworksDataNotification {
    /**
    ...
    private GetNetworksDataNotification() {}
    /**
     * @return Array of contact emails
     * 
     */
    ...
    public static Builder builder(GetNetworksDataNotification defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetNetworksDataNotification defaults) {
        ...
        public Builder emails(List<String> emails) {
            if (emails == null) {
              throw new MissingRequiredPropertyException("GetNetworksDataNotification", "emails");
            }
            this.emails = emails;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetNetworksDataNotification", "type");
            }
            this.type = type;
            return this;
        }
        public GetNetworksDataNotification build() {
            final var _resultValue = new GetNetworksDataNotification();
