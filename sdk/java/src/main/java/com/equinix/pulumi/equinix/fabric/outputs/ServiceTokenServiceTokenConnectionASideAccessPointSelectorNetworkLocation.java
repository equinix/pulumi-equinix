...
@CustomType
public final class ServiceTokenServiceTokenConnectionASideAccessPointSelectorNetworkLocation {
    /**
     * @return IBX Code
     * 
     */
    ...
    public static Builder builder(ServiceTokenServiceTokenConnectionASideAccessPointSelectorNetworkLocation defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String region;
        public Builder() {}
        public Builder(ServiceTokenServiceTokenConnectionASideAccessPointSelectorNetworkLocation defaults) {
        ...
        public ServiceTokenServiceTokenConnectionASideAccessPointSelectorNetworkLocation build() {
            final var _resultValue = new ServiceTokenServiceTokenConnectionASideAccessPointSelectorNetworkLocation();
