...
public final class GetConnectionZSideAccessPointProfileAccessPointTypeConfig {
    ...
    public static final class Builder {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetConnectionZSideAccessPointProfileAccessPointTypeConfig", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder uuid(String uuid) {
            if (uuid == null) {
              throw new MissingRequiredPropertyException("GetConnectionZSideAccessPointProfileAccessPointTypeConfig", "uuid");
            }
            this.uuid = uuid;
            return this;
        }
