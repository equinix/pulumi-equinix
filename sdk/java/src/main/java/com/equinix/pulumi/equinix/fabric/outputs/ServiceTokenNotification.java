...
@CustomType
public final class ServiceTokenNotification {
    /**
    ...
    private ServiceTokenNotification() {}
    /**
     * @return Array of contact emails
     * 
     */
    ...
    public static Builder builder(ServiceTokenNotification defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(ServiceTokenNotification defaults) {
        ...
        public Builder emails(List<String> emails) {
            if (emails == null) {
              throw new MissingRequiredPropertyException("ServiceTokenNotification", "emails");
            }
            this.emails = emails;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("ServiceTokenNotification", "type");
            }
            this.type = type;
            return this;
        }
        public ServiceTokenNotification build() {
            final var _resultValue = new ServiceTokenNotification();
