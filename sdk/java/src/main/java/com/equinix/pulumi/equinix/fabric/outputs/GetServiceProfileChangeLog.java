...
@CustomType
public final class GetServiceProfileChangeLog {
    /**
    ...
    private GetServiceProfileChangeLog() {}
    /**
     * @return Created by User Key
     * 
     */
    ...
    public static Builder builder(GetServiceProfileChangeLog defaults) {
    ...
    public static final class Builder {
        ...
        private String updatedDateTime;
        public Builder() {}
        public Builder(GetServiceProfileChangeLog defaults) {
        ...
        public Builder createdBy(String createdBy) {
            if (createdBy == null) {
              throw new MissingRequiredPropertyException("GetServiceProfileChangeLog", "createdBy");
            }
        ...
        public Builder createdByEmail(String createdByEmail) {
            if (createdByEmail == null) {
              throw new MissingRequiredPropertyException("GetServiceProfileChangeLog", "createdByEmail");
            }
        ...
        public Builder createdByFullName(String createdByFullName) {
            if (createdByFullName == null) {
              throw new MissingRequiredPropertyException("GetServiceProfileChangeLog", "createdByFullName");
            }
        ...
        public Builder createdDateTime(String createdDateTime) {
            if (createdDateTime == null) {
              throw new MissingRequiredPropertyException("GetServiceProfileChangeLog", "createdDateTime");
            }
        ...
        public Builder deletedBy(String deletedBy) {
            if (deletedBy == null) {
              throw new MissingRequiredPropertyException("GetServiceProfileChangeLog", "deletedBy");
            }
        ...
        public Builder deletedByEmail(String deletedByEmail) {
            if (deletedByEmail == null) {
              throw new MissingRequiredPropertyException("GetServiceProfileChangeLog", "deletedByEmail");
            }
        ...
        public Builder deletedByFullName(String deletedByFullName) {
            if (deletedByFullName == null) {
              throw new MissingRequiredPropertyException("GetServiceProfileChangeLog", "deletedByFullName");
            }
        ...
        public Builder deletedDateTime(String deletedDateTime) {
            if (deletedDateTime == null) {
              throw new MissingRequiredPropertyException("GetServiceProfileChangeLog", "deletedDateTime");
            }
        ...
        public Builder updatedBy(String updatedBy) {
            if (updatedBy == null) {
              throw new MissingRequiredPropertyException("GetServiceProfileChangeLog", "updatedBy");
            }
        ...
        public Builder updatedByEmail(String updatedByEmail) {
            if (updatedByEmail == null) {
              throw new MissingRequiredPropertyException("GetServiceProfileChangeLog", "updatedByEmail");
            }
        ...
        public Builder updatedByFullName(String updatedByFullName) {
            if (updatedByFullName == null) {
              throw new MissingRequiredPropertyException("GetServiceProfileChangeLog", "updatedByFullName");
            }
        ...
        public Builder updatedDateTime(String updatedDateTime) {
            if (updatedDateTime == null) {
              throw new MissingRequiredPropertyException("GetServiceProfileChangeLog", "updatedDateTime");
            }
            this.updatedDateTime = updatedDateTime;
            return this;
        }
        public GetServiceProfileChangeLog build() {
            final var _resultValue = new GetServiceProfileChangeLog();
