...
public final class GetConnectionRouteAggregationsPaginationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetConnectionRouteAggregationsPaginationArgs Empty = new GetConnectionRouteAggregationsPaginationArgs();
    ...
    private GetConnectionRouteAggregationsPaginationArgs() {}

    private GetConnectionRouteAggregationsPaginationArgs(GetConnectionRouteAggregationsPaginationArgs $) {
        this.limit = $.limit;
        this.next = $.next;
        this.offset = $.offset;
    ...
    public static Builder builder(GetConnectionRouteAggregationsPaginationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetConnectionRouteAggregationsPaginationArgs();
        }

        public Builder(GetConnectionRouteAggregationsPaginationArgs defaults) {
            $ = new GetConnectionRouteAggregationsPaginationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetConnectionRouteAggregationsPaginationArgs build() {
            if ($.limit == null) {
                throw new MissingRequiredPropertyException("GetConnectionRouteAggregationsPaginationArgs", "limit");
            }
            if ($.next == null) {
                throw new MissingRequiredPropertyException("GetConnectionRouteAggregationsPaginationArgs", "next");
            }
            if ($.offset == null) {
                throw new MissingRequiredPropertyException("GetConnectionRouteAggregationsPaginationArgs", "offset");
            }
            if ($.previous == null) {
                throw new MissingRequiredPropertyException("GetConnectionRouteAggregationsPaginationArgs", "previous");
            }
            if ($.total == null) {
                throw new MissingRequiredPropertyException("GetConnectionRouteAggregationsPaginationArgs", "total");
            }
            return $;
        }
    }
