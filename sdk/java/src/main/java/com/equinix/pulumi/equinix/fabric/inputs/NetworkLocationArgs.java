...
public final class NetworkLocationArgs extends com.pulumi.resources.ResourceArgs {

    public static final NetworkLocationArgs Empty = new NetworkLocationArgs();
    ...
    private NetworkLocationArgs(NetworkLocationArgs $) {
        this.ibx = $.ibx;
    ...
    public static Builder builder(NetworkLocationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetworkLocationArgs();
        }

        public Builder(NetworkLocationArgs defaults) {
            $ = new NetworkLocationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NetworkLocationArgs build() {
            return $;
        }
    }
