...
public final class GetRouteFiltersPaginationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetRouteFiltersPaginationArgs Empty = new GetRouteFiltersPaginationArgs();
    ...
    private GetRouteFiltersPaginationArgs() {}

    private GetRouteFiltersPaginationArgs(GetRouteFiltersPaginationArgs $) {
        this.limit = $.limit;
        this.next = $.next;
        this.offset = $.offset;
    ...
    public static Builder builder(GetRouteFiltersPaginationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRouteFiltersPaginationArgs();
        }

        public Builder(GetRouteFiltersPaginationArgs defaults) {
            $ = new GetRouteFiltersPaginationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRouteFiltersPaginationArgs build() {
            if ($.limit == null) {
                throw new MissingRequiredPropertyException("GetRouteFiltersPaginationArgs", "limit");
            }
            if ($.next == null) {
                throw new MissingRequiredPropertyException("GetRouteFiltersPaginationArgs", "next");
            }
            if ($.offset == null) {
                throw new MissingRequiredPropertyException("GetRouteFiltersPaginationArgs", "offset");
            }
            if ($.previous == null) {
                throw new MissingRequiredPropertyException("GetRouteFiltersPaginationArgs", "previous");
            }
            if ($.total == null) {
                throw new MissingRequiredPropertyException("GetRouteFiltersPaginationArgs", "total");
            }
            return $;
        }
    }
