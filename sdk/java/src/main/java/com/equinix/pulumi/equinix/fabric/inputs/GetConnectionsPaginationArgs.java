...
public final class GetConnectionsPaginationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetConnectionsPaginationArgs Empty = new GetConnectionsPaginationArgs();
    ...
    private GetConnectionsPaginationArgs() {}

    private GetConnectionsPaginationArgs(GetConnectionsPaginationArgs $) {
        this.limit = $.limit;
        this.offset = $.offset;
    }
    ...
    public static Builder builder(GetConnectionsPaginationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetConnectionsPaginationArgs();
        }

        public Builder(GetConnectionsPaginationArgs defaults) {
            $ = new GetConnectionsPaginationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetConnectionsPaginationArgs build() {
            return $;
        }
    }
