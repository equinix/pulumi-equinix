...
public final class GetNetworksSortArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetNetworksSortArgs Empty = new GetNetworksSortArgs();
    ...
    private GetNetworksSortArgs() {}

    private GetNetworksSortArgs(GetNetworksSortArgs $) {
    ...
    public static Builder builder(GetNetworksSortArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetNetworksSortArgs();
        }

        public Builder(GetNetworksSortArgs defaults) {
            $ = new GetNetworksSortArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetNetworksSortArgs build() {
            return $;
        }
    }
