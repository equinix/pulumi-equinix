...
@CustomType
public final class StreamAlertRuleChangeLog {
    /**
    ...
    private StreamAlertRuleChangeLog() {}
    /**
     * @return User name of creator of the stream resource
     * 
     */
    ...
    public static Builder builder(StreamAlertRuleChangeLog defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String updatedDateTime;
        public Builder() {}
        public Builder(StreamAlertRuleChangeLog defaults) {
        ...
        public StreamAlertRuleChangeLog build() {
            final var _resultValue = new StreamAlertRuleChangeLog();
