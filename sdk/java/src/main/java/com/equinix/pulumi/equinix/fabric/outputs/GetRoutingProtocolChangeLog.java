...
public final class GetRoutingProtocolChangeLog {
    ...
    private GetRoutingProtocolChangeLog() {}
    /**
     * @return Created by User Key
     * 
     */
    ...
    public static Builder builder(GetRoutingProtocolChangeLog defaults) {
    ...
    public static final class Builder {
        ...
        private String updatedDateTime;
        public Builder() {}
        public Builder(GetRoutingProtocolChangeLog defaults) {
        ...
        public Builder createdBy(String createdBy) {
            if (createdBy == null) {
              throw new MissingRequiredPropertyException("GetRoutingProtocolChangeLog", "createdBy");
            }
        ...
        public Builder createdByEmail(String createdByEmail) {
            if (createdByEmail == null) {
              throw new MissingRequiredPropertyException("GetRoutingProtocolChangeLog", "createdByEmail");
            }
        ...
        public Builder createdByFullName(String createdByFullName) {
            if (createdByFullName == null) {
              throw new MissingRequiredPropertyException("GetRoutingProtocolChangeLog", "createdByFullName");
            }
        ...
        public Builder createdDateTime(String createdDateTime) {
            if (createdDateTime == null) {
              throw new MissingRequiredPropertyException("GetRoutingProtocolChangeLog", "createdDateTime");
            }
        ...
        public Builder deletedBy(String deletedBy) {
            if (deletedBy == null) {
              throw new MissingRequiredPropertyException("GetRoutingProtocolChangeLog", "deletedBy");
            }
        ...
        public Builder deletedByEmail(String deletedByEmail) {
            if (deletedByEmail == null) {
              throw new MissingRequiredPropertyException("GetRoutingProtocolChangeLog", "deletedByEmail");
            }
        ...
        public Builder deletedByFullName(String deletedByFullName) {
            if (deletedByFullName == null) {
              throw new MissingRequiredPropertyException("GetRoutingProtocolChangeLog", "deletedByFullName");
            }
        ...
        public Builder deletedDateTime(String deletedDateTime) {
            if (deletedDateTime == null) {
              throw new MissingRequiredPropertyException("GetRoutingProtocolChangeLog", "deletedDateTime");
            }
        ...
        public Builder updatedBy(String updatedBy) {
            if (updatedBy == null) {
              throw new MissingRequiredPropertyException("GetRoutingProtocolChangeLog", "updatedBy");
            }
        ...
        public Builder updatedByEmail(String updatedByEmail) {
            if (updatedByEmail == null) {
              throw new MissingRequiredPropertyException("GetRoutingProtocolChangeLog", "updatedByEmail");
            }
        ...
        public Builder updatedByFullName(String updatedByFullName) {
            if (updatedByFullName == null) {
              throw new MissingRequiredPropertyException("GetRoutingProtocolChangeLog", "updatedByFullName");
            }
        ...
        public Builder updatedDateTime(String updatedDateTime) {
            if (updatedDateTime == null) {
              throw new MissingRequiredPropertyException("GetRoutingProtocolChangeLog", "updatedDateTime");
            }
            this.updatedDateTime = updatedDateTime;
            return this;
        }
        public GetRoutingProtocolChangeLog build() {
            final var _resultValue = new GetRoutingProtocolChangeLog();
