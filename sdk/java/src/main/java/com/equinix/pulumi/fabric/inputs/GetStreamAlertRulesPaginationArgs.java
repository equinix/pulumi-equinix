...
public final class GetStreamAlertRulesPaginationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetStreamAlertRulesPaginationArgs Empty = new GetStreamAlertRulesPaginationArgs();
    ...
    private GetStreamAlertRulesPaginationArgs() {}

    private GetStreamAlertRulesPaginationArgs(GetStreamAlertRulesPaginationArgs $) {
        this.limit = $.limit;
        this.next = $.next;
        this.offset = $.offset;
    ...
    public static Builder builder(GetStreamAlertRulesPaginationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetStreamAlertRulesPaginationArgs();
        }

        public Builder(GetStreamAlertRulesPaginationArgs defaults) {
            $ = new GetStreamAlertRulesPaginationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetStreamAlertRulesPaginationArgs build() {
            if ($.limit == null) {
                throw new MissingRequiredPropertyException("GetStreamAlertRulesPaginationArgs", "limit");
            }
            if ($.next == null) {
                throw new MissingRequiredPropertyException("GetStreamAlertRulesPaginationArgs", "next");
            }
            if ($.offset == null) {
                throw new MissingRequiredPropertyException("GetStreamAlertRulesPaginationArgs", "offset");
            }
            if ($.previous == null) {
                throw new MissingRequiredPropertyException("GetStreamAlertRulesPaginationArgs", "previous");
            }
            if ($.total == null) {
                throw new MissingRequiredPropertyException("GetStreamAlertRulesPaginationArgs", "total");
            }
            return $;
        }
    }
