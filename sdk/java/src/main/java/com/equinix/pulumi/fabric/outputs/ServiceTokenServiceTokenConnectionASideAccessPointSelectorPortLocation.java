...
@CustomType
public final class ServiceTokenServiceTokenConnectionASideAccessPointSelectorPortLocation {
    /**
     * @return IBX Code
     * 
     */
    ...
    public static Builder builder(ServiceTokenServiceTokenConnectionASideAccessPointSelectorPortLocation defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String region;
        public Builder() {}
        public Builder(ServiceTokenServiceTokenConnectionASideAccessPointSelectorPortLocation defaults) {
        ...
        public ServiceTokenServiceTokenConnectionASideAccessPointSelectorPortLocation build() {
            final var _resultValue = new ServiceTokenServiceTokenConnectionASideAccessPointSelectorPortLocation();
