...
@CustomType
public final class ConnectionChangeLog {
    /**
    ...
    public static Builder builder(ConnectionChangeLog defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String updatedDateTime;
        public Builder() {}
        public Builder(ConnectionChangeLog defaults) {
        ...
        public ConnectionChangeLog build() {
            final var _resultValue = new ConnectionChangeLog();
