...
public final class GetConnectionASideAccessPointVirtualDevice {
    ...
    public static final class Builder {
        ...
        public Builder href(String href) {
            if (href == null) {
              throw new MissingRequiredPropertyException("GetConnectionASideAccessPointVirtualDevice", "href");
            }
            this.href = href;
            return this;
        }
        ...
        public Builder uuid(String uuid) {
            if (uuid == null) {
              throw new MissingRequiredPropertyException("GetConnectionASideAccessPointVirtualDevice", "uuid");
            }
            this.uuid = uuid;
            return this;
        }
        public GetConnectionASideAccessPointVirtualDevice build() {
            final var _resultValue = new GetConnectionASideAccessPointVirtualDevice();
