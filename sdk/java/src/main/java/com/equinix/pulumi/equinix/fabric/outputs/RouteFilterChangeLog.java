...
@CustomType
public final class RouteFilterChangeLog {
    /**
    ...
    public static Builder builder(RouteFilterChangeLog defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String updatedDateTime;
        public Builder() {}
        public Builder(RouteFilterChangeLog defaults) {
        ...
        public RouteFilterChangeLog build() {
            final var _resultValue = new RouteFilterChangeLog();
