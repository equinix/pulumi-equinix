...
public final class GetPortsDatumLag {
    ...
    public static Builder builder(GetPortsDatumLag defaults) {
    ...
    public static final class Builder {
        ...
        private String name;
        public Builder() {}
        public Builder(GetPortsDatumLag defaults) {
        ...
        public GetPortsDatumLag build() {
            final var o = new GetPortsDatumLag();
            o.enabled = enabled;
            o.id = id;
