...
@CustomType
public final class GetServiceProfilesDataAccessPointTypeConfigLinkProtocolConfig {
    private String encapsulation;
    private String encapsulationStrategy;
    private Boolean reuseVlanSTag;

    private GetServiceProfilesDataAccessPointTypeConfigLinkProtocolConfig() {}
    ...
    public static Builder builder(GetServiceProfilesDataAccessPointTypeConfigLinkProtocolConfig defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean reuseVlanSTag;
        public Builder() {}
        public Builder(GetServiceProfilesDataAccessPointTypeConfigLinkProtocolConfig defaults) {
        ...
        public GetServiceProfilesDataAccessPointTypeConfigLinkProtocolConfig build() {
            final var o = new GetServiceProfilesDataAccessPointTypeConfigLinkProtocolConfig();
