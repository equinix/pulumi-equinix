...
public final class CloudRouterOrderArgs extends com.pulumi.resources.ResourceArgs {

    public static final CloudRouterOrderArgs Empty = new CloudRouterOrderArgs();
    ...
    public static Builder builder(CloudRouterOrderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CloudRouterOrderArgs();
        }

        public Builder(CloudRouterOrderArgs defaults) {
            $ = new CloudRouterOrderArgs(Objects.requireNonNull(defaults));
        }
