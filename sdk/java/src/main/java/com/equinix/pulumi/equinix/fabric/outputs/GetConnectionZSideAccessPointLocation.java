...
public final class GetConnectionZSideAccessPointLocation {
    ...
    public static final class Builder {
        ...
        public Builder ibx(String ibx) {
            if (ibx == null) {
              throw new MissingRequiredPropertyException("GetConnectionZSideAccessPointLocation", "ibx");
            }
            this.ibx = ibx;
            return this;
        }
        ...
        public Builder metroCode(String metroCode) {
            if (metroCode == null) {
              throw new MissingRequiredPropertyException("GetConnectionZSideAccessPointLocation", "metroCode");
            }
        ...
        public Builder metroName(String metroName) {
            if (metroName == null) {
              throw new MissingRequiredPropertyException("GetConnectionZSideAccessPointLocation", "metroName");
            }
        ...
        public Builder region(String region) {
            if (region == null) {
              throw new MissingRequiredPropertyException("GetConnectionZSideAccessPointLocation", "region");
            }
            this.region = region;
            return this;
        }
