...
@CustomType
public final class GetNetworkNotification {
    /**
    ...
    private GetNetworkNotification() {}
    /**
     * @return Array of contact emails
     * 
     */
    ...
    public static Builder builder(GetNetworkNotification defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetNetworkNotification defaults) {
        ...
        public GetNetworkNotification build() {
            final var _resultValue = new GetNetworkNotification();
