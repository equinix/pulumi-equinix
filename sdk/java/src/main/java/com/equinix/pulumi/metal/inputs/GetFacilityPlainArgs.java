...
public final class GetFacilityPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    /**
     * @return Set of feature strings that the facility must have. Some possible values are `baremetal`, `ibx`, `storage`, `globalIpv4`, `backendTransfer`, `layer2`.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param featuresRequireds Set of feature strings that the facility must have. Some possible values are `baremetal`, `ibx`, `storage`, `globalIpv4`, `backendTransfer`, `layer2`.
         * 
         * @return builder
         * 
         */
