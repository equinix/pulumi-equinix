...
public final class GetConnectionNotification {
    ...
    public static final class Builder {
        ...
        public Builder emails(List<String> emails) {
            if (emails == null) {
              throw new MissingRequiredPropertyException("GetConnectionNotification", "emails");
            }
            this.emails = emails;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetConnectionNotification", "type");
            }
            this.type = type;
            return this;
        }
        public GetConnectionNotification build() {
            final var _resultValue = new GetConnectionNotification();
