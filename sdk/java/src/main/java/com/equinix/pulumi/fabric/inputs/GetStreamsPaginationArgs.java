...
public final class GetStreamsPaginationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetStreamsPaginationArgs Empty = new GetStreamsPaginationArgs();
    ...
    private GetStreamsPaginationArgs() {}

    private GetStreamsPaginationArgs(GetStreamsPaginationArgs $) {
        this.limit = $.limit;
        this.next = $.next;
        this.offset = $.offset;
    ...
    public static Builder builder(GetStreamsPaginationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetStreamsPaginationArgs();
        }

        public Builder(GetStreamsPaginationArgs defaults) {
            $ = new GetStreamsPaginationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetStreamsPaginationArgs build() {
            if ($.limit == null) {
                throw new MissingRequiredPropertyException("GetStreamsPaginationArgs", "limit");
            }
            if ($.next == null) {
                throw new MissingRequiredPropertyException("GetStreamsPaginationArgs", "next");
            }
            if ($.offset == null) {
                throw new MissingRequiredPropertyException("GetStreamsPaginationArgs", "offset");
            }
            if ($.previous == null) {
                throw new MissingRequiredPropertyException("GetStreamsPaginationArgs", "previous");
            }
            if ($.total == null) {
                throw new MissingRequiredPropertyException("GetStreamsPaginationArgs", "total");
            }
            return $;
        }
    }
