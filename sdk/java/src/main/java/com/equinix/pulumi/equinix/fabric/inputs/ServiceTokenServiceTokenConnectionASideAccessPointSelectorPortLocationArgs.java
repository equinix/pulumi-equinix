...
public final class ServiceTokenServiceTokenConnectionASideAccessPointSelectorPortLocationArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceTokenServiceTokenConnectionASideAccessPointSelectorPortLocationArgs Empty = new ServiceTokenServiceTokenConnectionASideAccessPointSelectorPortLocationArgs();
    ...
    private ServiceTokenServiceTokenConnectionASideAccessPointSelectorPortLocationArgs(ServiceTokenServiceTokenConnectionASideAccessPointSelectorPortLocationArgs $) {
        this.ibx = $.ibx;
    ...
    public static Builder builder(ServiceTokenServiceTokenConnectionASideAccessPointSelectorPortLocationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceTokenServiceTokenConnectionASideAccessPointSelectorPortLocationArgs();
        }

        public Builder(ServiceTokenServiceTokenConnectionASideAccessPointSelectorPortLocationArgs defaults) {
            $ = new ServiceTokenServiceTokenConnectionASideAccessPointSelectorPortLocationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceTokenServiceTokenConnectionASideAccessPointSelectorPortLocationArgs build() {
            return $;
        }
    }
