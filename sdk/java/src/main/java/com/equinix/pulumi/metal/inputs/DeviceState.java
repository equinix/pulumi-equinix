...
import com.equinix.pulumi.metal.enums.NetworkType;
...
import com.equinix.pulumi.metal.inputs.DeviceNetworkArgs;
import com.equinix.pulumi.metal.inputs.DevicePortArgs;
...
public final class DeviceState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param deployedHardwareReservationId ID of hardware reservation where this device was deployed. It is useful when using the next-available hardware reservation
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param network The device&#39;s private and public IP (v4 and v6) network details. When a device is run without any special network configuration, it will have 3 addresses: public ipv4, private ipv4 and ipv6
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param plan The device plan slug. To find the plan slug, visit the [plan documentation](https://docs.equinix.com/metal/hardware/standard-servers/)
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param ports Ports assigned to the device
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param sosHostname The hostname to use for [Serial over SSH](https://docs.equinix.com/metal/resilience-recovery/serial-over-ssh/) access to the device
         * 
         * @return builder
         * 
         */
