...
@CustomType
public final class GetServiceTokensDataChangeLog {
    /**
    ...
    private GetServiceTokensDataChangeLog() {}
    /**
     * @return Created by User Key
     * 
     */
    ...
    public static Builder builder(GetServiceTokensDataChangeLog defaults) {
    ...
    public static final class Builder {
        ...
        private String updatedDateTime;
        public Builder() {}
        public Builder(GetServiceTokensDataChangeLog defaults) {
        ...
        public Builder createdBy(String createdBy) {
            if (createdBy == null) {
              throw new MissingRequiredPropertyException("GetServiceTokensDataChangeLog", "createdBy");
            }
        ...
        public Builder createdByEmail(String createdByEmail) {
            if (createdByEmail == null) {
              throw new MissingRequiredPropertyException("GetServiceTokensDataChangeLog", "createdByEmail");
            }
        ...
        public Builder createdByFullName(String createdByFullName) {
            if (createdByFullName == null) {
              throw new MissingRequiredPropertyException("GetServiceTokensDataChangeLog", "createdByFullName");
            }
        ...
        public Builder createdDateTime(String createdDateTime) {
            if (createdDateTime == null) {
              throw new MissingRequiredPropertyException("GetServiceTokensDataChangeLog", "createdDateTime");
            }
        ...
        public Builder deletedBy(String deletedBy) {
            if (deletedBy == null) {
              throw new MissingRequiredPropertyException("GetServiceTokensDataChangeLog", "deletedBy");
            }
        ...
        public Builder deletedByEmail(String deletedByEmail) {
            if (deletedByEmail == null) {
              throw new MissingRequiredPropertyException("GetServiceTokensDataChangeLog", "deletedByEmail");
            }
        ...
        public Builder deletedByFullName(String deletedByFullName) {
            if (deletedByFullName == null) {
              throw new MissingRequiredPropertyException("GetServiceTokensDataChangeLog", "deletedByFullName");
            }
        ...
        public Builder deletedDateTime(String deletedDateTime) {
            if (deletedDateTime == null) {
              throw new MissingRequiredPropertyException("GetServiceTokensDataChangeLog", "deletedDateTime");
            }
        ...
        public Builder updatedBy(String updatedBy) {
            if (updatedBy == null) {
              throw new MissingRequiredPropertyException("GetServiceTokensDataChangeLog", "updatedBy");
            }
        ...
        public Builder updatedByEmail(String updatedByEmail) {
            if (updatedByEmail == null) {
              throw new MissingRequiredPropertyException("GetServiceTokensDataChangeLog", "updatedByEmail");
            }
        ...
        public Builder updatedByFullName(String updatedByFullName) {
            if (updatedByFullName == null) {
              throw new MissingRequiredPropertyException("GetServiceTokensDataChangeLog", "updatedByFullName");
            }
        ...
        public Builder updatedDateTime(String updatedDateTime) {
            if (updatedDateTime == null) {
              throw new MissingRequiredPropertyException("GetServiceTokensDataChangeLog", "updatedDateTime");
            }
            this.updatedDateTime = updatedDateTime;
            return this;
        }
        public GetServiceTokensDataChangeLog build() {
            final var _resultValue = new GetServiceTokensDataChangeLog();
