...
@CustomType
public final class GetPortAccount {
    /**
    ...
    public static Builder builder(GetPortAccount defaults) {
    ...
    public static final class Builder {
        ...
        private String ucmId;
        public Builder() {}
        public Builder(GetPortAccount defaults) {
        ...
        public GetPortAccount build() {
            final var _resultValue = new GetPortAccount();
