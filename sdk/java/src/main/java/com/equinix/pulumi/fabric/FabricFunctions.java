...
public final class FabricFunctions {
     ...
     *             .build());
     * 
     *         ctx.export("numberOfReturnedServiceProfiles", test.data().length());
     ...
     *             .build());
     * 
     *         ctx.export("streamAlertRulesType", alertRules.data()[0].type());
     *         ctx.export("streamAlertRulesId", alertRules.data()[0].uuid());
     *         ctx.export("streamAlertRulesState", alertRules.data()[0].state());
     *         ctx.export("streamAlertRulesStreamId", alertRules.data()[0].streamId());
     *     }
     * }
     * }
     * </pre>
