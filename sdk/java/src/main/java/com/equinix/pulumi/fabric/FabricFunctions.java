...
public final class FabricFunctions {
     ...
     *             .build());
     * 
     *         ctx.export("numberOfReturnedMetros", metros.datas().size());
     ...
     *         ctx.export("deviceRedundancyEnabled", portDataName.device().redundancy().enabled());
     *         ctx.export("deviceRedundancyPriority", portDataName.device().redundancy().priority());
     *     }
     * }
     * }
     * </pre>
     ...
     *             .build());
     * 
     *         ctx.export("id", portsDataNameEquinixFabricPort.get("data")[0].get("id"));
     *         ctx.export("name", portsDataNameEquinixFabricPort.get("data")[0].get("name"));
     *         ctx.export("state", portsDataNameEquinixFabricPort.get("data")[0].get("state"));
     *         ctx.export("accountName", portsDataNameEquinixFabricPort.get("data")[0].get("account")[0].get("accountName"));
     *         ctx.export("type", portsDataNameEquinixFabricPort.get("data")[0].get("type"));
     *         ctx.export("bandwidth", portsDataNameEquinixFabricPort.get("data")[0].get("bandwidth"));
     *         ctx.export("usedBandwidth", portsDataNameEquinixFabricPort.get("data")[0].get("usedBandwidth"));
     *         ctx.export("encapsulationType", portsDataNameEquinixFabricPort.get("data")[0].get("encapsulation")[0].get("type"));
     *         ctx.export("ibx", portsDataNameEquinixFabricPort.get("data")[0].get("location")[0].get("ibx"));
     *         ctx.export("metroCode", portsDataNameEquinixFabricPort.get("data")[0].get("location")[0].get("metroCode"));
     *         ctx.export("metroName", portsDataNameEquinixFabricPort.get("data")[0].get("location")[0].get("metroName"));
     *         ctx.export("region", portsDataNameEquinixFabricPort.get("data")[0].get("location")[0].get("region"));
     *         ctx.export("deviceRedundancyEnabled", portsDataNameEquinixFabricPort.get("data")[0].get("device")[0].get("redundancy")[0].get("enabled"));
     *         ctx.export("deviceRedundancyPriority", portsDataNameEquinixFabricPort.get("data")[0].get("device")[0].get("redundancy")[0].get("priority"));
     *     }
     * }
     * }
     * </pre>
     ...
     *         ctx.export("eptServiceConnection", ptp.get("connections"));
     *     }
     * }
     * }
     * </pre>
     ...
     * import com.pulumi.core.Output;
     * import com.pulumi.equinix.fabric.FabricFunctions;
     * import com.pulumi.equinix.fabric.inputs.GetPrecisionTimeServicesArgs;
     * import com.pulumi.equinix.fabric.inputs.GetPrecisionTimeServicesPaginationArgs;
     * import com.pulumi.equinix.fabric.inputs.GetPrecisionTimeServicesFilterArgs;
     * import com.pulumi.equinix.fabric.inputs.GetPrecisionTimeServicesSortArgs;
     * import java.util.ArrayList;
     * import java.util.Arrays;
     * import java.util.Map;
     * import java.io.File;
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var all = FabricFunctions.getPrecisionTimeServices(GetPrecisionTimeServicesArgs.builder()
     *             .pagination(GetPrecisionTimeServicesPaginationArgs.builder()
     *                 .limit(2)
     *                 .offset(1)
     *                 .build())
     *             .filters(GetPrecisionTimeServicesFilterArgs.builder()
     *                 .property("/type")
     *                 .operator("=")
     *                 .values("PTP")
     *                 .build())
     *             .sorts(GetPrecisionTimeServicesSortArgs.builder()
     *                 .direction("DESC")
     *                 .property("/uuid")
     *                 .build())
     *             .build());
     * 
     *         ctx.export("eptServiceId", all.datas()[0].id());
     *         ctx.export("eptServiceName", all.datas()[0].name());
     *         ctx.export("eptServiceState", all.datas()[0].state());
     *         ctx.export("eptServiceType", all.datas()[0].type());
     *         ctx.export("eptServiceIpv4", all.datas()[0].ipv4());
     *     }
     * }
     * }
     * </pre>
     ...
     * import com.pulumi.equinix.fabric.inputs.GetRouteFiltersFilterArgs;
     * import com.pulumi.equinix.fabric.inputs.GetRouteFiltersPaginationArgs;
     * import com.pulumi.equinix.fabric.inputs.GetRouteFiltersSortArgs;
     * import java.util.ArrayList;
     * import java.util.Arrays;
     * import java.util.Map;
     * import java.io.File;
     ...
     * import com.pulumi.equinix.fabric.inputs.GetServiceProfilesPaginationArgs;
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var test = FabricFunctions.getServiceProfiles(GetServiceProfilesArgs.builder()
     *             .andFilters(true)
     ...
     *                 .build())
     *             .pagination(GetServiceProfilesPaginationArgs.builder()
     *                 .offset(0)
     *                 .limit(5)
     *                 .build())
     *             .sort(GetServiceProfilesSortArgs.builder()
     *                 .direction("ASC")
     *                 .property("/name")
     *                 .build())
     *             .build());
     * 
     *         ctx.export("numberOfReturnedServiceProfiles", test.data().size());
     *         ctx.export("firstServiceProfileName", test.data()[0].name());
     *         ctx.export("firstServiceProfileUuid", test.data()[0].uuid());
     *         ctx.export("firstServiceProfileDescription", test.data()[0].description());
     *         ctx.export("firstServiceProfileState", test.data()[0].state());
     *         ctx.export("firstServiceProfileVisibility", test.data()[0].visibility());
     *         ctx.export("firstServiceProfileMetrosCode", test.data()[0].metros()[0].code());
     *         ctx.export("firstServiceProfileMetrosName", test.data()[0].metros()[0].name());
     *         ctx.export("firstServiceProfileMetrosDisplayName", test.data()[0].metros()[0].displayName());
     *         ctx.export("firstServiceProfileType", test.data()[0].type());
     *     }
     * }
     * }
     * </pre>
     ...
     *             .build());
     * 
     *         ctx.export("streamAlertRulesType", alertRules.get("data")[0].get("type"));
     *         ctx.export("streamAlertRulesId", alertRules.get("data")[0].get("uuid"));
     *         ctx.export("streamAlertRulesState", alertRules.get("data")[0].get("state"));
     *         ctx.export("streamAlertRulesStreamId", alertRules.get("data")[0].get("streamId"));
     *     }
     * }
     * }
     * </pre>
     ...
     * import com.pulumi.equinix.fabric.inputs.GetStreamAttachmentsFilterArgs;
     * import com.pulumi.equinix.fabric.inputs.GetStreamAttachmentsSortArgs;
     * import java.util.ArrayList;
     * import java.util.Arrays;
     * import java.util.Map;
     * import java.io.File;
     ...
     *             .build());
     * 
     *         ctx.export("numberOfReturnedStreams", dataStreams.datas().size());
     *     }
     * }
     * }
     * </pre>
