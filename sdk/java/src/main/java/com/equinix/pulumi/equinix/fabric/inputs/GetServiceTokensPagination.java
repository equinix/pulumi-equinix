...
public final class GetServiceTokensPagination extends com.pulumi.resources.InvokeArgs {

    public static final GetServiceTokensPagination Empty = new GetServiceTokensPagination();
    ...
    private GetServiceTokensPagination() {}

    private GetServiceTokensPagination(GetServiceTokensPagination $) {
        this.limit = $.limit;
        this.next = $.next;
        this.offset = $.offset;
    ...
    public static Builder builder(GetServiceTokensPagination defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetServiceTokensPagination();
        }

        public Builder(GetServiceTokensPagination defaults) {
            $ = new GetServiceTokensPagination(Objects.requireNonNull(defaults));
        }
        ...
        public GetServiceTokensPagination build() {
            if ($.limit == null) {
                throw new MissingRequiredPropertyException("GetServiceTokensPagination", "limit");
            }
            if ($.next == null) {
                throw new MissingRequiredPropertyException("GetServiceTokensPagination", "next");
            }
            if ($.offset == null) {
                throw new MissingRequiredPropertyException("GetServiceTokensPagination", "offset");
            }
            if ($.previous == null) {
                throw new MissingRequiredPropertyException("GetServiceTokensPagination", "previous");
            }
            if ($.total == null) {
                throw new MissingRequiredPropertyException("GetServiceTokensPagination", "total");
            }
            return $;
        }
    }
