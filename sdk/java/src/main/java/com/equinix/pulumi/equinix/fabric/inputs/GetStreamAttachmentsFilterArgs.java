...
public final class GetStreamAttachmentsFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetStreamAttachmentsFilterArgs Empty = new GetStreamAttachmentsFilterArgs();
    ...
    private GetStreamAttachmentsFilterArgs() {}

    private GetStreamAttachmentsFilterArgs(GetStreamAttachmentsFilterArgs $) {
    ...
    public static Builder builder(GetStreamAttachmentsFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetStreamAttachmentsFilterArgs();
        }

        public Builder(GetStreamAttachmentsFilterArgs defaults) {
            $ = new GetStreamAttachmentsFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetStreamAttachmentsFilterArgs build() {
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("GetStreamAttachmentsFilterArgs", "operator");
            }
            if ($.property == null) {
                throw new MissingRequiredPropertyException("GetStreamAttachmentsFilterArgs", "property");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetStreamAttachmentsFilterArgs", "values");
            }
            return $;
        }
    }
