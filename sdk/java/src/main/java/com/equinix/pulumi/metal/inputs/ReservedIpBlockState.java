...
public final class ReservedIpBlockState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Only valid as an argument and required when `type` is `vrf`. The size of the network to reserve from an existing VRF ip_range. `cidr` can only be specified with `vrfId`. Range is 22-31. Virtual Circuits require 30-31. Other VRF resources must use a CIDR in the 22-29 range.
     * 
     */
    ...
    /**
     * @return Facility where to allocate the public IP address block, makes sense only if type is `publicIpv4` and must be empty if type is `globalIpv4`. Conflicts with `metro`. Use metro instead; read the facility to metro migration guide
     * 
     */
    ...
    /**
     * @return Metro where to allocate the public IP address block, makes sense only if type is `publicIpv4` and must be empty if type is `globalIpv4`. Conflicts with `facility`.
     * 
     */
    ...
    /**
     * @return Only valid as an argument and required when `type` is `vrf`. An unreserved network address from an existing `ipRange` in the specified VRF.
     * 
     */
    ...
    /**
     * @return One of `globalIpv4`, `publicIpv4`, or `vrf`. Defaults to `publicIpv4` for backward compatibility.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param cidr Only valid as an argument and required when `type` is `vrf`. The size of the network to reserve from an existing VRF ip_range. `cidr` can only be specified with `vrfId`. Range is 22-31. Virtual Circuits require 30-31. Other VRF resources must use a CIDR in the 22-29 range.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param facility Facility where to allocate the public IP address block, makes sense only if type is `publicIpv4` and must be empty if type is `globalIpv4`. Conflicts with `metro`. Use metro instead; read the facility to metro migration guide
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param global Boolean flag whether addresses from a block are global (i.e. can be assigned in any metro).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param metro Metro where to allocate the public IP address block, makes sense only if type is `publicIpv4` and must be empty if type is `globalIpv4`. Conflicts with `facility`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param network Only valid as an argument and required when `type` is `vrf`. An unreserved network address from an existing `ipRange` in the specified VRF.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param type One of `globalIpv4`, `publicIpv4`, or `vrf`. Defaults to `publicIpv4` for backward compatibility.
         * 
         * @return builder
         * 
         */
