...
@CustomType
public final class GetConnectionsDataZSideAccessPointLinkProtocol {
    /**
    ...
    private GetConnectionsDataZSideAccessPointLinkProtocol() {}
    /**
     * @return Type of the link protocol - UNTAGGED, DOT1Q, QINQ, EVPN_VXLAN
     * 
     */
    ...
    public static Builder builder(GetConnectionsDataZSideAccessPointLinkProtocol defaults) {
    ...
    public static final class Builder {
        ...
        private Integer vlanTag;
        public Builder() {}
        public Builder(GetConnectionsDataZSideAccessPointLinkProtocol defaults) {
        ...
        public Builder vlanCTag(Integer vlanCTag) {
            if (vlanCTag == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataZSideAccessPointLinkProtocol", "vlanCTag");
            }
        ...
        public Builder vlanSTag(Integer vlanSTag) {
            if (vlanSTag == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataZSideAccessPointLinkProtocol", "vlanSTag");
            }
        ...
        public Builder vlanTag(Integer vlanTag) {
            if (vlanTag == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataZSideAccessPointLinkProtocol", "vlanTag");
            }
            this.vlanTag = vlanTag;
            return this;
        }
        public GetConnectionsDataZSideAccessPointLinkProtocol build() {
            final var _resultValue = new GetConnectionsDataZSideAccessPointLinkProtocol();
