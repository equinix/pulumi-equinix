...
public final class MetalFunctions {
     ...
     *             .build());
     * 
     *         final var test = MetalFunctions.getGateway(GetGatewayArgs.builder()
     *             .gatewayId(gatewayId)
     *             .build());
     * 
     *     }
     ...
     *             .build());
     * 
     *         final var test = MetalFunctions.getPort(GetPortArgs.builder()
     ...
     *             .build());
     * 
     *         final var test = MetalFunctions.getPrecreatedIpBlock(GetPrecreatedIpBlockArgs.builder()
     *             .metro("sv")
     *             .projectId(projectId)
     *             .addressFamily(6)
     *             .public_(true)
     ...
     *         var fromIpv6Block = new IpAttachment("fromIpv6Block", IpAttachmentArgs.builder()
     *             .deviceId(web1.id())
     *             .cidrNotation(StdFunctions.cidrsubnet(CidrsubnetArgs.builder()
