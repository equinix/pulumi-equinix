...
public final class GetAdvertisedRoutesPaginationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetAdvertisedRoutesPaginationArgs Empty = new GetAdvertisedRoutesPaginationArgs();
    ...
    private GetAdvertisedRoutesPaginationArgs() {}

    private GetAdvertisedRoutesPaginationArgs(GetAdvertisedRoutesPaginationArgs $) {
        this.limit = $.limit;
        this.next = $.next;
        this.offset = $.offset;
    ...
    public static Builder builder(GetAdvertisedRoutesPaginationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAdvertisedRoutesPaginationArgs();
        }

        public Builder(GetAdvertisedRoutesPaginationArgs defaults) {
            $ = new GetAdvertisedRoutesPaginationArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param total The total number of elements returned
         * 
         * @return builder
         * 
         */
        ...
        public GetAdvertisedRoutesPaginationArgs build() {
            if ($.next == null) {
                throw new MissingRequiredPropertyException("GetAdvertisedRoutesPaginationArgs", "next");
            }
            if ($.previous == null) {
                throw new MissingRequiredPropertyException("GetAdvertisedRoutesPaginationArgs", "previous");
            }
            if ($.total == null) {
                throw new MissingRequiredPropertyException("GetAdvertisedRoutesPaginationArgs", "total");
            }
            return $;
        }
    }
