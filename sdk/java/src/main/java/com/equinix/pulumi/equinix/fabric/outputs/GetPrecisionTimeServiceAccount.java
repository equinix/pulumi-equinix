...
@CustomType
public final class GetPrecisionTimeServiceAccount {
    /**
     * @return Account Name
     * 
     */
    ...
    private GetPrecisionTimeServiceAccount() {}
    /**
     * @return Account Name
     * 
     */
    ...
    public static Builder builder(GetPrecisionTimeServiceAccount defaults) {
    ...
    public static final class Builder {
        ...
        private String ucmId;
        public Builder() {}
        public Builder(GetPrecisionTimeServiceAccount defaults) {
        ...
        public Builder accountName(String accountName) {
            if (accountName == null) {
              throw new MissingRequiredPropertyException("GetPrecisionTimeServiceAccount", "accountName");
            }
        ...
        public Builder accountNumber(Integer accountNumber) {
            if (accountNumber == null) {
              throw new MissingRequiredPropertyException("GetPrecisionTimeServiceAccount", "accountNumber");
            }
        ...
        public Builder globalCustId(String globalCustId) {
            if (globalCustId == null) {
              throw new MissingRequiredPropertyException("GetPrecisionTimeServiceAccount", "globalCustId");
            }
        ...
        public Builder globalOrgId(String globalOrgId) {
            if (globalOrgId == null) {
              throw new MissingRequiredPropertyException("GetPrecisionTimeServiceAccount", "globalOrgId");
            }
        ...
        public Builder globalOrganizationName(String globalOrganizationName) {
            if (globalOrganizationName == null) {
              throw new MissingRequiredPropertyException("GetPrecisionTimeServiceAccount", "globalOrganizationName");
            }
        ...
        public Builder orgId(Integer orgId) {
            if (orgId == null) {
              throw new MissingRequiredPropertyException("GetPrecisionTimeServiceAccount", "orgId");
            }
            this.orgId = orgId;
            return this;
        }
        ...
        public Builder organizationName(String organizationName) {
            if (organizationName == null) {
              throw new MissingRequiredPropertyException("GetPrecisionTimeServiceAccount", "organizationName");
            }
        ...
        public Builder resellerAccountName(String resellerAccountName) {
            if (resellerAccountName == null) {
              throw new MissingRequiredPropertyException("GetPrecisionTimeServiceAccount", "resellerAccountName");
            }
        ...
        public Builder resellerAccountNumber(Integer resellerAccountNumber) {
            if (resellerAccountNumber == null) {
              throw new MissingRequiredPropertyException("GetPrecisionTimeServiceAccount", "resellerAccountNumber");
            }
        ...
        public Builder resellerOrgId(Integer resellerOrgId) {
            if (resellerOrgId == null) {
              throw new MissingRequiredPropertyException("GetPrecisionTimeServiceAccount", "resellerOrgId");
            }
        ...
        public Builder resellerUcmId(String resellerUcmId) {
            if (resellerUcmId == null) {
              throw new MissingRequiredPropertyException("GetPrecisionTimeServiceAccount", "resellerUcmId");
            }
        ...
        public Builder ucmId(String ucmId) {
            if (ucmId == null) {
              throw new MissingRequiredPropertyException("GetPrecisionTimeServiceAccount", "ucmId");
            }
            this.ucmId = ucmId;
            return this;
        }
        public GetPrecisionTimeServiceAccount build() {
            final var _resultValue = new GetPrecisionTimeServiceAccount();
