...
public final class RoutingProtocolBgpIpv6Args extends com.pulumi.resources.ResourceArgs {

    public static final RoutingProtocolBgpIpv6Args Empty = new RoutingProtocolBgpIpv6Args();
    ...
    public static Builder builder(RoutingProtocolBgpIpv6Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RoutingProtocolBgpIpv6Args();
        }

        public Builder(RoutingProtocolBgpIpv6Args defaults) {
            $ = new RoutingProtocolBgpIpv6Args(Objects.requireNonNull(defaults));
        }
        ...
        public RoutingProtocolBgpIpv6Args build() {
            if ($.customerPeerIp == null) {
                throw new MissingRequiredPropertyException("RoutingProtocolBgpIpv6Args", "customerPeerIp");
            }
            return $;
        }
    }
