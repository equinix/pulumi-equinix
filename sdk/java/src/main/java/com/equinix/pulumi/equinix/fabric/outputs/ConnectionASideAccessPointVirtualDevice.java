...
public final class ConnectionASideAccessPointVirtualDevice {
    ...
    public static final class Builder {
        ...
        public Builder uuid(String uuid) {
            if (uuid == null) {
              throw new MissingRequiredPropertyException("ConnectionASideAccessPointVirtualDevice", "uuid");
            }
            this.uuid = uuid;
            return this;
        }
        public ConnectionASideAccessPointVirtualDevice build() {
            final var _resultValue = new ConnectionASideAccessPointVirtualDevice();
