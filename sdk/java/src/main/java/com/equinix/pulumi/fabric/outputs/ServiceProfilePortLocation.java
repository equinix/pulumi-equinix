...
public final class ServiceProfilePortLocation {
    ...
    public static Builder builder(ServiceProfilePortLocation defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String region;
        public Builder() {}
        public Builder(ServiceProfilePortLocation defaults) {
        ...
        public ServiceProfilePortLocation build() {
            final var _resultValue = new ServiceProfilePortLocation();
