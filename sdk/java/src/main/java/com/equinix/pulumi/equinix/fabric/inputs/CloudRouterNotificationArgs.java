...
public final class CloudRouterNotificationArgs extends com.pulumi.resources.ResourceArgs {

    public static final CloudRouterNotificationArgs Empty = new CloudRouterNotificationArgs();
    ...
    private CloudRouterNotificationArgs() {}

    private CloudRouterNotificationArgs(CloudRouterNotificationArgs $) {
        this.emails = $.emails;
    ...
    public static Builder builder(CloudRouterNotificationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CloudRouterNotificationArgs();
        }

        public Builder(CloudRouterNotificationArgs defaults) {
            $ = new CloudRouterNotificationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CloudRouterNotificationArgs build() {
            if ($.emails == null) {
                throw new MissingRequiredPropertyException("CloudRouterNotificationArgs", "emails");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("CloudRouterNotificationArgs", "type");
            }
            return $;
        }
    }
