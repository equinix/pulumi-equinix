...
public final class GetServiceProfilesPaginationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetServiceProfilesPaginationArgs Empty = new GetServiceProfilesPaginationArgs();
    ...
    private GetServiceProfilesPaginationArgs() {}

    private GetServiceProfilesPaginationArgs(GetServiceProfilesPaginationArgs $) {
        this.limit = $.limit;
        this.offset = $.offset;
    }
    ...
    public static Builder builder(GetServiceProfilesPaginationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetServiceProfilesPaginationArgs();
        }

        public Builder(GetServiceProfilesPaginationArgs defaults) {
            $ = new GetServiceProfilesPaginationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetServiceProfilesPaginationArgs build() {
            return $;
        }
    }
