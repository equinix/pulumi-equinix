...
public final class GetPortLag {
    ...
    public static Builder builder(GetPortLag defaults) {
    ...
    public static final class Builder {
        ...
        private String name;
        public Builder() {}
        public Builder(GetPortLag defaults) {
        ...
        public GetPortLag build() {
            final var o = new GetPortLag();
            o.enabled = enabled;
            o.id = id;
