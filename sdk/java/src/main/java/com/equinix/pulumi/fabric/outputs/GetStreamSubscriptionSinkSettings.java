...
public final class GetStreamSubscriptionSinkSettings {
    ...
    public static final class Builder {
        ...
        public Builder accessToken(String accessToken) {
            if (accessToken == null) {
              throw new MissingRequiredPropertyException("GetStreamSubscriptionSinkSettings", "accessToken");
            }
        ...
        public Builder apiKey(String apiKey) {
            if (apiKey == null) {
              throw new MissingRequiredPropertyException("GetStreamSubscriptionSinkSettings", "apiKey");
            }
            this.apiKey = apiKey;
            return this;
        }
        ...
        public Builder integrationKey(String integrationKey) {
            if (integrationKey == null) {
              throw new MissingRequiredPropertyException("GetStreamSubscriptionSinkSettings", "integrationKey");
            }
        ...
        public Builder password(String password) {
            if (password == null) {
              throw new MissingRequiredPropertyException("GetStreamSubscriptionSinkSettings", "password");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetStreamSubscriptionSinkSettings", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("GetStreamSubscriptionSinkSettings", "username");
            }
