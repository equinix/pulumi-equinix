...
public final class GetConnectionsDataASideAccessPointPortRedundancy {
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataASideAccessPointPortRedundancy", "enabled");
            }
        ...
        public Builder group(String group) {
            if (group == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataASideAccessPointPortRedundancy", "group");
            }
            this.group = group;
            return this;
        }
        ...
        public Builder priority(String priority) {
            if (priority == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataASideAccessPointPortRedundancy", "priority");
            }
