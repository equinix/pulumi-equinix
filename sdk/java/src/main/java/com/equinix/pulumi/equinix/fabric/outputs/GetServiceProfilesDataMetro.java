...
@CustomType
public final class GetServiceProfilesDataMetro {
    private String code;
    ...
    private GetServiceProfilesDataMetro() {}
    public String code() {
        return this.code;
    }
    ...
    public static Builder builder(GetServiceProfilesDataMetro defaults) {
    ...
    public static final class Builder {
        ...
        private Map<String,String> sellerRegions;
        public Builder() {}
        public Builder(GetServiceProfilesDataMetro defaults) {
        ...
        public GetServiceProfilesDataMetro build() {
            final var o = new GetServiceProfilesDataMetro();
            o.code = code;
