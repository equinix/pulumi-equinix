...
@CustomType
public final class GetServiceProfilesDatumAccount {
    /**
    ...
    private GetServiceProfilesDatumAccount() {}
    /**
     * @return Legal name of the accountholder.
     * 
     */
    ...
    public static Builder builder(GetServiceProfilesDatumAccount defaults) {
    ...
    public static final class Builder {
        ...
        private String ucmId;
        public Builder() {}
        public Builder(GetServiceProfilesDatumAccount defaults) {
        ...
        public Builder accountName(String accountName) {
            if (accountName == null) {
              throw new MissingRequiredPropertyException("GetServiceProfilesDatumAccount", "accountName");
            }
        ...
        public Builder accountNumber(Integer accountNumber) {
            if (accountNumber == null) {
              throw new MissingRequiredPropertyException("GetServiceProfilesDatumAccount", "accountNumber");
            }
        ...
        public Builder globalCustId(String globalCustId) {
            if (globalCustId == null) {
              throw new MissingRequiredPropertyException("GetServiceProfilesDatumAccount", "globalCustId");
            }
        ...
        public Builder globalOrgId(String globalOrgId) {
            if (globalOrgId == null) {
              throw new MissingRequiredPropertyException("GetServiceProfilesDatumAccount", "globalOrgId");
            }
        ...
        public Builder globalOrganizationName(String globalOrganizationName) {
            if (globalOrganizationName == null) {
              throw new MissingRequiredPropertyException("GetServiceProfilesDatumAccount", "globalOrganizationName");
            }
        ...
        public Builder orgId(Integer orgId) {
            if (orgId == null) {
              throw new MissingRequiredPropertyException("GetServiceProfilesDatumAccount", "orgId");
            }
            this.orgId = orgId;
            return this;
        }
        ...
        public Builder organizationName(String organizationName) {
            if (organizationName == null) {
              throw new MissingRequiredPropertyException("GetServiceProfilesDatumAccount", "organizationName");
            }
        ...
        public Builder ucmId(String ucmId) {
            if (ucmId == null) {
              throw new MissingRequiredPropertyException("GetServiceProfilesDatumAccount", "ucmId");
            }
            this.ucmId = ucmId;
            return this;
        }
        public GetServiceProfilesDatumAccount build() {
            final var _resultValue = new GetServiceProfilesDatumAccount();
