...
@CustomType
public final class CloudRouterChangeLog {
    /**
    ...
    public static Builder builder(CloudRouterChangeLog defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String updatedDateTime;
        public Builder() {}
        public Builder(CloudRouterChangeLog defaults) {
        ...
        public CloudRouterChangeLog build() {
            final var _resultValue = new CloudRouterChangeLog();
