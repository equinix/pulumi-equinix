...
public final class GetPortLocation {
    ...
    public static final class Builder {
        ...
        public Builder ibx(String ibx) {
            if (ibx == null) {
              throw new MissingRequiredPropertyException("GetPortLocation", "ibx");
            }
            this.ibx = ibx;
            return this;
        }
        ...
        public Builder metroCode(String metroCode) {
            if (metroCode == null) {
              throw new MissingRequiredPropertyException("GetPortLocation", "metroCode");
            }
        ...
        public Builder metroName(String metroName) {
            if (metroName == null) {
              throw new MissingRequiredPropertyException("GetPortLocation", "metroName");
            }
        ...
        public Builder region(String region) {
            if (region == null) {
              throw new MissingRequiredPropertyException("GetPortLocation", "region");
            }
            this.region = region;
            return this;
        }
        public GetPortLocation build() {
            final var _resultValue = new GetPortLocation();
