...
@CustomType
public final class GetPortsDataLocation {
    private String href;
    private String ibx;
    ...
    public static Builder builder(GetPortsDataLocation defaults) {
    ...
    public static final class Builder {
        ...
        private String region;
        public Builder() {}
        public Builder(GetPortsDataLocation defaults) {
        ...
        public GetPortsDataLocation build() {
            final var o = new GetPortsDataLocation();
            o.href = href;
            o.ibx = ibx;
