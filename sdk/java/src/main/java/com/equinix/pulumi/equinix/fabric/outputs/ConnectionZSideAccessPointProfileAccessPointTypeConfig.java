...
@CustomType
public final class ConnectionZSideAccessPointProfileAccessPointTypeConfig {
    /**
    ...
    public static Builder builder(ConnectionZSideAccessPointProfileAccessPointTypeConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String uuid;
        public Builder() {}
        public Builder(ConnectionZSideAccessPointProfileAccessPointTypeConfig defaults) {
