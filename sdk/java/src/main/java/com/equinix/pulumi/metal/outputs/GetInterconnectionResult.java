...
public final class GetInterconnectionResult {
    ...
    /**
     * @return Type of service token, aSide or z_side. One available in shared connection.
     * 
     */
    ...
    /**
     * @return (Deprecated) Fabric Token required to configure the connection in Equinix Fabric with the equinix.fabric.Connection resource or from the [Equinix Fabric Portal](https://fabric.equinix.com/dashboard). If your organization already has connection service tokens enabled, use `serviceTokens` instead.
     * 
     * @deprecated
     * If your organization already has connection service tokens enabled, use `serviceTokens` instead
     * 
     */
