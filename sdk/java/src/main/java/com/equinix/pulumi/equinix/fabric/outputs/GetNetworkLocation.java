...
public final class GetNetworkLocation {
    ...
    public static Builder builder(GetNetworkLocation defaults) {
    ...
    public static final class Builder {
        ...
        private String region;
        public Builder() {}
        public Builder(GetNetworkLocation defaults) {
        ...
        public Builder ibx(String ibx) {
            if (ibx == null) {
              throw new MissingRequiredPropertyException("GetNetworkLocation", "ibx");
            }
            this.ibx = ibx;
            return this;
        }
        ...
        public Builder metroCode(String metroCode) {
            if (metroCode == null) {
              throw new MissingRequiredPropertyException("GetNetworkLocation", "metroCode");
            }
        ...
        public Builder metroName(String metroName) {
            if (metroName == null) {
              throw new MissingRequiredPropertyException("GetNetworkLocation", "metroName");
            }
        ...
        public Builder region(String region) {
            if (region == null) {
              throw new MissingRequiredPropertyException("GetNetworkLocation", "region");
            }
            this.region = region;
            return this;
        }
        public GetNetworkLocation build() {
            final var _resultValue = new GetNetworkLocation();
