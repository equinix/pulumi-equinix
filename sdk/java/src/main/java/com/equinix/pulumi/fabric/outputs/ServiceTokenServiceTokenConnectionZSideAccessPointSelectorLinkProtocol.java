...
@CustomType
public final class ServiceTokenServiceTokenConnectionZSideAccessPointSelectorLinkProtocol {
    /**
    ...
    private ServiceTokenServiceTokenConnectionZSideAccessPointSelectorLinkProtocol() {}
    /**
     * @return Type of the link protocol - UNTAGGED, DOT1Q, QINQ, EVPN_VXLAN
     * 
     */
    ...
    public static Builder builder(ServiceTokenServiceTokenConnectionZSideAccessPointSelectorLinkProtocol defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer vlanTag;
        public Builder() {}
        public Builder(ServiceTokenServiceTokenConnectionZSideAccessPointSelectorLinkProtocol defaults) {
        ...
        public ServiceTokenServiceTokenConnectionZSideAccessPointSelectorLinkProtocol build() {
            final var _resultValue = new ServiceTokenServiceTokenConnectionZSideAccessPointSelectorLinkProtocol();
