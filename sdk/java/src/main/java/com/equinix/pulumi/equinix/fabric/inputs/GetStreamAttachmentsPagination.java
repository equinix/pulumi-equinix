...
public final class GetStreamAttachmentsPagination extends com.pulumi.resources.InvokeArgs {

    public static final GetStreamAttachmentsPagination Empty = new GetStreamAttachmentsPagination();
    ...
    private GetStreamAttachmentsPagination() {}

    private GetStreamAttachmentsPagination(GetStreamAttachmentsPagination $) {
        this.limit = $.limit;
        this.next = $.next;
        this.offset = $.offset;
    ...
    public static Builder builder(GetStreamAttachmentsPagination defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetStreamAttachmentsPagination();
        }

        public Builder(GetStreamAttachmentsPagination defaults) {
            $ = new GetStreamAttachmentsPagination(Objects.requireNonNull(defaults));
        }
        ...
        public GetStreamAttachmentsPagination build() {
            if ($.limit == null) {
                throw new MissingRequiredPropertyException("GetStreamAttachmentsPagination", "limit");
            }
            if ($.next == null) {
                throw new MissingRequiredPropertyException("GetStreamAttachmentsPagination", "next");
            }
            if ($.offset == null) {
                throw new MissingRequiredPropertyException("GetStreamAttachmentsPagination", "offset");
            }
            if ($.previous == null) {
                throw new MissingRequiredPropertyException("GetStreamAttachmentsPagination", "previous");
            }
            if ($.total == null) {
                throw new MissingRequiredPropertyException("GetStreamAttachmentsPagination", "total");
            }
            return $;
        }
    }
