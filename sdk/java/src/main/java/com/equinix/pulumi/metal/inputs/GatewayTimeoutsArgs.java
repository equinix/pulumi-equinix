...
public final class GatewayTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GatewayTimeoutsArgs Empty = new GatewayTimeoutsArgs();
    ...
    private GatewayTimeoutsArgs() {}

    private GatewayTimeoutsArgs(GatewayTimeoutsArgs $) {
        this.delete = $.delete;
    }
    ...
    public static Builder builder(GatewayTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GatewayTimeoutsArgs();
        }

        public Builder(GatewayTimeoutsArgs defaults) {
            $ = new GatewayTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GatewayTimeoutsArgs build() {
            return $;
        }
    }
