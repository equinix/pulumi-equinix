...
public final class PortChangeLogArgs extends com.pulumi.resources.ResourceArgs {

    public static final PortChangeLogArgs Empty = new PortChangeLogArgs();
    ...
    /**
     * @return User name of creator of the port resource
     * 
     */
    ...
    /**
     * @return Email of creator of the port resource
     * 
     */
    ...
    /**
     * @return Legal name of creator of the port resource
     * 
     */
    ...
    /**
     * @return Creation time of the port resource
     * 
     */
    ...
    /**
     * @return User name of deleter of the port resource
     * 
     */
    ...
    /**
     * @return Email of deleter of the port resource
     * 
     */
    ...
    /**
     * @return Legal name of deleter of the port resource
     * 
     */
    ...
    /**
     * @return Deletion time of the port resource
     * 
     */
    ...
    /**
     * @return User name of last updater of the port resource
     * 
     */
    ...
    /**
     * @return Email of last updater of the port resource
     * 
     */
    ...
    /**
     * @return Legal name of last updater of the port resource
     * 
     */
    ...
    /**
     * @return Last update time of the port resource
     * 
     */
    ...
    private PortChangeLogArgs() {}

    private PortChangeLogArgs(PortChangeLogArgs $) {
    ...
    public static Builder builder(PortChangeLogArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PortChangeLogArgs();
        }

        public Builder(PortChangeLogArgs defaults) {
            $ = new PortChangeLogArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param createdBy User name of creator of the port resource
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param createdByEmail Email of creator of the port resource
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param createdByFullName Legal name of creator of the port resource
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param createdDateTime Creation time of the port resource
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param deletedBy User name of deleter of the port resource
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param deletedByEmail Email of deleter of the port resource
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param deletedByFullName Legal name of deleter of the port resource
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param deletedDateTime Deletion time of the port resource
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param updatedBy User name of last updater of the port resource
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param updatedByEmail Email of last updater of the port resource
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param updatedByFullName Legal name of last updater of the port resource
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param updatedDateTime Last update time of the port resource
         * 
         * @return builder
         * 
         */
        ...
        public PortChangeLogArgs build() {
            return $;
        }
    }
