...
@CustomType
public final class ConnectionASideAccessPointLocation {
    /**
     * @return IBX Code
     * 
     */
    ...
    public static Builder builder(ConnectionASideAccessPointLocation defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String region;
        public Builder() {}
        public Builder(ConnectionASideAccessPointLocation defaults) {
        ...
        public ConnectionASideAccessPointLocation build() {
            final var _resultValue = new ConnectionASideAccessPointLocation();
