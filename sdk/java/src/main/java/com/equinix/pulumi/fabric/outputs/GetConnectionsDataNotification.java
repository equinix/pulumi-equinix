...
public final class GetConnectionsDataNotification {
    ...
    public static final class Builder {
        ...
        public Builder emails(List<String> emails) {
            if (emails == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataNotification", "emails");
            }
            this.emails = emails;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataNotification", "type");
            }
            this.type = type;
            return this;
        }
