...
public class SshUser extends com.pulumi.resources.CustomResource {
     ...
     */
    public SshUser(java.lang.String name) {
     ...
     */
    public SshUser(java.lang.String name, SshUserArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SshUser(java.lang.String name, SshUserArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("equinix:networkedge/sshUser:SshUser", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SshUser(java.lang.String name, Output<java.lang.String> id, @Nullable SshUserState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("equinix:networkedge/sshUser:SshUser", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static SshUser get(java.lang.String name, Output<java.lang.String> id, @Nullable SshUserState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
