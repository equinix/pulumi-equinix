...
public final class DeviceBehaviorArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return List of attributes that are allowed to change without recreating the instance. Supported attributes: `customData`, `userData`
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param allowChanges List of attributes that are allowed to change without recreating the instance. Supported attributes: `customData`, `userData`
         * 
         * @return builder
         * 
         */
