...
public final class GatewayState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return UUID of Public or VRF IP Reservation to associate with the gateway, the reservation must be in the same metro as the VLAN, conflicts with `privateIpv4SubnetSize`.
     * 
     */
    ...
    /**
     * @return Size of the private IPv4 subnet to create for this metal gateway, must be one of `8`, `16`, `32`, `64`, `128`. Conflicts with `ipReservationId`.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param ipReservationId UUID of Public or VRF IP Reservation to associate with the gateway, the reservation must be in the same metro as the VLAN, conflicts with `privateIpv4SubnetSize`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param privateIpv4SubnetSize Size of the private IPv4 subnet to create for this metal gateway, must be one of `8`, `16`, `32`, `64`, `128`. Conflicts with `ipReservationId`.
         * 
         * @return builder
         * 
         */
