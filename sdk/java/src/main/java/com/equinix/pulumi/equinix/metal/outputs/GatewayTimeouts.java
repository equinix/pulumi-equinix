...
@CustomType
public final class GatewayTimeouts {
    /**
    ...
    public static Builder builder(GatewayTimeouts defaults) {
    ...
    public static final class Builder {
        private @Nullable String delete;
        public Builder() {}
        public Builder(GatewayTimeouts defaults) {
        ...
        public GatewayTimeouts build() {
            final var _resultValue = new GatewayTimeouts();
