...
public final class RouteFilterRuleChangeLogArgs extends com.pulumi.resources.ResourceArgs {

    public static final RouteFilterRuleChangeLogArgs Empty = new RouteFilterRuleChangeLogArgs();
    ...
    private RouteFilterRuleChangeLogArgs() {}

    private RouteFilterRuleChangeLogArgs(RouteFilterRuleChangeLogArgs $) {
    ...
    public static Builder builder(RouteFilterRuleChangeLogArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RouteFilterRuleChangeLogArgs();
        }

        public Builder(RouteFilterRuleChangeLogArgs defaults) {
            $ = new RouteFilterRuleChangeLogArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RouteFilterRuleChangeLogArgs build() {
            return $;
        }
    }
