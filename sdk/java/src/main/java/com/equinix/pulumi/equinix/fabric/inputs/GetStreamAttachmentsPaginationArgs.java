...
public final class GetStreamAttachmentsPaginationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetStreamAttachmentsPaginationArgs Empty = new GetStreamAttachmentsPaginationArgs();
    ...
    private GetStreamAttachmentsPaginationArgs() {}

    private GetStreamAttachmentsPaginationArgs(GetStreamAttachmentsPaginationArgs $) {
        this.limit = $.limit;
        this.next = $.next;
        this.offset = $.offset;
    ...
    public static Builder builder(GetStreamAttachmentsPaginationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetStreamAttachmentsPaginationArgs();
        }

        public Builder(GetStreamAttachmentsPaginationArgs defaults) {
            $ = new GetStreamAttachmentsPaginationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetStreamAttachmentsPaginationArgs build() {
            if ($.limit == null) {
                throw new MissingRequiredPropertyException("GetStreamAttachmentsPaginationArgs", "limit");
            }
            if ($.next == null) {
                throw new MissingRequiredPropertyException("GetStreamAttachmentsPaginationArgs", "next");
            }
            if ($.offset == null) {
                throw new MissingRequiredPropertyException("GetStreamAttachmentsPaginationArgs", "offset");
            }
            if ($.previous == null) {
                throw new MissingRequiredPropertyException("GetStreamAttachmentsPaginationArgs", "previous");
            }
            if ($.total == null) {
                throw new MissingRequiredPropertyException("GetStreamAttachmentsPaginationArgs", "total");
            }
            return $;
        }
    }
