...
public final class NetworkNotification {
    ...
    public static Builder builder(NetworkNotification defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(NetworkNotification defaults) {
        ...
        public Builder emails(List<String> emails) {
            if (emails == null) {
              throw new MissingRequiredPropertyException("NetworkNotification", "emails");
            }
            this.emails = emails;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("NetworkNotification", "type");
            }
            this.type = type;
            return this;
        }
        public NetworkNotification build() {
            final var _resultValue = new NetworkNotification();
