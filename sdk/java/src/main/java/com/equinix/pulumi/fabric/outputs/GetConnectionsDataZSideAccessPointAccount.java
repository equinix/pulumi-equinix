...
@CustomType
public final class GetConnectionsDataZSideAccessPointAccount {
    /**
    ...
    private GetConnectionsDataZSideAccessPointAccount() {}
    /**
     * @return Legal name of the accountholder.
     * 
     */
    ...
    public static Builder builder(GetConnectionsDataZSideAccessPointAccount defaults) {
    ...
    public static final class Builder {
        ...
        private String ucmId;
        public Builder() {}
        public Builder(GetConnectionsDataZSideAccessPointAccount defaults) {
        ...
        public Builder accountName(String accountName) {
            if (accountName == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataZSideAccessPointAccount", "accountName");
            }
        ...
        public Builder accountNumber(Integer accountNumber) {
            if (accountNumber == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataZSideAccessPointAccount", "accountNumber");
            }
        ...
        public Builder globalCustId(String globalCustId) {
            if (globalCustId == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataZSideAccessPointAccount", "globalCustId");
            }
        ...
        public Builder globalOrgId(String globalOrgId) {
            if (globalOrgId == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataZSideAccessPointAccount", "globalOrgId");
            }
        ...
        public Builder globalOrganizationName(String globalOrganizationName) {
            if (globalOrganizationName == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataZSideAccessPointAccount", "globalOrganizationName");
            }
        ...
        public Builder orgId(Integer orgId) {
            if (orgId == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataZSideAccessPointAccount", "orgId");
            }
            this.orgId = orgId;
            return this;
        }
        ...
        public Builder organizationName(String organizationName) {
            if (organizationName == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataZSideAccessPointAccount", "organizationName");
            }
        ...
        public Builder ucmId(String ucmId) {
            if (ucmId == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataZSideAccessPointAccount", "ucmId");
            }
            this.ucmId = ucmId;
            return this;
        }
        public GetConnectionsDataZSideAccessPointAccount build() {
            final var _resultValue = new GetConnectionsDataZSideAccessPointAccount();
