...
public final class ProjectArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The UUID of payment method for this project. The payment method and the project need to belong to the same organization (passed with `organizationId`, or default).
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param paymentMethodId The UUID of payment method for this project. The payment method and the project need to belong to the same organization (passed with `organizationId`, or default).
         * 
         * @return builder
         * 
         */
