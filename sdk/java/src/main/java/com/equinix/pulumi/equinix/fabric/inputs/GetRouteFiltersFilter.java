...
public final class GetRouteFiltersFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetRouteFiltersFilter Empty = new GetRouteFiltersFilter();
    ...
    private GetRouteFiltersFilter(GetRouteFiltersFilter $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRouteFiltersFilter();
        }

        public Builder(GetRouteFiltersFilter defaults) {
            $ = new GetRouteFiltersFilter(Objects.requireNonNull(defaults));
        }
