...
@CustomType
public final class GetRouteFilterRulesDataChangeLog {
    /**
    ...
    private GetRouteFilterRulesDataChangeLog() {}
    /**
     * @return Created by User Key
     * 
     */
    ...
    public static Builder builder(GetRouteFilterRulesDataChangeLog defaults) {
    ...
    public static final class Builder {
        ...
        private String updatedDateTime;
        public Builder() {}
        public Builder(GetRouteFilterRulesDataChangeLog defaults) {
        ...
        public Builder createdBy(String createdBy) {
            if (createdBy == null) {
              throw new MissingRequiredPropertyException("GetRouteFilterRulesDataChangeLog", "createdBy");
            }
        ...
        public Builder createdByEmail(String createdByEmail) {
            if (createdByEmail == null) {
              throw new MissingRequiredPropertyException("GetRouteFilterRulesDataChangeLog", "createdByEmail");
            }
        ...
        public Builder createdByFullName(String createdByFullName) {
            if (createdByFullName == null) {
              throw new MissingRequiredPropertyException("GetRouteFilterRulesDataChangeLog", "createdByFullName");
            }
        ...
        public Builder createdDateTime(String createdDateTime) {
            if (createdDateTime == null) {
              throw new MissingRequiredPropertyException("GetRouteFilterRulesDataChangeLog", "createdDateTime");
            }
        ...
        public Builder deletedBy(String deletedBy) {
            if (deletedBy == null) {
              throw new MissingRequiredPropertyException("GetRouteFilterRulesDataChangeLog", "deletedBy");
            }
        ...
        public Builder deletedByEmail(String deletedByEmail) {
            if (deletedByEmail == null) {
              throw new MissingRequiredPropertyException("GetRouteFilterRulesDataChangeLog", "deletedByEmail");
            }
        ...
        public Builder deletedByFullName(String deletedByFullName) {
            if (deletedByFullName == null) {
              throw new MissingRequiredPropertyException("GetRouteFilterRulesDataChangeLog", "deletedByFullName");
            }
        ...
        public Builder deletedDateTime(String deletedDateTime) {
            if (deletedDateTime == null) {
              throw new MissingRequiredPropertyException("GetRouteFilterRulesDataChangeLog", "deletedDateTime");
            }
        ...
        public Builder updatedBy(String updatedBy) {
            if (updatedBy == null) {
              throw new MissingRequiredPropertyException("GetRouteFilterRulesDataChangeLog", "updatedBy");
            }
        ...
        public Builder updatedByEmail(String updatedByEmail) {
            if (updatedByEmail == null) {
              throw new MissingRequiredPropertyException("GetRouteFilterRulesDataChangeLog", "updatedByEmail");
            }
        ...
        public Builder updatedByFullName(String updatedByFullName) {
            if (updatedByFullName == null) {
              throw new MissingRequiredPropertyException("GetRouteFilterRulesDataChangeLog", "updatedByFullName");
            }
        ...
        public Builder updatedDateTime(String updatedDateTime) {
            if (updatedDateTime == null) {
              throw new MissingRequiredPropertyException("GetRouteFilterRulesDataChangeLog", "updatedDateTime");
            }
            this.updatedDateTime = updatedDateTime;
            return this;
        }
        public GetRouteFilterRulesDataChangeLog build() {
            final var _resultValue = new GetRouteFilterRulesDataChangeLog();
