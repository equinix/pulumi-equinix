...
public final class GetConnectionZSideAccessPointVirtualDevice {
    ...
    public static final class Builder {
        ...
        public Builder href(String href) {
            if (href == null) {
              throw new MissingRequiredPropertyException("GetConnectionZSideAccessPointVirtualDevice", "href");
            }
            this.href = href;
            return this;
        }
        ...
        public Builder uuid(String uuid) {
            if (uuid == null) {
              throw new MissingRequiredPropertyException("GetConnectionZSideAccessPointVirtualDevice", "uuid");
            }
            this.uuid = uuid;
            return this;
        }
