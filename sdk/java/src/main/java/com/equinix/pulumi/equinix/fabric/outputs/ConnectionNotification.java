...
public final class ConnectionNotification {
    ...
    public static Builder builder(ConnectionNotification defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(ConnectionNotification defaults) {
        ...
        public Builder emails(List<String> emails) {
            if (emails == null) {
              throw new MissingRequiredPropertyException("ConnectionNotification", "emails");
            }
            this.emails = emails;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("ConnectionNotification", "type");
            }
            this.type = type;
            return this;
        }
