...
public final class GetConnectionASideServiceToken {
    ...
    public static final class Builder {
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetConnectionASideServiceToken", "description");
            }
        ...
        public Builder href(String href) {
            if (href == null) {
              throw new MissingRequiredPropertyException("GetConnectionASideServiceToken", "href");
            }
            this.href = href;
            return this;
        }
        ...
        public GetConnectionASideServiceToken build() {
            final var _resultValue = new GetConnectionASideServiceToken();
