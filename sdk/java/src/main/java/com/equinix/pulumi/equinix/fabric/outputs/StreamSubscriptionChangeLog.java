...
@CustomType
public final class StreamSubscriptionChangeLog {
    /**
    ...
    private StreamSubscriptionChangeLog() {}
    /**
     * @return User name of creator of the stream resource
     * 
     */
    ...
    public static Builder builder(StreamSubscriptionChangeLog defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String updatedDateTime;
        public Builder() {}
        public Builder(StreamSubscriptionChangeLog defaults) {
        ...
        public StreamSubscriptionChangeLog build() {
            final var _resultValue = new StreamSubscriptionChangeLog();
