...
@CustomType
public final class GetCloudRouterChangeLog {
    /**
    ...
    private GetCloudRouterChangeLog() {}
    /**
     * @return Created by User Key
     * 
     */
    ...
    public static Builder builder(GetCloudRouterChangeLog defaults) {
    ...
    public static final class Builder {
        ...
        private String updatedDateTime;
        public Builder() {}
        public Builder(GetCloudRouterChangeLog defaults) {
        ...
        public Builder createdBy(String createdBy) {
            if (createdBy == null) {
              throw new MissingRequiredPropertyException("GetCloudRouterChangeLog", "createdBy");
            }
        ...
        public Builder createdByEmail(String createdByEmail) {
            if (createdByEmail == null) {
              throw new MissingRequiredPropertyException("GetCloudRouterChangeLog", "createdByEmail");
            }
        ...
        public Builder createdByFullName(String createdByFullName) {
            if (createdByFullName == null) {
              throw new MissingRequiredPropertyException("GetCloudRouterChangeLog", "createdByFullName");
            }
        ...
        public Builder createdDateTime(String createdDateTime) {
            if (createdDateTime == null) {
              throw new MissingRequiredPropertyException("GetCloudRouterChangeLog", "createdDateTime");
            }
        ...
        public Builder deletedBy(String deletedBy) {
            if (deletedBy == null) {
              throw new MissingRequiredPropertyException("GetCloudRouterChangeLog", "deletedBy");
            }
        ...
        public Builder deletedByEmail(String deletedByEmail) {
            if (deletedByEmail == null) {
              throw new MissingRequiredPropertyException("GetCloudRouterChangeLog", "deletedByEmail");
            }
        ...
        public Builder deletedByFullName(String deletedByFullName) {
            if (deletedByFullName == null) {
              throw new MissingRequiredPropertyException("GetCloudRouterChangeLog", "deletedByFullName");
            }
        ...
        public Builder deletedDateTime(String deletedDateTime) {
            if (deletedDateTime == null) {
              throw new MissingRequiredPropertyException("GetCloudRouterChangeLog", "deletedDateTime");
            }
        ...
        public Builder updatedBy(String updatedBy) {
            if (updatedBy == null) {
              throw new MissingRequiredPropertyException("GetCloudRouterChangeLog", "updatedBy");
            }
        ...
        public Builder updatedByEmail(String updatedByEmail) {
            if (updatedByEmail == null) {
              throw new MissingRequiredPropertyException("GetCloudRouterChangeLog", "updatedByEmail");
            }
        ...
        public Builder updatedByFullName(String updatedByFullName) {
            if (updatedByFullName == null) {
              throw new MissingRequiredPropertyException("GetCloudRouterChangeLog", "updatedByFullName");
            }
        ...
        public Builder updatedDateTime(String updatedDateTime) {
            if (updatedDateTime == null) {
              throw new MissingRequiredPropertyException("GetCloudRouterChangeLog", "updatedDateTime");
            }
