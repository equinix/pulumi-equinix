...
@CustomType
public final class GetServiceTokenNotification {
    /**
    ...
    private GetServiceTokenNotification() {}
    /**
     * @return Array of contact emails
     * 
     */
    ...
    public static Builder builder(GetServiceTokenNotification defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetServiceTokenNotification defaults) {
        ...
        public Builder emails(List<String> emails) {
            if (emails == null) {
              throw new MissingRequiredPropertyException("GetServiceTokenNotification", "emails");
            }
            this.emails = emails;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetServiceTokenNotification", "type");
            }
            this.type = type;
            return this;
        }
        public GetServiceTokenNotification build() {
            final var _resultValue = new GetServiceTokenNotification();
