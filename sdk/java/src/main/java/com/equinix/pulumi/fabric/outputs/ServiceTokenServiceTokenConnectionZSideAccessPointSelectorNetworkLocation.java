...
@CustomType
public final class ServiceTokenServiceTokenConnectionZSideAccessPointSelectorNetworkLocation {
    /**
     * @return IBX Code
     * 
     */
    ...
    private ServiceTokenServiceTokenConnectionZSideAccessPointSelectorNetworkLocation() {}
    /**
     * @return IBX Code
     * 
     */
    ...
    public static Builder builder(ServiceTokenServiceTokenConnectionZSideAccessPointSelectorNetworkLocation defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String region;
        public Builder() {}
        public Builder(ServiceTokenServiceTokenConnectionZSideAccessPointSelectorNetworkLocation defaults) {
        ...
        public ServiceTokenServiceTokenConnectionZSideAccessPointSelectorNetworkLocation build() {
            final var _resultValue = new ServiceTokenServiceTokenConnectionZSideAccessPointSelectorNetworkLocation();
