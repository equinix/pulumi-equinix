...
@CustomType
public final class PortChangeLog {
    /**
    ...
    public static Builder builder(PortChangeLog defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String updatedDateTime;
        public Builder() {}
        public Builder(PortChangeLog defaults) {
        ...
        public PortChangeLog build() {
            final var _resultValue = new PortChangeLog();
