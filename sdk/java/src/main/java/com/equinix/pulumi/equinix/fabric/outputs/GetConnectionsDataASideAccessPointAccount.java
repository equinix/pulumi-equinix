...
@CustomType
public final class GetConnectionsDataASideAccessPointAccount {
    /**
    ...
    private GetConnectionsDataASideAccessPointAccount() {}
    /**
     * @return Legal name of the accountholder.
     * 
     */
    ...
    public static Builder builder(GetConnectionsDataASideAccessPointAccount defaults) {
    ...
    public static final class Builder {
        ...
        private String ucmId;
        public Builder() {}
        public Builder(GetConnectionsDataASideAccessPointAccount defaults) {
        ...
        public Builder accountName(String accountName) {
            if (accountName == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataASideAccessPointAccount", "accountName");
            }
        ...
        public Builder accountNumber(Integer accountNumber) {
            if (accountNumber == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataASideAccessPointAccount", "accountNumber");
            }
        ...
        public Builder globalCustId(String globalCustId) {
            if (globalCustId == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataASideAccessPointAccount", "globalCustId");
            }
        ...
        public Builder globalOrgId(String globalOrgId) {
            if (globalOrgId == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataASideAccessPointAccount", "globalOrgId");
            }
        ...
        public Builder globalOrganizationName(String globalOrganizationName) {
            if (globalOrganizationName == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataASideAccessPointAccount", "globalOrganizationName");
            }
        ...
        public Builder orgId(Integer orgId) {
            if (orgId == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataASideAccessPointAccount", "orgId");
            }
            this.orgId = orgId;
            return this;
        }
        ...
        public Builder organizationName(String organizationName) {
            if (organizationName == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataASideAccessPointAccount", "organizationName");
            }
        ...
        public Builder ucmId(String ucmId) {
            if (ucmId == null) {
              throw new MissingRequiredPropertyException("GetConnectionsDataASideAccessPointAccount", "ucmId");
            }
            this.ucmId = ucmId;
            return this;
        }
        public GetConnectionsDataASideAccessPointAccount build() {
            final var _resultValue = new GetConnectionsDataASideAccessPointAccount();
