...
@CustomType
public final class GetServiceProfilesDataCustomField {
    ...
    private GetServiceProfilesDataCustomField() {}
    ...
    public static Builder builder(GetServiceProfilesDataCustomField defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean required;
        public Builder() {}
        public Builder(GetServiceProfilesDataCustomField defaults) {
        ...
        public GetServiceProfilesDataCustomField build() {
            final var o = new GetServiceProfilesDataCustomField();
