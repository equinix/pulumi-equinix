...
public final class RouteAggregationRuleChangeLog {
    ...
    public static Builder builder(RouteAggregationRuleChangeLog defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String updatedDateTime;
        public Builder() {}
        public Builder(RouteAggregationRuleChangeLog defaults) {
        ...
        public RouteAggregationRuleChangeLog build() {
            final var _resultValue = new RouteAggregationRuleChangeLog();
