...
public final class GetServiceProfilesArgs extends com.pulumi.resources.InvokeArgs {
    ...
    /**
     * @return Filters for the Data Source Search Request (If andFilters is not set to true you cannot provide more than one filter block)
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param filter Filters for the Data Source Search Request (If andFilters is not set to true you cannot provide more than one filter block)
         * 
         * @return builder
         * 
         */
