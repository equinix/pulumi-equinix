...
import com.equinix.pulumi.equinix.networkedge.inputs.DeviceClusterDetailsNode1VendorConfigurationArgs;
...
public final class DeviceClusterDetailsNode1Args extends com.pulumi.resources.ResourceArgs {
    ...
    private DeviceClusterDetailsNode1Args() {}

    private DeviceClusterDetailsNode1Args(DeviceClusterDetailsNode1Args $) {
    ...
    public static Builder builder(DeviceClusterDetailsNode1Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeviceClusterDetailsNode1Args();
        }

        public Builder(DeviceClusterDetailsNode1Args defaults) {
            $ = new DeviceClusterDetailsNode1Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder vendorConfiguration(@Nullable Output<DeviceClusterDetailsNode1VendorConfigurationArgs> vendorConfiguration) {
         ...
         * 
         */
        public Builder vendorConfiguration(DeviceClusterDetailsNode1VendorConfigurationArgs vendorConfiguration) {
            return vendorConfiguration(Output.of(vendorConfiguration));
        }

        public DeviceClusterDetailsNode1Args build() {
            return $;
        }
    }
