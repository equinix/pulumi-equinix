...
public final class GetConnectionASideAccessPointPortRedundancy {
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetConnectionASideAccessPointPortRedundancy", "enabled");
            }
        ...
        public Builder group(String group) {
            if (group == null) {
              throw new MissingRequiredPropertyException("GetConnectionASideAccessPointPortRedundancy", "group");
            }
            this.group = group;
            return this;
        }
        ...
        public Builder priority(String priority) {
            if (priority == null) {
              throw new MissingRequiredPropertyException("GetConnectionASideAccessPointPortRedundancy", "priority");
            }
