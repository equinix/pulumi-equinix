...
public final class GetRouteAggregationsPaginationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetRouteAggregationsPaginationArgs Empty = new GetRouteAggregationsPaginationArgs();
    ...
    /**
     * @return The total number of route aggregations available to the user making the request
     * 
     */
    ...
    private GetRouteAggregationsPaginationArgs() {}

    private GetRouteAggregationsPaginationArgs(GetRouteAggregationsPaginationArgs $) {
        this.limit = $.limit;
        this.next = $.next;
        this.offset = $.offset;
    ...
    public static Builder builder(GetRouteAggregationsPaginationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRouteAggregationsPaginationArgs();
        }

        public Builder(GetRouteAggregationsPaginationArgs defaults) {
            $ = new GetRouteAggregationsPaginationArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param total The total number of route aggregations available to the user making the request
         * 
         * @return builder
         * 
         */
        ...
        public GetRouteAggregationsPaginationArgs build() {
            if ($.limit == null) {
                throw new MissingRequiredPropertyException("GetRouteAggregationsPaginationArgs", "limit");
            }
            if ($.next == null) {
                throw new MissingRequiredPropertyException("GetRouteAggregationsPaginationArgs", "next");
            }
            if ($.offset == null) {
                throw new MissingRequiredPropertyException("GetRouteAggregationsPaginationArgs", "offset");
            }
            if ($.previous == null) {
                throw new MissingRequiredPropertyException("GetRouteAggregationsPaginationArgs", "previous");
            }
            if ($.total == null) {
                throw new MissingRequiredPropertyException("GetRouteAggregationsPaginationArgs", "total");
            }
            return $;
        }
    }
