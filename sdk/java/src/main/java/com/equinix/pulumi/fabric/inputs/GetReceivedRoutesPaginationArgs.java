...
public final class GetReceivedRoutesPaginationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetReceivedRoutesPaginationArgs Empty = new GetReceivedRoutesPaginationArgs();
    ...
    private GetReceivedRoutesPaginationArgs() {}

    private GetReceivedRoutesPaginationArgs(GetReceivedRoutesPaginationArgs $) {
        this.limit = $.limit;
        this.next = $.next;
        this.offset = $.offset;
    ...
    public static Builder builder(GetReceivedRoutesPaginationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetReceivedRoutesPaginationArgs();
        }

        public Builder(GetReceivedRoutesPaginationArgs defaults) {
            $ = new GetReceivedRoutesPaginationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetReceivedRoutesPaginationArgs build() {
            if ($.next == null) {
                throw new MissingRequiredPropertyException("GetReceivedRoutesPaginationArgs", "next");
            }
            if ($.previous == null) {
                throw new MissingRequiredPropertyException("GetReceivedRoutesPaginationArgs", "previous");
            }
            if ($.total == null) {
                throw new MissingRequiredPropertyException("GetReceivedRoutesPaginationArgs", "total");
            }
            return $;
        }
    }
