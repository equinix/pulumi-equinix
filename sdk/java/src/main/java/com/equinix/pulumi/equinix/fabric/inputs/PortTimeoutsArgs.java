...
public final class PortTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final PortTimeoutsArgs Empty = new PortTimeoutsArgs();
    ...
    private PortTimeoutsArgs() {}

    private PortTimeoutsArgs(PortTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.read = $.read;
        this.update = $.update;
    ...
    public static Builder builder(PortTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PortTimeoutsArgs();
        }

        public Builder(PortTimeoutsArgs defaults) {
            $ = new PortTimeoutsArgs(Objects.requireNonNull(defaults));
        }
