...
import com.equinix.pulumi.equinix.networkedge.inputs.BgpState;
...
public class Bgp extends com.pulumi.resources.CustomResource {
     ...
     */
    public Bgp(java.lang.String name) {
     ...
     */
    public Bgp(java.lang.String name, BgpArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Bgp(java.lang.String name, BgpArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("equinix:networkedge/bgp:Bgp", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Bgp(java.lang.String name, Output<java.lang.String> id, @Nullable BgpState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("equinix:networkedge/bgp:Bgp", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static Bgp get(java.lang.String name, Output<java.lang.String> id, @Nullable BgpState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
