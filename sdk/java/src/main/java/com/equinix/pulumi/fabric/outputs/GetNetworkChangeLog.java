...
@CustomType
public final class GetNetworkChangeLog {
    /**
    ...
    public static Builder builder(GetNetworkChangeLog defaults) {
    ...
    public static final class Builder {
        ...
        private String updatedDateTime;
        public Builder() {}
        public Builder(GetNetworkChangeLog defaults) {
        ...
        public GetNetworkChangeLog build() {
            final var _resultValue = new GetNetworkChangeLog();
