...
public final class GetReceivedRoutesFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetReceivedRoutesFilterArgs Empty = new GetReceivedRoutesFilterArgs();
    ...
    private GetReceivedRoutesFilterArgs() {}

    private GetReceivedRoutesFilterArgs(GetReceivedRoutesFilterArgs $) {
    ...
    public static Builder builder(GetReceivedRoutesFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetReceivedRoutesFilterArgs();
        }

        public Builder(GetReceivedRoutesFilterArgs defaults) {
            $ = new GetReceivedRoutesFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetReceivedRoutesFilterArgs build() {
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("GetReceivedRoutesFilterArgs", "operator");
            }
            if ($.property == null) {
                throw new MissingRequiredPropertyException("GetReceivedRoutesFilterArgs", "property");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetReceivedRoutesFilterArgs", "values");
            }
            return $;
        }
    }
