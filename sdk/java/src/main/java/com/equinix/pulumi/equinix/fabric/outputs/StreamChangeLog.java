...
@CustomType
public final class StreamChangeLog {
    /**
    ...
    public static Builder builder(StreamChangeLog defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String updatedDateTime;
        public Builder() {}
        public Builder(StreamChangeLog defaults) {
        ...
        public StreamChangeLog build() {
            final var _resultValue = new StreamChangeLog();
