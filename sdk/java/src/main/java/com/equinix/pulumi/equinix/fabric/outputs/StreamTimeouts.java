...
@CustomType
public final class StreamTimeouts {
    /**
    ...
    public static Builder builder(StreamTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(StreamTimeouts defaults) {
        ...
        public StreamTimeouts build() {
            final var _resultValue = new StreamTimeouts();
