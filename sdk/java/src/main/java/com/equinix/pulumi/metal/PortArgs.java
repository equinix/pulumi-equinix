...
public final class PortArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return UUID of a VLAN to assign as a native VLAN. It must be one of attached VLANs (from `vlanIds` parameter).
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param nativeVlanId UUID of a VLAN to assign as a native VLAN. It must be one of attached VLANs (from `vlanIds` parameter).
         * 
         * @return builder
         * 
         */
