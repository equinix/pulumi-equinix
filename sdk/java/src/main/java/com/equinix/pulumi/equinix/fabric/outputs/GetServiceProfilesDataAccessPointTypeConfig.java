...
import com.equinix.pulumi.equinix.fabric.outputs.GetServiceProfilesDataAccessPointTypeConfigApiConfig;
import com.equinix.pulumi.equinix.fabric.outputs.GetServiceProfilesDataAccessPointTypeConfigAuthenticationKey;
import com.equinix.pulumi.equinix.fabric.outputs.GetServiceProfilesDataAccessPointTypeConfigLinkProtocolConfig;
...
@CustomType
public final class GetServiceProfilesDataAccessPointTypeConfig {
    ...
    private List<GetServiceProfilesDataAccessPointTypeConfigApiConfig> apiConfigs;
    private List<GetServiceProfilesDataAccessPointTypeConfigAuthenticationKey> authenticationKeys;
    ...
    private List<GetServiceProfilesDataAccessPointTypeConfigLinkProtocolConfig> linkProtocolConfigs;
    private List<Integer> supportedBandwidths;
    private String type;
    private String uuid;

    private GetServiceProfilesDataAccessPointTypeConfig() {}
    ...
    public List<GetServiceProfilesDataAccessPointTypeConfigApiConfig> apiConfigs() {
        return this.apiConfigs;
    }
    public List<GetServiceProfilesDataAccessPointTypeConfigAuthenticationKey> authenticationKeys() {
    ...
    public List<GetServiceProfilesDataAccessPointTypeConfigLinkProtocolConfig> linkProtocolConfigs() {
    ...
    public static Builder builder(GetServiceProfilesDataAccessPointTypeConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String uuid;
        public Builder() {}
        public Builder(GetServiceProfilesDataAccessPointTypeConfig defaults) {
        ...
        @CustomType.Setter
        public Builder apiConfigs(List<GetServiceProfilesDataAccessPointTypeConfigApiConfig> apiConfigs) {
            this.apiConfigs = Objects.requireNonNull(apiConfigs);
            return this;
        }
        public Builder apiConfigs(GetServiceProfilesDataAccessPointTypeConfigApiConfig... apiConfigs) {
            return apiConfigs(List.of(apiConfigs));
        }
        @CustomType.Setter
        public Builder authenticationKeys(List<GetServiceProfilesDataAccessPointTypeConfigAuthenticationKey> authenticationKeys) {
            this.authenticationKeys = Objects.requireNonNull(authenticationKeys);
            return this;
        }
        public Builder authenticationKeys(GetServiceProfilesDataAccessPointTypeConfigAuthenticationKey... authenticationKeys) {
        ...
        @CustomType.Setter
        public Builder linkProtocolConfigs(List<GetServiceProfilesDataAccessPointTypeConfigLinkProtocolConfig> linkProtocolConfigs) {
            this.linkProtocolConfigs = Objects.requireNonNull(linkProtocolConfigs);
            return this;
        }
        public Builder linkProtocolConfigs(GetServiceProfilesDataAccessPointTypeConfigLinkProtocolConfig... linkProtocolConfigs) {
        ...
        public GetServiceProfilesDataAccessPointTypeConfig build() {
            final var o = new GetServiceProfilesDataAccessPointTypeConfig();
