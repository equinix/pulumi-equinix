...
public final class GetServiceTokensFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetServiceTokensFilterArgs Empty = new GetServiceTokensFilterArgs();
    ...
    private GetServiceTokensFilterArgs() {}

    private GetServiceTokensFilterArgs(GetServiceTokensFilterArgs $) {
    ...
    public static Builder builder(GetServiceTokensFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetServiceTokensFilterArgs();
        }

        public Builder(GetServiceTokensFilterArgs defaults) {
            $ = new GetServiceTokensFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetServiceTokensFilterArgs build() {
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("GetServiceTokensFilterArgs", "operator");
            }
            if ($.property == null) {
                throw new MissingRequiredPropertyException("GetServiceTokensFilterArgs", "property");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetServiceTokensFilterArgs", "values");
            }
            return $;
        }
    }
