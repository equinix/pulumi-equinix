...
import com.equinix.pulumi.fabric.inputs.GetRoutingProtocolBfdArgs;
import com.equinix.pulumi.fabric.inputs.GetRoutingProtocolBgpIpv4Args;
import com.equinix.pulumi.fabric.inputs.GetRoutingProtocolBgpIpv6Args;
import com.equinix.pulumi.fabric.inputs.GetRoutingProtocolDirectIpv4Args;
import com.equinix.pulumi.fabric.inputs.GetRoutingProtocolDirectIpv6Args;
...
public final class GetRoutingProtocolArgs extends com.pulumi.resources.InvokeArgs {
     ...
     */
    @Import(name="bfd")
    private @Nullable Output<GetRoutingProtocolBfdArgs> bfd;

    /**
     * @return Bidirectional Forwarding Detection
     * 
     */
    public Optional<Output<GetRoutingProtocolBfdArgs>> bfd() {
     ...
     */
    @Import(name="bgpIpv4")
    private @Nullable Output<GetRoutingProtocolBgpIpv4Args> bgpIpv4;

    /**
     * @return Routing Protocol BGP IPv4
     * 
     */
    public Optional<Output<GetRoutingProtocolBgpIpv4Args>> bgpIpv4() {
     ...
     */
    @Import(name="bgpIpv6")
    private @Nullable Output<GetRoutingProtocolBgpIpv6Args> bgpIpv6;

    /**
     * @return Routing Protocol BGP IPv6
     * 
     */
    public Optional<Output<GetRoutingProtocolBgpIpv6Args>> bgpIpv6() {
    ...
    private @Nullable Output<GetRoutingProtocolDirectIpv4Args> directIpv4;

    /**
     * @return Routing Protocol Direct IPv4
     * 
     */
    public Optional<Output<GetRoutingProtocolDirectIpv4Args>> directIpv4() {
    ...
    private @Nullable Output<GetRoutingProtocolDirectIpv6Args> directIpv6;

    /**
     * @return Routing Protocol Direct IPv6
     * 
     */
    public Optional<Output<GetRoutingProtocolDirectIpv6Args>> directIpv6() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder bfd(@Nullable Output<GetRoutingProtocolBfdArgs> bfd) {
            $.bfd = bfd;
            return this;
        }
         ...
         * 
         */
        public Builder bfd(GetRoutingProtocolBfdArgs bfd) {
         ...
         * 
         */
        public Builder bgpIpv4(@Nullable Output<GetRoutingProtocolBgpIpv4Args> bgpIpv4) {
            $.bgpIpv4 = bgpIpv4;
            return this;
        }
         ...
         * 
         */
        public Builder bgpIpv4(GetRoutingProtocolBgpIpv4Args bgpIpv4) {
         ...
         * 
         */
        public Builder bgpIpv6(@Nullable Output<GetRoutingProtocolBgpIpv6Args> bgpIpv6) {
            $.bgpIpv6 = bgpIpv6;
            return this;
        }
         ...
         * 
         */
        public Builder bgpIpv6(GetRoutingProtocolBgpIpv6Args bgpIpv6) {
         ...
         * 
         */
        public Builder directIpv4(@Nullable Output<GetRoutingProtocolDirectIpv4Args> directIpv4) {
         ...
         * 
         */
        public Builder directIpv4(GetRoutingProtocolDirectIpv4Args directIpv4) {
         ...
         * 
         */
        public Builder directIpv6(@Nullable Output<GetRoutingProtocolDirectIpv6Args> directIpv6) {
         ...
         * 
         */
        public Builder directIpv6(GetRoutingProtocolDirectIpv6Args directIpv6) {
