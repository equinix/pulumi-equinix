...
@CustomType
public final class GetPortsDataOperation {
    private Integer connectionCount;
    private String opStatusChangedAt;
    private String operationalStatus;

    private GetPortsDataOperation() {}
    ...
    public static Builder builder(GetPortsDataOperation defaults) {
    ...
    public static final class Builder {
        ...
        private String operationalStatus;
        public Builder() {}
        public Builder(GetPortsDataOperation defaults) {
        ...
        public GetPortsDataOperation build() {
            final var o = new GetPortsDataOperation();
