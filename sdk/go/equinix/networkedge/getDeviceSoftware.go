...
func GetDeviceSoftwareOutput(ctx *pulumi.Context, args GetDeviceSoftwareOutputArgs, opts ...pulumi.InvokeOption) GetDeviceSoftwareResultOutput {
	...
	return ctx.InvokeOutput("equinix:networkedge/getDeviceSoftware:getDeviceSoftware", args, GetDeviceSoftwareResultOutput{}, options).(GetDeviceSoftwareResultOutput)
}
