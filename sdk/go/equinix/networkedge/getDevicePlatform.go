...
func GetDevicePlatformOutput(ctx *pulumi.Context, args GetDevicePlatformOutputArgs, opts ...pulumi.InvokeOption) GetDevicePlatformResultOutput {
	...
	return ctx.InvokeOutput("equinix:networkedge/getDevicePlatform:getDevicePlatform", args, GetDevicePlatformResultOutput{}, options).(GetDevicePlatformResultOutput)
}
