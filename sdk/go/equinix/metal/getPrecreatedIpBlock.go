...
//			web1, err := metal.NewDevice(ctx, "web1", &metal.DeviceArgs{
//				Hostname:        pulumi.String("web1"),
...
//				return err
//			}
//			test, err := metal.GetPrecreatedIpBlock(ctx, &metal.GetPrecreatedIpBlockArgs{
...
//			_, err = metal.NewIpAttachment(ctx, "from_ipv6_block", &metal.IpAttachmentArgs{
//				DeviceId:     web1.ID(),
//				CidrNotation: pulumi.String(invokeCidrsubnet.Result),
//			})
//			if err != nil {
//				return err
//			}
