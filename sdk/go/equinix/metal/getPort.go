...
//			testDevice, err := metal.NewDevice(ctx, "test", &metal.DeviceArgs{
...
func LookupPortOutput(ctx *pulumi.Context, args LookupPortOutputArgs, opts ...pulumi.InvokeOption) LookupPortResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupPortResultOutput, error) {
			...
			return ctx.InvokeOutput("equinix:metal/getPort:getPort", args, LookupPortResultOutput{}, options).(LookupPortResultOutput), nil
