...
func GetMarketplaceSubscriptionOutput(ctx *pulumi.Context, args GetMarketplaceSubscriptionOutputArgs, opts ...pulumi.InvokeOption) GetMarketplaceSubscriptionResultOutput {
	...
	return ctx.InvokeOutput("equinix:fabric/getMarketplaceSubscription:getMarketplaceSubscription", args, GetMarketplaceSubscriptionResultOutput{}, options).(GetMarketplaceSubscriptionResultOutput)
}
