...
//			_, err := fabric.NewStreamSubscription(ctx, "SPLUNK", &fabric.StreamSubscriptionArgs{
//				Type:        pulumi.String("STREAM_SUBSCRIPTION"),
...
//						pulumi.String("equinix.fabric.connection.*"),
//					},
//				},
...
//					Type: pulumi.String("SPLUNK_HEC"),
//					Uri:  pulumi.String("<splunk_uri>"),
//					Settings: &fabric.StreamSubscriptionSinkSettingsArgs{
//						EventIndex:  pulumi.String("<splunk_event_index>"),
//						MetricIndex: pulumi.String("<splunk_metric_index>"),
//						Source:      pulumi.String("<splunk_source>"),
//					},
//					Credential: &fabric.StreamSubscriptionSinkCredentialArgs{
//						Type:        pulumi.String("ACCESS_TOKEN"),
//						AccessToken: pulumi.String("<splunk_access_token>"),
//					},
//				},
//			})
//			if err != nil {
//				return err
//			}
//			_, err = fabric.NewStreamSubscription(ctx, "SLACK", &fabric.StreamSubscriptionArgs{
//				Type:        pulumi.String("STREAM_SUBSCRIPTION"),
//				Name:        pulumi.String("<name>"),
//				Description: pulumi.String("<description>"),
//				StreamId:    pulumi.String("<stream_id>"),
...
//					Uri:  pulumi.String("<slack_uri>"),
//				},
//			})
//			if err != nil {
//				return err
//			}
//			_, err = fabric.NewStreamSubscription(ctx, "PAGER_DUTY", &fabric.StreamSubscriptionArgs{
//				Type:        pulumi.String("STREAM_SUBSCRIPTION"),
//				Name:        pulumi.String("<name>"),
//				Description: pulumi.String("<description>"),
//				StreamId:    pulumi.String("<stream_id>"),
...
//					Host: pulumi.String("<pager_duty_host"),
//					Settings: &fabric.StreamSubscriptionSinkSettingsArgs{
//						ChangeUri: "<pager_duty_change_uri>",
//						AlertUri:  "<pager_duty_alert_uri>",
//					},
//					Credential: &fabric.StreamSubscriptionSinkCredentialArgs{
//						Type:           pulumi.String("INTEGRATION_KEY"),
//						IntegrationKey: pulumi.String("<pager_duty_integration_key>"),
//					},
//				},
//			})
//			if err != nil {
//				return err
//			}
//			_, err = fabric.NewStreamSubscription(ctx, "DATADOG", &fabric.StreamSubscriptionArgs{
//				Type:        pulumi.String("STREAM_SUBSCRIPTION"),
//				Name:        pulumi.String("<name>"),
//				Description: pulumi.String("<description>"),
//				StreamId:    pulumi.String("<stream_id>"),
...
//					Host: pulumi.String("<datadog_host>"),
//					Settings: &fabric.StreamSubscriptionSinkSettingsArgs{
//						Source:         pulumi.String("Equinix"),
//						ApplicationKey: pulumi.String("<datadog_application_key>"),
//						EventUri:       pulumi.String("<datadog_event_uri>"),
//						MetricUri:      pulumi.String("<datadog_metric_uri>"),
//					},
//					Credential: &fabric.StreamSubscriptionSinkCredentialArgs{
...
//				return err
//			}
//			_, err = fabric.NewStreamSubscription(ctx, "MSTEAMS", &fabric.StreamSubscriptionArgs{
//				Type:        pulumi.String("STREAM_SUBSCRIPTION"),
//				Name:        pulumi.String("<name>"),
//				Description: pulumi.String("<description>"),
//				StreamId:    pulumi.String("<stream_id>"),
...
//					Uri:  pulumi.String("<msteams_uri>"),
//				},
//			})
//			if err != nil {
//				return err
//			}
//			_, err = fabric.NewStreamSubscription(ctx, "servicenow", &fabric.StreamSubscriptionArgs{
//				Type:        pulumi.String("STREAM_SUBSCRIPTION"),
//				Name:        pulumi.String("<name>"),
//				Description: pulumi.String("<description>"),
//				StreamId:    pulumi.String("<stream_id>"),
...
//					Host: pulumi.String("<servicenow_host>"),
//					Settings: &fabric.StreamSubscriptionSinkSettingsArgs{
//						Source: pulumi.String("Equinix"),
//					},
//					Credential: &fabric.StreamSubscriptionSinkCredentialArgs{
//						Type:     pulumi.String("USERNAME_PASSWORD"),
//						Username: pulumi.String("<servicenow_username>"),
//						Password: pulumi.String("<servicenow_password>"),
//					},
//				},
//			})
//			if err != nil {
//				return err
//			}
//			_, err = fabric.NewStreamSubscription(ctx, "webhook", &fabric.StreamSubscriptionArgs{
//				Type:        pulumi.String("STREAM_SUBSCRIPTION"),
//				Name:        pulumi.String("<name>"),
//				Description: pulumi.String("<description>"),
//				StreamId:    pulumi.String("<stream_id>"),
...
//					Settings: &fabric.StreamSubscriptionSinkSettingsArgs{
//						Format:    pulumi.String("<webhook_format>"),
//						EventUri:  pulumi.String("<webhook_event_uri>"),
//						MetricUri: pulumi.String("<webhook_metric_uri>"),
//					},
//				},
//			})
//			if err != nil {
//				return err
//			}
//			_, err = fabric.NewStreamSubscription(ctx, "grafana", &fabric.StreamSubscriptionArgs{
//				Type:        pulumi.String("STREAM_SUBSCRIPTION"),
//				Name:        pulumi.String("<name>"),
//				Description: pulumi.String("<description>"),
//				StreamId:    pulumi.String("<stream_id>"),
...
//					Type: pulumi.String("WEBHOOK"),
//					Settings: &fabric.StreamSubscriptionSinkSettingsArgs{
//						Format:    pulumi.String("OPENTELEMETRY"),
//						EventUri:  pulumi.String("<grafana_event_uri>"),
//						MetricUri: pulumi.String("<grafana_metric_uri>"),
//					},
//				},
//			})
//			if err != nil {
