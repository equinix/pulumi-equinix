...
func GetRouteAggregationRulesOutput(ctx *pulumi.Context, args GetRouteAggregationRulesOutputArgs, opts ...pulumi.InvokeOption) GetRouteAggregationRulesResultOutput {
	...
	return ctx.InvokeOutput("equinix:fabric/getRouteAggregationRules:getRouteAggregationRules", args, GetRouteAggregationRulesResultOutput{}, options).(GetRouteAggregationRulesResultOutput)
}
