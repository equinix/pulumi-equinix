...
func GetStreamSubscriptionsOutput(ctx *pulumi.Context, args GetStreamSubscriptionsOutputArgs, opts ...pulumi.InvokeOption) GetStreamSubscriptionsResultOutput {
	...
	return ctx.InvokeOutput("equinix:fabric/getStreamSubscriptions:getStreamSubscriptions", args, GetStreamSubscriptionsResultOutput{}, options).(GetStreamSubscriptionsResultOutput)
}
