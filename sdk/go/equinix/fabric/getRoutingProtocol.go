...
func LookupRoutingProtocolOutput(ctx *pulumi.Context, args LookupRoutingProtocolOutputArgs, opts ...pulumi.InvokeOption) LookupRoutingProtocolResultOutput {
	...
	return ctx.InvokeOutput("equinix:fabric/getRoutingProtocol:getRoutingProtocol", args, LookupRoutingProtocolResultOutput{}, options).(LookupRoutingProtocolResultOutput)
}
