...
func LookupConnectionRouteAggregationOutput(ctx *pulumi.Context, args LookupConnectionRouteAggregationOutputArgs, opts ...pulumi.InvokeOption) LookupConnectionRouteAggregationResultOutput {
	...
	return ctx.InvokeOutput("equinix:fabric/getConnectionRouteAggregation:getConnectionRouteAggregation", args, LookupConnectionRouteAggregationResultOutput{}, options).(LookupConnectionRouteAggregationResultOutput)
}
