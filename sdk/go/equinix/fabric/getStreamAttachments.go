...
func GetStreamAttachmentsOutput(ctx *pulumi.Context, args GetStreamAttachmentsOutputArgs, opts ...pulumi.InvokeOption) GetStreamAttachmentsResultOutput {
	...
	return ctx.InvokeOutput("equinix:fabric/getStreamAttachments:getStreamAttachments", args, GetStreamAttachmentsResultOutput{}, options).(GetStreamAttachmentsResultOutput)
}
