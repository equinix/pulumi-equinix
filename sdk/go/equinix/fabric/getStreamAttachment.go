...
func LookupStreamAttachmentOutput(ctx *pulumi.Context, args LookupStreamAttachmentOutputArgs, opts ...pulumi.InvokeOption) LookupStreamAttachmentResultOutput {
	...
	return ctx.InvokeOutput("equinix:fabric/getStreamAttachment:getStreamAttachment", args, LookupStreamAttachmentResultOutput{}, options).(LookupStreamAttachmentResultOutput)
}
