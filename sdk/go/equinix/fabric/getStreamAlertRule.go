...
func LookupStreamAlertRuleOutput(ctx *pulumi.Context, args LookupStreamAlertRuleOutputArgs, opts ...pulumi.InvokeOption) LookupStreamAlertRuleResultOutput {
	...
	return ctx.InvokeOutput("equinix:fabric/getStreamAlertRule:getStreamAlertRule", args, LookupStreamAlertRuleResultOutput{}, options).(LookupStreamAlertRuleResultOutput)
}
