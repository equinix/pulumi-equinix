...
func LookupRouteAggregationOutput(ctx *pulumi.Context, args LookupRouteAggregationOutputArgs, opts ...pulumi.InvokeOption) LookupRouteAggregationResultOutput {
	...
	return ctx.InvokeOutput("equinix:fabric/getRouteAggregation:getRouteAggregation", args, LookupRouteAggregationResultOutput{}, options).(LookupRouteAggregationResultOutput)
}
