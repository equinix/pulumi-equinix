...
func LookupConnectionRouteFilterOutput(ctx *pulumi.Context, args LookupConnectionRouteFilterOutputArgs, opts ...pulumi.InvokeOption) LookupConnectionRouteFilterResultOutput {
	...
	return ctx.InvokeOutput("equinix:fabric/getConnectionRouteFilter:getConnectionRouteFilter", args, LookupConnectionRouteFilterResultOutput{}, options).(LookupConnectionRouteFilterResultOutput)
}
