...
//				return err
//			}
//			ctx.Export("streamAlertRulesType", pulumi.Any(alertRules.Data[0].Type))
//			ctx.Export("streamAlertRulesId", pulumi.Any(alertRules.Data[0].Uuid))
//			ctx.Export("streamAlertRulesState", pulumi.Any(alertRules.Data[0].State))
//			ctx.Export("streamAlertRulesStreamId", pulumi.Any(alertRules.Data[0].StreamId))
//			return nil
//		})
//	}
//
...
func GetStreamAlertRulesOutput(ctx *pulumi.Context, args GetStreamAlertRulesOutputArgs, opts ...pulumi.InvokeOption) GetStreamAlertRulesResultOutput {
	...
	return ctx.InvokeOutput("equinix:fabric/getStreamAlertRules:getStreamAlertRules", args, GetStreamAlertRulesResultOutput{}, options).(GetStreamAlertRulesResultOutput)
}
