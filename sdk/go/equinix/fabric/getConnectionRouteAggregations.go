...
func GetConnectionRouteAggregationsOutput(ctx *pulumi.Context, args GetConnectionRouteAggregationsOutputArgs, opts ...pulumi.InvokeOption) GetConnectionRouteAggregationsResultOutput {
	...
	return ctx.InvokeOutput("equinix:fabric/getConnectionRouteAggregations:getConnectionRouteAggregations", args, GetConnectionRouteAggregationsResultOutput{}, options).(GetConnectionRouteAggregationsResultOutput)
}
