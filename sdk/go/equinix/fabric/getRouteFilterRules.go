...
func GetRouteFilterRulesOutput(ctx *pulumi.Context, args GetRouteFilterRulesOutputArgs, opts ...pulumi.InvokeOption) GetRouteFilterRulesResultOutput {
	...
	return ctx.InvokeOutput("equinix:fabric/getRouteFilterRules:getRouteFilterRules", args, GetRouteFilterRulesResultOutput{}, options).(GetRouteFilterRulesResultOutput)
}
