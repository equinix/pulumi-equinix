...
func GetServiceProfilesOutput(ctx *pulumi.Context, args GetServiceProfilesOutputArgs, opts ...pulumi.InvokeOption) GetServiceProfilesResultOutput {
	...
	return ctx.InvokeOutput("equinix:fabric/getServiceProfiles:getServiceProfiles", args, GetServiceProfilesResultOutput{}, options).(GetServiceProfilesResultOutput)
}
