...
func LookupStreamSubscriptionOutput(ctx *pulumi.Context, args LookupStreamSubscriptionOutputArgs, opts ...pulumi.InvokeOption) LookupStreamSubscriptionResultOutput {
	...
	return ctx.InvokeOutput("equinix:fabric/getStreamSubscription:getStreamSubscription", args, LookupStreamSubscriptionResultOutput{}, options).(LookupStreamSubscriptionResultOutput)
}
