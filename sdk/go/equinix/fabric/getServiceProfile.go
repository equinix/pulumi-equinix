...
func LookupServiceProfileOutput(ctx *pulumi.Context, args LookupServiceProfileOutputArgs, opts ...pulumi.InvokeOption) LookupServiceProfileResultOutput {
	...
	return ctx.InvokeOutput("equinix:fabric/getServiceProfile:getServiceProfile", args, LookupServiceProfileResultOutput{}, options).(LookupServiceProfileResultOutput)
}
