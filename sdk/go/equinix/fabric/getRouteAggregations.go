...
func GetRouteAggregationsOutput(ctx *pulumi.Context, args GetRouteAggregationsOutputArgs, opts ...pulumi.InvokeOption) GetRouteAggregationsResultOutput {
	...
	return ctx.InvokeOutput("equinix:fabric/getRouteAggregations:getRouteAggregations", args, GetRouteAggregationsResultOutput{}, options).(GetRouteAggregationsResultOutput)
}
