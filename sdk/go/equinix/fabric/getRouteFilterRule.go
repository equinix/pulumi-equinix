...
func LookupRouteFilterRuleOutput(ctx *pulumi.Context, args LookupRouteFilterRuleOutputArgs, opts ...pulumi.InvokeOption) LookupRouteFilterRuleResultOutput {
	...
	return ctx.InvokeOutput("equinix:fabric/getRouteFilterRule:getRouteFilterRule", args, LookupRouteFilterRuleResultOutput{}, options).(LookupRouteFilterRuleResultOutput)
}
