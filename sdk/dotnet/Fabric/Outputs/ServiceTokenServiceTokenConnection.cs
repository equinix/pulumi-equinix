...
namespace Pulumi.Equinix.Fabric.Outputs
{
    ...
    [OutputType]
    public sealed class ServiceTokenServiceTokenConnection
    {
        /// <summary>
        /// A-Side Connection link protocol,virtual device or network configuration
        /// </summary>
        public readonly ImmutableArray<Outputs.ServiceTokenServiceTokenConnectionASide> ASides;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.ServiceTokenServiceTokenConnectionZSide> ZSides;

        [OutputConstructor]
        private ServiceTokenServiceTokenConnection(
            ImmutableArray<Outputs.ServiceTokenServiceTokenConnectionASide> aSides,
            ...
            ImmutableArray<Outputs.ServiceTokenServiceTokenConnectionZSide> zSides)
        {
            ASides = aSides;
