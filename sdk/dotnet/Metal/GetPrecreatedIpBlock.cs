...
namespace Pulumi.Equinix.Metal
{
    public static class GetPrecreatedIpBlock
    {
        ...
        ///     });
        /// 
        ///     var test = Equinix.Metal.GetPrecreatedIpBlock.Invoke(new()
        ///     {
        ///         Metro = "sv",
        ///         ProjectId = projectId,
        ///         AddressFamily = 6,
        ...
        ///     var fromIpv6Block = new Equinix.Metal.IpAttachment("from_ipv6_block", new()
        ///     {
        ///         DeviceId = web1.Id,
        ///         CidrNotation = Std.Cidrsubnet.Invoke(new()
        ///         {
        ///             Input = test.Apply(getPrecreatedIpBlockResult =&gt; getPrecreatedIpBlockResult.CidrNotation),
        ///             Newbits = 8,
        ///             Netnum = 2,
