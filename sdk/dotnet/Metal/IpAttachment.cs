...
namespace Pulumi.Equinix.Metal
{
    ...
    public partial class IpAttachment : global::Pulumi.CustomResource
    {
        ...
        public IpAttachment(string name, IpAttachmentArgs args, CustomResourceOptions? options = null)
            : base("equinix:metal/ipAttachment:IpAttachment", name, args ?? new IpAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpAttachment(string name, Input<string> id, IpAttachmentState? state = null, CustomResourceOptions? options = null)
            : base("equinix:metal/ipAttachment:IpAttachment", name, state, MakeResourceOptions(options, id))
        {
        }
