...
namespace Pulumi.Equinix.NetworkEdge.Inputs
{
    ...
    public sealed class DeviceSecondaryDeviceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("interfaces")]
        private InputList<Inputs.DeviceSecondaryDeviceInterfaceArgs>? _interfaces;

        /// <summary>
        /// List of device interfaces. See Interface Attribute below for more details.
        /// </summary>
        public InputList<Inputs.DeviceSecondaryDeviceInterfaceArgs> Interfaces
        {
            get => _interfaces ?? (_interfaces = new InputList<Inputs.DeviceSecondaryDeviceInterfaceArgs>());
        ...
        /// </summary>
        [Input("sshKey")]
        public Input<Inputs.DeviceSecondaryDeviceSshKeyArgs>? SshKey { get; set; }
        ...
        public DeviceSecondaryDeviceArgs()
        {
        }
        public static new DeviceSecondaryDeviceArgs Empty => new DeviceSecondaryDeviceArgs();
    }
}
