...
export class OrganizationMember extends pulumi.CustomResource {
     ...
     */
    declare public readonly invitee: pulumi.Output<string>;
    /**
     ...
     */
    declare public /*out*/ readonly nonce: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly projectsIds: pulumi.Output<string[]>;
    /**
