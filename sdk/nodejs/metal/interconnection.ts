...
export class Interconnection extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly ports: pulumi.Output<outputs.metal.InterconnectionPort[]>;
    /**
     ...
     */
    declare public readonly serviceTokenType: pulumi.Output<string | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly serviceTokens: pulumi.Output<outputs.metal.InterconnectionServiceToken[]>;
    /**
     ...
     */
    declare public readonly vlans: pulumi.Output<number[] | undefined>;
    /**
     ...
     */
    declare public readonly vrfs: pulumi.Output<string[] | undefined>;
    ...
    constructor(name: string, argsOrState?: InterconnectionArgs | InterconnectionState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["serviceTokenType"] = state?.serviceTokenType;
            resourceInputs["serviceTokens"] = state?.serviceTokens;
            ...
            resourceInputs["vrfs"] = state?.vrfs;
        } else {
            ...
            resourceInputs["serviceTokenType"] = args?.serviceTokenType;
            resourceInputs["speed"] = args?.speed;
            resourceInputs["tags"] = args?.tags;
            resourceInputs["type"] = args?.type;
            resourceInputs["vlans"] = args?.vlans;
            resourceInputs["vrfs"] = args?.vrfs;
