...
export class DeviceLink extends pulumi.CustomResource {
     ...
     */
    declare public readonly devices: pulumi.Output<outputs.networkedge.DeviceLinkDevice[]>;
    /**
     ...
     */
    declare public readonly metroLinks: pulumi.Output<outputs.networkedge.DeviceLinkMetroLink[] | undefined>;
    /**
     * device link name.
     */
    ...
    constructor(name: string, argsOrState?: DeviceLinkArgs | DeviceLinkState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["metroLinks"] = state?.metroLinks;
            ...
            resourceInputs["metroLinks"] = args?.metroLinks;
...
export interface DeviceLinkState {
     ...
     * definition of one or more devices belonging to the device link. See Device section below for more details.
     */
    devices?: pulumi.Input<pulumi.Input<inputs.networkedge.DeviceLinkDevice>[] | undefined>;
    /**
     * definition of one or more, inter metro, connections belonging to the device link. See Metro Link section below for more details.
     */
    metroLinks?: pulumi.Input<pulumi.Input<inputs.networkedge.DeviceLinkMetroLink>[] | undefined>;
    /**
     * device link name.
     */
