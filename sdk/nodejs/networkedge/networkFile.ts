 ...
 * ```
 *
 * The `content`, `selfManaged` and `byol` fields can not be imported.
 */
export class NetworkFile extends pulumi.CustomResource {
     ...
     */
    declare public readonly byol: pulumi.Output<boolean>;
    /**
     ...
     * Device type code
     */
    declare public readonly deviceTypeCode: pulumi.Output<string>;
    /**
     * File name.
     */
     ...
     */
    declare public readonly processType: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: NetworkFileArgs | NetworkFileState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["deviceTypeCode"] = state?.deviceTypeCode;
            ...
            if (args?.byol === undefined && !opts.urn) {
                throw new Error("Missing required property 'byol'");
            }
            if (args?.content === undefined && !opts.urn) {
                throw new Error("Missing required property 'content'");
            }
            if (args?.deviceTypeCode === undefined && !opts.urn) {
            ...
            if (args?.selfManaged === undefined && !opts.urn) {
            ...
            resourceInputs["deviceTypeCode"] = args?.deviceTypeCode;
...
export interface NetworkFileState {
     ...
     * Device type code
     */
    deviceTypeCode?: pulumi.Input<string | undefined>;
    /**
     * File name.
     */
     ...
     * File process type (LICENSE or CLOUD_INIT).
     */
    processType?: pulumi.Input<string | enums.networkedge.FileType | undefined>;
    /**
     * Boolean value that determines device management mode, i.e., `self-managed` or `Equinix-managed`.
     */
