...
export class StreamAttachment extends pulumi.CustomResource {
    ...
    declare public readonly timeouts: pulumi.Output<outputs.fabric.StreamAttachmentTimeouts | undefined>;
    /**
...
export interface StreamAttachmentState {
    ...
    timeouts?: pulumi.Input<inputs.fabric.StreamAttachmentTimeouts | undefined>;
    /**
     * Equinix defined type for the asset stream attachment
     */
