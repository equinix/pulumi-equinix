...
export class RouteAggregationRule extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly change: pulumi.Output<outputs.fabric.RouteAggregationRuleChange>;
    /**
     * Details of the last change on the resource
     */
    declare public /*out*/ readonly changeLog: pulumi.Output<outputs.fabric.RouteAggregationRuleChangeLog>;
    /**
    ...
    declare public readonly timeouts: pulumi.Output<outputs.fabric.RouteAggregationRuleTimeouts | undefined>;
    /**
...
export interface RouteAggregationRuleState {
     ...
     * Current state of latest Route Aggregation Rule change
     */
    change?: pulumi.Input<inputs.fabric.RouteAggregationRuleChange | undefined>;
    /**
     * Details of the last change on the resource
     */
    changeLog?: pulumi.Input<inputs.fabric.RouteAggregationRuleChangeLog | undefined>;
    /**
     * Customer-provided Route Aggregation Rule description
     */
     ...
     * UUID of the Route Aggregation that this rule is applied to
     */
    routeAggregationId?: pulumi.Input<string | undefined>;
    /**
     * Value representing provisioning status for the Route Aggregation Rule resource
     */
    state?: pulumi.Input<string | undefined>;
    timeouts?: pulumi.Input<inputs.fabric.RouteAggregationRuleTimeouts | undefined>;
    /**
     * Equinix defined Route Aggregation Type; BGP*IPv4*PREFIX*AGGREGATION, BGP*IPv6*PREFIX*AGGREGATION
     */
