...
export interface GetStreamAlertRuleOutputArgs {
     ...
     * Detection method for stream alert rule
     */
    detectionMethod?: pulumi.Input<inputs.fabric.GetStreamAlertRuleDetectionMethodArgs | undefined>;
    /**
     * Metric selector for the stream alert rule
     */
    metricSelector?: pulumi.Input<inputs.fabric.GetStreamAlertRuleMetricSelectorArgs | undefined>;
    /**
     * The uuid of the stream that is the target of the stream alert rule
     */
