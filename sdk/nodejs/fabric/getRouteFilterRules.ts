...
export interface GetRouteFilterRulesOutputArgs {
     ...
     * Filters for the Data Source Search Request
     */
    filters?: pulumi.Input<pulumi.Input<inputs.fabric.GetRouteFilterRulesFilterArgs>[] | undefined>;
    /**
     * Number of elements to be requested per page. Number must be between 1 and 100. Default is 20
     */
     ...
     * Sort criteria for the Data Source Search Request
     */
    sorts?: pulumi.Input<pulumi.Input<inputs.fabric.GetRouteFilterRulesSortArgs>[] | undefined>;
}
