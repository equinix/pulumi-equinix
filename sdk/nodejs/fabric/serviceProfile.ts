...
export class ServiceProfile extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly selfProfile: pulumi.Output<boolean>;
    /**
...
export interface ServiceProfileState {
     ...
     * Access point config information
     */
    accessPointTypeConfigs?: pulumi.Input<pulumi.Input<inputs.fabric.ServiceProfileAccessPointTypeConfig>[] | undefined>;
    /**
     * Service Profile Owner Account Information
     */
    account?: pulumi.Input<inputs.fabric.ServiceProfileAccount | undefined>;
    /**
     * Array of contact emails
     */
    allowedEmails?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    /**
     * Captures connection lifecycle change information
     */
    changeLog?: pulumi.Input<inputs.fabric.ServiceProfileChangeLog | undefined>;
    /**
     * Custom Fields
     */
    customFields?: pulumi.Input<pulumi.Input<inputs.fabric.ServiceProfileCustomField>[] | undefined>;
    /**
     * User-provided service description
     */
     ...
     * Marketing Info
     */
    marketingInfo?: pulumi.Input<inputs.fabric.ServiceProfileMarketingInfo | undefined>;
    /**
     * Access point config information
     */
    metros?: pulumi.Input<pulumi.Input<inputs.fabric.ServiceProfileMetro>[] | undefined>;
    /**
     * Customer-assigned service profile name
     */
     ...
     * Preferences for notifications on connection configuration or status changes
     */
    notifications?: pulumi.Input<pulumi.Input<inputs.fabric.ServiceProfileNotification>[] | undefined>;
    /**
     * Ports
     */
    ports?: pulumi.Input<pulumi.Input<inputs.fabric.ServiceProfilePort>[] | undefined>;
    /**
     * Project information
     */
    project?: pulumi.Input<inputs.fabric.ServiceProfileProject | undefined>;
    /**
     * Self Profile indicating if the profile is created for customer's self use
     */
    selfProfile?: pulumi.Input<boolean | undefined>;
    /**
     * Service profile state - ACTIVE, PENDING_APPROVAL, DELETED, REJECTED
     */
    state?: pulumi.Input<string | enums.fabric.ProfileState | undefined>;
    /**
     * Tags attached to the connection
     */
     ...
     * Service profile type - L2*PROFILE, L3*PROFILE, ECIA*PROFILE, ECMC*PROFILE, IA*PROFILE, IX*PROFILE
     */
    type?: pulumi.Input<string | enums.fabric.ProfileType | undefined>;
    /**
     * Equinix assigned service profile identifier
     */
     ...
     * Flips view between buyer and seller representation. Available values : aSide, zSide. Default value : aSide
     */
    viewPoint?: pulumi.Input<string | undefined>;
    /**
     * Virtual Devices
     */
    virtualDevices?: pulumi.Input<pulumi.Input<inputs.fabric.ServiceProfileVirtualDevice>[] | undefined>;
    /**
     * Service profile visibility - PUBLIC, PRIVATE
     */
    visibility?: pulumi.Input<string | enums.fabric.ProfileVisibility | undefined>;
}
