...
export interface GetRouteFiltersOutputArgs {
     ...
     * Pagination details for the Data Source Search Request
     */
    pagination?: pulumi.Input<inputs.fabric.GetRouteFiltersPaginationArgs | undefined>;
    /**
     * Filters for the Data Source Search Request
     */
    sorts?: pulumi.Input<pulumi.Input<inputs.fabric.GetRouteFiltersSortArgs>[] | undefined>;
}
