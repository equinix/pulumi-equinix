 ...
 * export const deviceRedundancyEnabled = portDataName.then(portDataName => portDataName.device?.redundancy?.enabled);
 * export const deviceRedundancyPriority = portDataName.then(portDataName => portDataName.device?.redundancy?.priority);
 * ```
 */
