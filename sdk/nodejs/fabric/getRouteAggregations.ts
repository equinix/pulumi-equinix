...
export interface GetRouteAggregationsOutputArgs {
     ...
     * Pagination details for the returned route aggregations list
     */
    pagination?: pulumi.Input<inputs.fabric.GetRouteAggregationsPaginationArgs | undefined>;
    /**
     * Filters for the Data Source Search Request
     */
    sort?: pulumi.Input<inputs.fabric.GetRouteAggregationsSortArgs | undefined>;
}
