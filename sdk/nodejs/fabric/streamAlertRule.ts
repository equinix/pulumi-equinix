...
export interface StreamAlertRuleState {
     ...
     * Details of the last change on the stream resource
     */
    changeLog?: pulumi.Input<inputs.fabric.StreamAlertRuleChangeLog | undefined>;
    /**
     * Customer-provided stream alert rule description
     */
     ...
     * Detection method for stream alert rule
     */
    detectionMethod?: pulumi.Input<inputs.fabric.StreamAlertRuleDetectionMethod | undefined>;
    /**
     * Stream alert rule enabled status
     */
     ...
     * Metric selector for the stream alert rule
     */
    metricSelector?: pulumi.Input<inputs.fabric.StreamAlertRuleMetricSelector | undefined>;
    /**
     * Customer-provided stream alert rule name
     */
     ...
     * Resource selector for the stream alert rule
     */
    resourceSelector?: pulumi.Input<inputs.fabric.StreamAlertRuleResourceSelector | undefined>;
    /**
     * Value representing provisioning status for the stream alert rule
     */
    ...
    timeouts?: pulumi.Input<inputs.fabric.StreamAlertRuleTimeouts | undefined>;
    /**
     * Type of the stream alert rule
     */
