...
policy_attachment = equinix.fabric.ConnectionRouteFilter("policy_attachment",
...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		policyAttachment, err := fabric.NewConnectionRouteFilter(ctx, "policy_attachment", &fabric.ConnectionRouteFilterArgs{
...
{
    var policyAttachment = new Equinix.Fabric.ConnectionRouteFilter("policy_attachment", new()
    {
        ConnectionId = "<connection_uuid>",
        RouteFilterId = "<route_filter_policy_uuid>",
        Direction = "INBOUND",
